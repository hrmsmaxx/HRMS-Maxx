...
// ));
 ...
 function offerValidateCreate()

    {
         ...
         $(document).ready(function() {
            ...
            function addObjectiveContent(count) {
                ...
                return '<form action="performance/add_goals" method="post">'+
    ...
    // Smart Goal End
        ...
        //     if(appsumo_code != ''){                    
        //         $.post('<?php echo base_url();?>settings/check_appsumo_code',{appsumo_code:appsumo_code},function(data){
        //             // alert(data);
        //             if(data == 1){                        
        //                 toastr.success('Code applied successfully!');   
        //                 $('#appsumo_code').val('');
        //             }else if(data == 2){
        //               toastr.error('Code already applied.');  
        //                 $('#appsumo_code').val('');
        //                return false;                    
        //             }else if(data == 3){
