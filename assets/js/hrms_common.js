...
function initalloading_employee(page, employee_id, username, employee_email, department_id) {
    ...
    $.post(base_url + 'employees/employees_list', {
	   ...
	   var records_header = datas.table_header;
        ...
        if (recordscount > 0) {
		    ...
		    '<td class="div-cell user-identity">' +
                ...
                htmlbody += 
                    ...
                    '<li><a href="' + base_url + 'employees/profile_view/' + record.id + '"   title="Employee"><i class="fa fa-pencil m-r-5"></i> '+ records_header.edit +' </li>' +
                    '<li><a href="' + base_url + 'employees/delete/' + record.id + '"  data-toggle="ajaxModal"><i class="fa fa-trash-o m-r-5"></i>'+ records_header.delete +'</a></li>';
                    if(record.activated == 2 ){
                        htmlbody += '<li><a href="' + base_url + 'employees/change_inactive/'+record.id+ '" ><i class="fa fa-eye m-r-5"></i>'+ records_header.active +'</a></li>';
                    }else{
                        htmlbody += '<li><a href="' + base_url + 'employees/change_inactive/'+record.id+ '" ><i class="fa fa-eye-slash m-r-5"></i>'+ records_header.inactive +'</a></li>';
                    }
                    htmlbody += '</ul>' +
                    '</div>' +
                    '</div>' +
            ...
            htmlbody = '<tbody class="row filter-row"><div class="col-md-12 text-center"></div></tbody>';
        }

        var html = '<thead>'+
                    '<tr class="table_heading">' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.name + '</b></p>' +
            '</th>' +
	    '<th class="div-cell">' +
            '<p><b>' + records_header.branch + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.department + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.employee_id_code + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.mail + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.mobile + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.join_date + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.last_login + '</b></p>' +
            '</th>' +
            '<th class="div-cell">' +
            '<p><b>' + records_header.status + '</b></p>' +
            '</th>' +
            '<th class="div-cell text-right">' +
            '<p><b>' + records_header.action + '</b></p>' +
            '</th>' +
            '</tr>' +
            '</thead>';
        var classname = '';
...
if (uri_page == 'attendance' && uri_page1 !='attendance_records') {
    var page = 1;
    var employee_id = $('#employee_id').val();
    ...
    $.post(base_url + 'attendance/attendance_list', {
        ...
        if (recordscount > 0) {
            for (var i = 0; i < recordscount; i++) {
                ...
                attendance_body += '<tr id="user_'+record.user_id+'"><td><a href="'+base_url + 'attendance/details/'+record.user_id+'">' + name + '</a></td>';
               ...
               // console.log(attendance);
                ...
                var user_html = "";
                    //if(record.user_id == 320){
                        ...
                        var production_hour_achived = $('#production_hour_achived').val();
                        var later_entry_hours = $('#later_entry_hours').val();
                        var missing_work = $('#missing_work').val();
                        // alert(missing_work);
                        var status = rec.day;
                        var punchin = rec.punch_in;
                        var punch_out = rec.punch_out;
                        var user_id =  record.user_id;
                        var day = parseInt(key) + 1
                    ...
                    if (status == '0') {
                        if(punchin == '' && punch_out == ''){
                            user_html += '<i class="fa fa-close text-danger"></i>';
                        }
                    } else if (status == '1') {
                        if((punchin != ''  && punch_out != '')){
                            if(overtimes!= 0){
                                user_html += '<a href="'+base_url + 'attendance/attendance_details/'+user_id+'/'+day+'/'+attendance_month+'/'+attendance_year+'" data-toggle="ajaxModal" ><i class="fa fa-check text-warning"></i></a>';
                            }
                            if(production_hour_achived !=0){
                                user_html += '<a href="'+base_url + 'attendance/attendance_details/'+user_id+'/'+day+'/'+attendance_month+'/'+attendance_year+'" data-toggle="ajaxModal" ><i class="fa fa-check text-success"></i></a>';
                            }if(later_entry_hours !=0){
                                user_html += '<a href="'+base_url + 'attendance/attendance_details/'+user_id+'/'+day+'/'+attendance_month+'/'+attendance_year+'" data-toggle="ajaxModal" ><i class="fa fa-check text-yellow1"></i></a>';
                            }
                            if(missing_work !=0){
                                user_html += '<a href="'+base_url + 'attendance/attendance_details/'+user_id+'/'+day+'/'+attendance_month+'/'+attendance_year+'" data-toggle="ajaxModal" ><i class="fa fa-close text-danger"></i></a>';
                            }
                            ...
                            user_html += '<div class="half-day">'
                                                    +'<span class="first-off"><a href="'+base_url + 'attendance/attendance_details/'+user_id+'/'+day+'/'+attendance_month+'/'+attendance_year+'" data-toggle="ajaxModal" ><i class="fa fa-check text-success"></i></a></span>' 
                                                    +'<span class="first-off"><i class="fa fa-close text-danger"></i></span>'
                                                +'</div>';
                        }
                    } else if (status == '2') {
                        user_html += '<i class="text-success" data-toggle="tooltip" title="Worked Hours"></i>';
                    } else if (status == '0') {
                        user_html += '<i class="fa fa-exclamation-triangle text-danger" data-toggle="tooltip" title="No Record for Punch in"></i>';
                    } else if (status == '') {
                        user_html += '-';
                    }
                    user_html += '</td>';
...
$(document).ready(function(){
   ...
   $('#check_id_code').change(function(){
        var id_code = $(this).val();
        if(id_code !=''){
            $.post(base_url+'employees/check_id_code/',{id_code:id_code},function(res){
                if(res == 'yes'){
    ...
    //   $('#check_incident_id_code').bind("keypress",function(){

    //     var id_code = $(this).val();
        
    //     if(id_code !=''){
    //         $.post(base_url+'incidents/check_id_code/',{id_code:id_code},function(res){
    //             if(res == 'yes'){
    //                 $('#already_id_code').css('display','');
	...
	//alert('test');
	   ...
	   if(client_name_edit == '') {
            $('#client_name_edit').focus();
            $('#client_name_edit').css('border-color','#77A7DB');
            $('#client_name_error').removeClass('display-none').addClass('display-block');
            return false;
        }
        else
        {
            $('#client_name_edit').css('border-color','#ccc');
    ...
    $('#asset_search').click(function(){
        ...
        {
            $('#category_name').focus();
            $('#category_name').css('border-color','#77A7DB');
            $('#category_name_error').removeClass('display-none').addClass('display-block');
            return false;
        }
        else
        {
            $('#category_name').css('border-color','#ccc');
            $('#category_name_error').removeClass('display-block').addClass('display-none');
        }
    });
    ...
    function clientValidateCreate()
    {
		...
		//branch_id:{
            ...
            messages: {
		//branch_id:{
                   // required: "Branch Name must not be empty"
                //},
                company_name: {
     ...
     $(document).on('click','#updateClient',function(){
        ...
        $(document).on('click','#employee_search_btn',function(){
            ...
            if(employee_id == '' && username == '' && email == '' && department_id ==''){
                ...
                $('#department_error').removeClass('display-none').addClass('display-block');
                console.log("invalid")
                return false;
            }
            else{
                ...
                $('#department_error').removeClass('display-block').addClass('display-none');
                console.log("valid")
            }
        });
      ...
      //               },
                ...
                messages: {
                    first_name: {
                        required: 'First Name must not empty'
                    },
                    last_name: {
                        required: 'Last Name must not empty'
                    },
                    dob: {
                    ...
                    id_code: {
                        ...
                        minlength : 'Id Code minimum length should be 1 characters',
                        maxlength : 'Id Code maximum length should be 9 characters'
                    },
                    password: {
      ...
      //               },
		    ...
		    user_type: {
                        required:'User Type must not empty'
                    },
                },
                submitHandler: function(form) {
                    form.submit();
    ...
    $(document).ready(function() {
      $(".only-numeric").bind("keypress", function (e) {
        ...
        $(document).on('click','#calendar_add_incident',function(){

            $("#calendarAddIncident").validate({
                ignore: [],
                rules: {
                    emp_id: {
                        required: true
                ...
                messages: {
                    ...
                    incident: {
                        required: "Please select the incident"
                    },
                    start_date: {
                        required: "From Date must not empty"
                    },
        ...
        $(document).on('click','#calendar_edit_incident',function(){
    ...
    //end calendar incidents
	    ...
	    //if(branch == '' || branch == null)
            //{
               // $('#estimates_branch_error').removeClass('display-none').addClass('display-block');
                //$('#create_branch_client').select2('open');
            //}
            //else
            //{
                //$('#estimates_branch_error').removeClass('display-block').addClass('display-none');
        ...
        $(document).on('click','#activity_search',function(){
            ...
            if(from == '' && to == ''){
                ...
                console.log("valid");
		$.ajax({
                        url: base_url+'profile/activities',
                        type: 'POST',
        ...
        $(document).on('click','#timesheet_search_btn',function(){
            ...
            $(document).on('click','#shif_schedule_search_btn',function(){
            var username = $('#username').val();
            var department_id = $('#department_id').val();
            var schedule_date = $('#schedule_date').val();
            var week = $('#week').val();
            
            if(username == '' && week == '' && department_id == '' && schedule_date == ''){
                $('#username').focus();
                $('#department_id').css('border-color','#77A7DB');
                $('#schedule_date').css('border-color','#77A7DB');
                $('#week').css('border-color','#77A7DB');
                $('#username_error').removeClass('display-none').addClass('display-block');
                $('#department_id_error').removeClass('display-none').addClass('display-block');
                $('#schedule_date_error').removeClass('display-none').addClass('display-block');
                $('#week_error').removeClass('display-none').addClass('display-block');
                console.log("invalid")
                return false;
            }
            else{
                $('#department_id').css('border-color','#ccc');
                $('#schedule_date').css('border-color','#ccc');
                $('#week').css('border-color','#ccc');
                $('#username_error').removeClass('display-block').addClass('display-none');
                $('#department_id_error').removeClass('display-block').addClass('display-none');
                $('#schedule_date_error').removeClass('display-block').addClass('display-none');
                $('#week_error').removeClass('display-block').addClass('display-none');
                console.log("valid")
            }
...
$('#Add_experience_c').click(function() {
    var add_div = '<div class="MultipleExperience"><h3 class="card-title">Work Experience</h3> <a href="#" class="remove_exp_div"><i class="fa fa-trash-o"></i></a><div class="row"><div class="col-md-6"><div class="form-group form-focus"><input type="text" class="form-control floating" value="" name="company_name[]"><label class="control-label">Company Name</label></div></div><div class="col-md-6"><div class="form-group form-focus"><input type="text" class="form-control floating" value="" name="location[]"><label class="control-label">Location</label></div></div><div class="col-md-6"><div class="form-group form-focus"><input type="text" class="form-control floating" value="" name="job_position[]"><label class="control-label">Job Position</label></div></div><div class="col-md-6"><div class="form-group form-focus"><div class="cal-icon"><input type="text" class="form-control floating datetimepicker" value="" name="period_from[]"></div><label class="control-label">Period From</label></div></div><div class="col-md-6"><div class="form-group form-focus"><div class="cal-icon"><input type="text" class="form-control floating datetimepicker" value="" name="period_to[]"></div><label class="control-label">Period To</label></div></div></div></div>';
    $('.MultipleExperience:last').after(add_div);
});
$('.AllExperience_c').on('click','.remove_exp_div',function() {
    $(this).parent().remove();
});
...
$('#add_more_attendance').click(function() {
       $.post(base_url +'attendance/employees',function(data){
            if(data){
                ...
                $.post(base_url +'attendance/incidents',function(incidents){
                    var incidents = JSON.parse(incidents);
                var html_incidents = '';
                if(incidents.length > 0){
                        
                    $( incidents ).each(function( keys,vals ) {
                        var incident_name = vals.incident_name
                        incident_name = incident_name.toLowerCase().replace(/\b[a-z]/g, function(letter) {
                            return letter.toUpperCase();
                        });
                        
                        html_incidents += '<option value="'+vals.id+'">'+incident_name+'</option>';
                    });
                }
                    var add_div = '<div class="AttendanceRecords"><h3 class="card-title">'+lang_add_attendance_records+'</h3> <a href="#" class="remove_record_div"><i class="fa fa-trash-o"></i></a><div class="row"><div class="col-md-6"><div class="form-group"><label>'+lang_employees+' <span class="text-danger">*</span></label>   <select class="select2-option form-control" name="user_id[]" id="user_name"><option value="">'+lang_select_employee+'</option>'+html+'</select></div></div><div class="col-md-6"><div class="form-group"><label>'+lang_date+'<span class="text-danger">*</span></label><input class="form-control punch_date" type="text" name="punch_date[]"></div></div> <div class="col-md-6"><div class="form-group"><label>'+lang_punch+'<span class="text-danger">*</span></label><select class="select form-control" name="punch[]" id="punch"><option value="" selected="selected" disabled="disabled">'+lang_select_punch+'</option><option value="punch_in">'+lang_punch_in+'</option><option value="punch_out">'+lang_punch_out+'</option></select></div></div><div class="col-md-6"><div class="form-group"><label>'+lang_time+'<span class="text-danger">*</span></label><input class="form-control  time_picker" type="text" name="punch_time[]" ></div></div>  <div class="col-md-6"><div class="form-group"><label>'+lang_incidents+'</label><select class="select form-control"name="workcode[]" id="workcode"><option value="" selected>'+lang_select_incidents+'</option>'+html_incidents+'</select></div></div></div></div>';
                    $('.AttendanceRecords:last').after(add_div);
                });
            }
...
$('.AllAttendanceRecords').on('click','.remove_record_div',function() {
    $(this).parent().remove();
});
...
$(document).on('click',".datetimepicker",function() {
    ...
    $("#experience_info_form").validate({
        ...
        $(document).on('click',".punch_date",function() {
            $('.punch_date').datepicker();
        });
        $(document).on('click',".time_picker",function() {           
    ...
    $('.punch_date').datepicker();
            ...
            messages: {
                ...
                'punch[]': {
                    required: "Please select the punch"
                },
                'punch_time[]': {
                    required: "Time must not be empty"
                }
            },
            submitHandler: function(form) {
                form.submit();
  ...
  $(document).on('click','.punch_groups_submit',function(){
        $("#punch_groups").validate({
            onsubmit: true,
            ignore: [] ,
            rules: {
                'punch_group_name': {
  ...
  $(document).on('click','.locations_submit',function(){
         $("#locations").validate({
            onsubmit: true,
            ignore: [] ,
            rules: {
            ...
            messages: {
                ...
                'radius': {
                    required: "Radius must not be empty"
                }
            },
            submitHandler: function(form) {
                form.submit();
...
$(document).on('click','#submit_edit_contact_form',function(){
        ...
        $(document).on('click','#incident_submit',function(){
            ...
            $("#incidentAddForm").validate({
                ...
                messages: {
                    incident_name: {
                        required: 'Incident name must not empty'
                    },
                    type: {
                    ...
                    id_code: {
                        required: 'Id Code is required',
                        minlength : 'Minimum Length Should be be 1 characters',
                        maxlength : 'Maximum Length Should be 9 characters'
                    },
                    cost:{
        ...
        $(document).on('click','#incident_type_submit',function(){
            
            $("#incidentTypeAddForm").validate({
                ignore: [],
                rules: {
                    name: {
                        required: true
                ...
                messages: {
                    ...
                    number_of_incidents: {
                        required: 'Number of Incident name must not empty'
                    }
...
$(document).ready(function(){
    ...
    $(document).on('click',"#hospitalisation",function() {
        var hospitalisation = $('#hospitalisation_leave').val();
        if(hospitalisation == '')
        {
    ...
    $(document).on('click',"#extras_leaves",function() {
        var extra_leaves = $('#extra_leaves').val();
        alert(extra_leaves);
        return false;
        if(extra_leaves == '')
        {
            ...
            $.post(base_url + 'leave_settings/update_extra_leave/', { extra_leaves: extra_leaves}, function (datas) {
               $('#extra_leaves').val(datas);
...
$(document).on('click','.DeleteDeduction',function(){
    ...
    $(document).on('change','#main_category',function(){
        ...
        $.post(base_url + 'budgets/check_subcategories/', {category_id:category_id}, function (datas) {
            ...
            for(i=0; i<sub_categories.length; i++) {
                $('#sub_category').append("<option value="+sub_categories[i].sub_id+">"+sub_categories[i].sub_category+"</option>");                      
             }
        });
    });

    $(document).on('change','#asset_category',function(){
        var category_id = $( "#asset_category option:selected" ).val();
        $.post(base_url + 'all_assets/check_subcategories/', {category_id:category_id}, function (datas) {
            var sub_categories = JSON.parse(datas);
            $('#sub_category').empty();
            $('#sub_category').append("<option value='' selected disabled='disabled'>Choose Sub-Category</option>");
            for(i=0; i<sub_categories.length; i++) {
    ...
    $(document).on('change','#edit_asset_category',function(){

        var category_id = $( "#edit_asset_category option:selected" ).val();
        $.post(base_url + 'all_assets/check_subcategories/', {category_id:category_id}, function (datas) {
            var sub_categories = JSON.parse(datas);
            $('#edit_sub_category').empty();
            $('#edit_sub_category').append("<option value='' selected disabled='disabled'>Choose Sub-Category</option>");
            for(i=0; i<sub_categories.length; i++) {
                $('#edit_sub_category').append("<option value="+sub_categories[i].sub_id+">"+sub_categories[i].sub_category+"</option>");                      
             }
        });
    });
           ...
           ignore:[],
            ...
            messages: {
                ...
                position: {
                  ...
                  job_location: {
                    required: 'Add atleat one job location'
                },
                  no_of_vacancy: {
                ...
                experience_level: {
                    required: 'Experience level field is required'
                },
                  age: {
...
categories.push(value);
     ...
     if(categories.length!=0){
        ...
        $('#positions').html('<option value=""><div class="text-center">No results</div></option>');
     }
 }
