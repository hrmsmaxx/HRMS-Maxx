...
$(document).on('change','.leave_approvers_dept',function(){
        var no = $(this).data('no');
        var deptid = $( "#leave_approvers_dept"+no).val();
        if(deptid !=''){
            $.post(base_url + 'settings/get_emp_dept/', {deptid:deptid}, function (datas) {
                var emp_details = JSON.parse(datas);
                console.log(emp_details);
                $('#leave_approvers'+no).empty();
                $('#leave_approvers'+no).append("<option value='' selected disabled='disabled'>Select Approvers</option>");
                for(i=0; i<emp_details.length; i++) {
                    $('#leave_approvers'+no).append("<option value="+emp_details[i].id+">"+emp_details[i].fullname+"</option>");                      
                 }
            });
        } else{
...
$(document).on('change','.expense_approvers_dept',function(){
        var no = $(this).data('no');
        var deptid = $( "#expense_approvers_dept"+no).val();
        if(deptid !=''){
            $.post(base_url + 'settings/get_emp_dept/', {deptid:deptid}, function (datas) {
                var emp_details = JSON.parse(datas);
                console.log(emp_details);
                $('#expense_approvers'+no).empty();
                $('#expense_approvers'+no).append("<option value='' selected disabled='disabled'>Select Approvers</option>");
                for(i=0; i<emp_details.length; i++) {
                    $('#expense_approvers'+no).append("<option value="+emp_details[i].id+">"+emp_details[i].fullname+"</option>");                      
                 }
            });
        } else{
             toastr.error('Please Select the Department');
...
$(document).on('click','.approval-option input[type="radio"]',function(){
    ...
    $.ajax({
        ...
        success: function (data) {   
           $('#approver'+counts).find("option:eq(0)").html("Select Approver");
    ...
    //Append a new row of code to the "#items" div
    $("#items1").append(
      '<div class="next-approver"><label class="control-label m-b-10" style="padding-left:0">Approver </label><div class="row"><div class="col-md-6"><select style="width:260px;" name="expense_approvers[]"id="approver'+counts+'" class="approvers select form-control"><option value="">Select Approver</option></select></div><div class="col-md-2"><a class="remove_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div></div></div>'
    );
    ...
    $("#expense_approvers_items").append(
      '<div class="next-exp-approver"><label class="control-label m-b-10 exp_appr" style="padding-left:0">Approver '+counts+'</label><div class="row"><div class="col-md-6"><select name="expense_approvers[]"id="approver'+counts+'" class="approvers select form-control" style="width:260px;"><option value="">Select Approver</option></select></div><div class="col-md-2"><a class="remove_exp_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div></div></div>'
    );
   ...
   $(document).on('click','#add_leave_approvers',function(e){        
    ...
    $("#leave_approvers_items").append(
      '<div class="next-leave-approver"><label class="control-label m-b-10 leave_appr" style="padding-left:0">Approver '+counts+'</label><div class="row"><div class="col-md-6"><select name="leave_approvers[]"id="approver'+counts+'" class="approvers select form-control" style="width:260px;"><option value="">Select Approver</option></select></div><div class="col-md-2"><a class="remove_leave_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div></div></div>'
    );
 ...
 //    //Append a new row of code to the "#items" div
 //    $("#expense_approvers_items").append(
 //      '<div class="next-exp-approver"><label class="control-label m-b-10 exp_appr" style="padding-left:0">Approver '+counts+'</label><div class="row"><div class="col-md-4"><div class="form-group"><select style="width:260px" name="expense_approvers_dept[]" data-no="'+counts+'" id="expense_approvers_dept'+counts+'" class="approvers select2-option form-control expense_approvers_dept"><option value="">Select Department</option></select></div></div><div class="col-md-2"><a class="remove_exp_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div><div class="col-md-10"><div class="form-group"><select class="select2-option form-control expense_approvers" style="width:260px" name="expense_approvers[]" id="expense_approvers'+counts+'"><option value="">Select Approvers</option></select></div></div></div></div>'
 //    );

 //    $.ajax({
 //        type: "POST",
 //        url: base_url+"settings/get_department",
 //        data:{id:$(this).val()}, 
 //        beforeSend :function(){
 //          $("#expense_approvers_dept"+counts+" option:gt(0)").remove(); 
 //          $('#expense_approvers_dept'+counts).find("option:eq(0)").html("Please wait..");
          
 //        },                         
 //        success: function (data) {   
 //           $('#expense_approvers_dept'+counts).find("option:eq(0)").html("Select Department");
 //          var obj=jQuery.parseJSON(data);       
 //           $(obj).each(function(){
 //            var option = $('<option />');
 //            option.attr('value', this.value).text(this.label);           
 //            $('#expense_approvers_dept'+counts).append(option);
 //          });       
 //          }
 //      });
 //    });
 ...
 //    //Append a new row of code to the "#items" div
 //    $("#leave_approvers_items").append(
 //      '<div class="next-leave-approver"><label class="control-label m-b-10 leave_appr" style="padding-left:0">Approver '+counts+'</label><div class="row"><div class="col-md-4"><div class="form-group"> <select style="width:260px" name="leave_approvers_dept[]" data-no="'+counts+'" id="leave_approvers_dept'+counts+'" class="approvers select2-option form-control leave_approvers_dept"><option value="">Select Department</option></select></div></div><div class="col-md-2"><a class="remove_leave_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div><div class="col-md-10"><div class="form-group"><select class="select2-option form-control leave_approvers"   style="width:260px" name="leave_approvers[]" id="leave_approvers'+counts+'"><option value="">Select Approvers</option></select></div></div></div></div>'
 //    );
 ...
 //        data:{id:$(this).val()}, 
 //        beforeSend :function(){
 //          $("#leave_approvers_dept"+counts+" option:gt(0)").remove(); 
 //          $('#leave_approvers_dept'+counts).find("option:eq(0)").html("Please wait..");
          
 //        },                         
 //        success: function (data) {   
 //           $('#leave_approvers_dept'+counts).find("option:eq(0)").html("Select Department");
 //          var obj=jQuery.parseJSON(data);       
 //           $(obj).each(function(){
 //            var option = $('<option />');
 //            option.attr('value', this.value).text(this.label);           
 //            $('#leave_approvers_dept'+counts).append(option);
 //          });       
 //          }
 //      });
		...
		$(document).ready(function() {
				...
				'<a href="javascript:void(0);" class="goal_remove goals_remove" title="Remove"><i class="fa fa-times"></i></a>' +
					'<div class="table-responsive">' +
						'<table class="table performance-table perform-align" style="table-layout:fixed;width:initial;">' +
							'<thead>' +
								'<tr>' +
									'<th class="goalCount com-goal-width">Goal '+count+'</th>' +
                                                                ...
                                                                '<ul class="task-list" id="tasklist">'+
                                                                    '<li class="task">'+
                                                                        '<div class="task-container">'+
                                                                            ...
                                                                            '<input type="hidden" class="form-control result" name="result[]"  value="">'+                                                                            '<span class="task-action-btn task-btn-right">'+
			...
			function KeyResultContent(value,teamlead_id) {
				...
				return '<td>' +
					...
					'</td>' +
				'<td><button class="text-danger btn btn-white key-remove" title="Remove"><i class="fa fa-times"></i></button></td>'
			}
            ...
            $(document).on("click","#add_smart_another_goal",function() {
                var count = $("#count").val();
                var teamlead_id = $("#teamlead").val();
                // alert(teamlead_id);
                $("#count").val(parseInt(count)+1);
                ...
                var dynamic_div = addnewSmartGoalContent(count,teamlead_id);
                $(".add-another-goal").before(dynamic_div);
                // alert(dynamic_div);
            });
            ...
            function addnewSmartGoalContent(count,teamlead_id) {
                var count_incre = parseInt(count)+1;
                ...
                return '<form class="form-horizontal perform_360"  action="smartgoal/create_360" method="POST"><div class="performance-box">' +
                '<a href="javascript:void(0);" class="goal_remove goals_remove" title="Remove"><i class="fa fa-times"></i></a>' +
                    '<div class="table-responsive">' +
                        '<table class="table performance-table perform-align" style="table-layout:fixed;width:initial;">' +
                            '<thead>' +
                                '<tr>' +
                                '<th class="goalCount smt-goal-width">Goal '+count+'</th>' +
                                '<th class="text-center" style="min-width: 140px;width:140px;max-width:140px;">Status</th>' +
                                ...
                                '<th class="text-center" style="width: 110px;min-width:110px;max-width:110px;">Feedback </th>' +
                                '</tr>' +
                            '</thead>' +
                            '<tbody>' +
                                '<tr>' +
                            ...
                            '<tbody>' +
                                ...
                                '<tr>' +
                                    '<td class="smt-table-task-td-goal">' +
                                                    ...
                                                    '<div class="m-t-30 text-right">'+
                                                                    '<button class="btn btn-primary" type="submit" id="create_okr_submit">Create Goal</button>'+
                                                                '</div>' +
			...
			function addSmartGoalContent(count) {
				...
				'<div class="table-responsive">' +
					'<table class="table performance-table perform-align">' +
						'<thead>' +
							'<tr>' +
								'<th class="goalCount smt-goal-width">'+goal_count+'</th>' +
							     '<th class="text-center" style="min-width: 140px;">Status</th>' +
								'<th class="text-center" style="min-width: 160px;">Start </th>' +
								'<th class="text-center" style="min-width: 160px;">Completed </th>' +
   ...
   //          }); 
	...
	// Smart Goal End
	  ...
	  $(document).on('click','.create_goal_submit',function(){
		...
		{
            $('.progress_per').addClass('progress_percentage');
			if($(e).closest('li').hasClass('completed'))
			{
				$(e).closest('li').removeClass('completed');
                $(e).closest('li').find("input[name='result[]']").val(0);
			}
			else 
			{
				$(e).closest('li').addClass('completed');	
                $(e).closest('li').find("input[name='result[]']").val(1);
			}
...
/*			var task_list = $(e).closest('ul#tasklist li').length
        ...
        $(document).on("change",".manager_rating",function() {  
         ...
         $(document).on("change",".smartgoal_rating",function() {  
            
            var id      =    $(this).attr('data-id');
            var rating  =    $(this).val();
            if(rating != ''){
                $.post(base_url+'smartgoal/smartgoal_rating/',{id:id, rating:rating},function(res){               
                    if(res == 'yes'){
                         toastr.success('Rated successfully');
                   setTimeout(function () {
                        location.reload();
                 ...
                 toastr.error('please select the rating');
            }
        ...
        $(document).on("change",".employee_competence_rating",function() {  
         ...
         $(document).on("click",".performance_status",function() {           
           ...
           if(performance_status == 'okr'){
                msg = 'OKRs';
           }else if(performance_status == 'competency'){
                 msg = 'Competency-based';
           }else if(performance_status == 'smart_goals'){
                msg = 'SMART Goals';
           }
            ...
            $.post(base_url+'settings/performance_status/',{performance_status:performance_status},function(res){
                if(res == 'yes'){
                     toastr.success(msg +' Activated Successfully');
               setTimeout(function () {
