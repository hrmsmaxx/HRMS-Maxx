...
if($('#filter_search').length > 0) {
	...
	$(document).on('click', '#topup_status', function() {
		$('#topup_status_form').slideToggle("slow");
	});
}
...
$(document).on('click','[data-dismiss="modal"]',function(e){$('#ajaxModal').remove();
...
$(document).on('click',"#task_board_save",function() {
        ...
        if(task_board_name == '')
        {
            ...
            $.post(base_url + 'crm/lead_board_add/', { project_id: project_id,task_board_name: task_board_name,task_board_color:task_board_color,task_board_bc:task_board_bc,task_board_class: task_board_class}, function (datas) {
               ...
               setTimeout(function(){ toastr.success('lead Board saved Successfully'); 
                                location.reload();
                            }, 1500);   
            });
        }
...
$(document).on('click',"#task_board_edit",function() {
        ...
        if(task_board_name == '')
        {
            ...
            $.post(base_url + 'crm/lead_board_edit/', { task_board_id: task_board_id, project_id: project_id,task_board_name: task_board_name,task_board_color:task_board_color,task_board_bc:task_board_bc,task_board_class:task_board_class}, function (datas) {
               ...
               setTimeout(function(){ toastr.success('Lead Board Edited Successfully'); 
                                location.reload();
                            }, 1500);   
            });
        }
...
$(document).on("click","#add_another_goal",function() {
			...
			function addGoalContent(count,teamlead_id) {
				...
				return '<form class="form-horizontal perform_360"  action="performance_three_sixty/create_360" method="POST"><div class="row">' + '<div class="col-md-12">' + '<div class="performance-box">' +
            ...
            function addnewSmartGoalContent(count,teamlead_id) {
                ...
                return '<form class="form-horizontal perform_360"  action="smartgoal/create_360" method="POST"><div class="row"><div class="col-md-12"><div class="performance-box">' +
                '<a href="javascript:void(0);" class="goal_remove goals_remove" title="Remove"><i class="fa fa-times"></i></a>' +
                    '<div class="table-responsive">' +
                        '<table class="table performance-table perform-align" style="table-layout:fixed;width:initial;">' +
                            '<thead>' +
			...
			function addSmartGoalContent(count) {
				...
				return '<div class="row"><div class="col-md-12"><div class="performance-box">' +
