...
$(document).on('click','.approval-option input[type="radio"]',function(){
    ...
    $("#expense_approvers_items").append(
      '<div class="next-exp-approver"><label class="control-label m-b-10 exp_appr" style="padding-left:0">Approver '+counts+'</label><div class="row"><div class="col-md-6"><div class="form-group"><select name="expense_approvers_dept[]" data-no="'+counts+'" id="expense_approvers_dept'+counts+'" class="approvers select2-option form-control expense_approvers_dept"><option value="">Select Department</option></select></div></div><div class="col-md-2"><a class="remove_exp_approver btn rounded border text-danger"><i class="fa fa-times" aria-hidden="true"></i></a></div><div class="col-md-10"><div class="form-group"><select class="select2-option form-control expense_approvers"   style="width:260px" name="expense_approvers[]" id="expense_approvers'+counts+'"><option value="">Select Approvers</option></select></div></div></div></div>'
    );
