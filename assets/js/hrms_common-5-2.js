 ...
 function offerValidateCreate()
    {
         ...
         $(document).ready(function() {
            ...
            function addObjectiveContent(count) {
                ...
                return '<div class="performance-box m-t-15">' +
                            ...
                            '<tr>' +
                                '<td>' +
                                    '<div class="label-input">' +
                                        ...
                                        '<input type="text" class="form-control" name="key_result['+array_count+'][]">' +
                                ...
                                '<td class="text-center">' +
                                    '<span class="badge btn-info">Pending</span>' +
                                      ' <input type="hidden" class="key_status" name="key_status['+array_count+'][]" value="Pending">' +
                                '</td>' +
                                '<td class="text-center">' +
                                    '<button class="btn btn-warning keyres_progress" type="button" id="keyres_progress" onclick="show_keyprogress_bar(this)" name="key_progress['+array_count+'][]">0%</button>' +
                                '<input type="hidden" class="keyres_value" name="keyres_value['+array_count+'][]" value="">' + 
                                '</td>' +
                                '<td class="text-center">' +
                                    // '<strong class="key_grade">0</strong>' +
                                    // '<input type="hidden" class="key_gradeval" name="key_gradeval[]" value="">' +
                                    '<select class="form-control select" name="key_gradeval['+array_count+'][]" disabled>' +
                                            option +
                                    '</select>' +
                                '</td>' +
                                '<td class="text-center">'+
        ...
        $(document).ready(function() {
            ...
            function KeyResultContent(count,array_count) {
                ...
                return '<td>' +
                    ...
                    '<input type="text" class="form-control" name="key_result['+array_count+'][]">' +
                    '<a href="javascript:void(0);" class="text-danger key-remove" data-arrayval="'+array_count+'" title="Remove"><i class="fa fa-times"></i></a>' +
                    '</div>' + 
                    '</td>' + 
                '<td class="text-center"><span class="badge btn-info">Pending</span>' + 
                '<input type="hidden" class="key_status" name="key_status['+array_count+'][]" value="Pending">' +
                '</td>' + 
                '<td class="text-center"><button class="btn btn-warning keyres_progress" type="button" onclick="show_keyprogress_bar(this)" name="key_progress['+array_count+'][]">0%</button>' +
                '<input type="hidden" class="keyres_value" name="keyres_value['+array_count+'][]" value="">' + '</td>' +
                ...
                '</td>' + 
                '<td class="text-center"><button class="btn btn-white" type="button" data-toggle="modal" data-target="#opj_feedback"><i class="fa fa-commenting"></i></button></td>'
            }
