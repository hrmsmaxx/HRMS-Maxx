                  ...
                  <!--   <div class="form-group">
                        ...
                        <div class="col-md-9 approval-option">
                            ...
                            <label class="radio-inline">
                                <input id="radio-single" class="default_expense_approval" value="seq-approver" <?php echo ($default_expense_approval =='seq-approver')?"checked":"";?> name="default_expense_approval" type="hidden" checked>Sequence Approval (Chain) <sup> <span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                            </label>
                             <label class="radio-inline">
                     ...
                     <input value="seq-approver"  name="default_expense_approval" type="hidden" >
                     <div class="form-group row approverc seq-approverc" >
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <div class="row ex_exp_approvers_<?php echo $i;?>">
                                <div class="col-md-6">
                                        <div class="form-group">
                                  <select class="select2-option form-control expense_approvers_dept"   style="width:260px" data-no="<?php echo $i;?>" name="expense_approvers_dept[]" id="expense_approvers_dept<?php echo $i;?>"> 
                                <optgroup>Select Approvers</optgroup> 
                                <optgroup label="Staff">
                                    <option value="">Select Approvers</option>
                                    <?php foreach ($departments as $department): ?>
                                        <option value="<?=$department->deptid?>"  <?php echo ($expense_approver['dept_id'] ==$department->deptid)?"selected":"";?>>
                                           <?=ucfirst($department->deptname)?>
                                        </option>
                                    <?php endforeach ?>
                                </optgroup> 
                            </select>
                            ...
                            <?php 
                                        ...
                                        $this->db->where('U.department_id',$expense_approver['dept_id']);        
                                        $users =$this->db->get()->result(); ?>
                                    <div class="form-group">
                                      <select class="select2-option form-control expense_approvers"   style="width:260px" name="expense_approvers[]" id="expense_approvers<?php echo $i;?>"> 
                                          <option value="">Select Approvers</option>
                                           <?php foreach ($users as $user): ?>
                                                <option value="<?=$user->id?>"  <?php echo ($expense_approver['approvers'] ==$user->id)?"selected":"";?>>
                        ...
                        <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <optgroup label="Staff">
                                    <option value="">Select Approvers</option>
                                    <?php foreach ($departments as $department): ?>
                                        <option value="<?=$departments->deptid?>"  >
                                            <?=ucfirst($departments->deptname)?>
                                        </option>
                                    <?php endforeach ?>
                                </optgroup> 
                            </select>
                            ...
                            <div class="row">
                              <div class="col-md-10">
                                <div class="form-group">
                                  <select class="select2-option form-control expense_approvers_dept"   style="width:260px" data-no="" name="expense_approvers_dept[]" id="expense_approvers_dept"> 
                                    ...
                                    <select class="select2-option form-control expense_approvers_sim" multiple="multiple" style="width:260px" name="expense_approvers_sim[]" > 
                                        <optgroup label="Staff">
                                            ...
                                            foreach ($departments as $department){ ?>
                                                <option value="<?=$department->deptid?>" <?php echo ($expense_approver['approvers'] ==$department->deptid)?"selected":"";?>>
                                                  <?=ucfirst($department->deptname)?>
                                                </option>
      ...
      <?php if(User::is_admin()) { ?>
        <form action="<?php echo base_url(); ?>settings/leave_approval_settings" id="tokbox_form" cl
          ss="bs-example form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
               ...
               <input  value="seq-approver" name="default_leave_approval" type="hidden">
                    <!-- <input type="hidden" name="settings" value="offer_approval_setting"> -->
                        ...
                        <div class="col-sm-9 ">
                            <!--
                                ...
                                <div class="row ex_leave_approvers_<?php echo $i;?>">
                                  <div class="col-md-6">
                                    <div class="form-group">                                    
                                      <select class="select2-option form-control leave_approvers_dept"   style="width:260px" data-no="<?php echo $i;?>" name="leave_approvers_dept[]" id="leave_approvers_dept<?php echo $i;?>">  
                                        <option value="">Select Department</option>
                                        <?php foreach ($departments as $department): ?>
                                            <option value="<?=$department->deptid?>"  <?php echo ($leave_approver['dept_id'] ==$department->deptid)?"selected":"";?>>
                                                <?=ucfirst($department->deptname)?>
                                            </option>
                                        <?php endforeach ?>
                                      </select>
                                    ...
                                    <?php 
                                         ...
                                         $this->db->from('users U');
                                        $this->db->join('account_details AD','AD.user_id=U.id',"LEFT");
                                        $this->db->where('U.department_id',$leave_approver['dept_id']);        
                                        $users =$this->db->get()->result(); ?>
                                    <div class="form-group">
                                      <select class="select2-option form-control leave_approvers"   style="width:260px" name="leave_approvers[]" id="leave_approvers<?php echo $i;?>"> 
                                          <option value="">Select Approvers</option>
                                           <?php foreach ($users as $user): ?>
                                                <option value="<?=$user->id?>"  <?php echo ($leave_approver['approvers'] ==$user->id)?"selected":"";?>>
                                                    <?=ucfirst($user->fullname)?>
                                                </option>
                                            <?php endforeach ?>
                                      </select>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                     <select class="select2-option form-control leave_approvers"   style="width:260px" name="leave_approvers[]" id="leave_approvers0"> 
                                <optgroup>Select Approvers</optgroup> 
                                <optgroup label="Staff">
                                    <option value="">Select Approvers</option>
                                    <?php foreach ($departments as $department): ?>
                            ...
                            <div class="row">
                              <div class="col-md-10">
                                <div class="form-group">
                                  <select class="select2-option form-control leave_approvers_dept"   style="width:260px" data-no="" name="leave_approvers_dept[]" id="leave_approvers_dept">                                     
                                      <option value="">Select Department</option>
                                        <?php foreach ($departments as $department): ?>
                                          <option value="<?=$department->deptid?>"  >
                                              <?=ucfirst($department->deptname)?>
                   ...
                   <!--  <div class="form-group row approverc sim-approverc" >
                        <label class="control-label col-sm-3">leave Approvers</label>
                        <div class="col-sm-9 ">
