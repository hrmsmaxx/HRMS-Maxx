			...
			<div class="card-box leave-box" id="leave_annual">
				...
				<div class="leave-item">
					...
					<div class="leave-row">
						<div class="leave-left">
							<div class="input-box">
								<label class="d-block">Count Weekend days when employee request Leave<sup> <span class="badge info-badge" data-toggle="tooltip" data-placement="top" title="Count Weekend days when employee request Leave"><i class="fa fa-info" aria-hidden="true"></i></span></sup></label>
								<div class="leave-inline-form checkbox">
									<label class="radio-inline">
									<?php $leave_weekend = $this->db->get_where('leave_weekend')->row_array();

										$weekend = explode(',', $leave_weekend['days']);
									 ?>
										<input type="checkbox" name="days[]" class="weekend" value="saturday"  disabled="disabled" <?php echo (isset($weekend[0]) && $weekend[0] == 'saturday')?"checked":"";?>>Saturday
									</label>
									<label class="radio-inline">
										<input type="checkbox" name="days[]" class="weekend" value="sunday" disabled="disabled" <?php echo (isset($weekend[1]) && $weekend[1] == 'sunday')?"checked":"";?> <?php echo (isset($weekend[0]) && $weekend[0] == 'sunday')?"checked":"";?>>Sunday
									</label>
						...
						<div class="leave-right">
							<button class="leave-edit-btn" type="button" data-typ="leave_weekend">Edit</button>
						</div>
						<!-- <div class="leave-right">
							<div class="UpdateMaxBtn" style="display: none;">
								<button class="btn btn-white CancelMaxBtn" >Cancel</button>
