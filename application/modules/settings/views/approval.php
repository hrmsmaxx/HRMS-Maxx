 ...
 // echo $active_performance; exit();
    ...
    $offer_approvers = $this->db->where('subdomain_id',$this->session->userdata('subdomain_id'))->get('offer_approver_settings')->result_array();

    if(!empty($offer_approvers)){

        $default_offer_approvals = $this->db->get_where('offer_approver_settings',array('default_offer_approval'=>'seq-approver','subdomain_id'=>$this->session->userdata('subdomain_id')))->result_array();
    ...
    $leave_approvers = $this->db->where('subdomain_id',$this->session->userdata('subdomain_id'))->get('leave_approver_settings')->result_array();
    //echo print_r($leave_approvers); exit;

    if(!empty($leave_approvers)){

        $default_leave_approvals = $this->db->get_where('leave_approver_settings',array('default_leave_approval'=>'seq-approver','subdomain_id'=>$this->session->userdata('subdomain_id')))->result_array();
    ...
    $expense_approvers = $this->db->where('subdomain_id',$this->session->userdata('subdomain_id'))->get('expense_approver_settings')->result_array();

    if(!empty($expense_approvers)){

        $default_expense_approvals = $this->db->get_where('expense_approver_settings',array('default_expense_approval'=>'seq-approver','subdomain_id'=>$this->session->userdata('subdomain_id')))->result_array();
            ...
            <div class="col-lg-12 p-0">
               ...
               <div class="panel panel-white m-b-0">
                  ...
                  <div class="panel-heading">
                     ...
                     <h3 class="panel-title p-5"><?php echo lang('approval_setting');?></h3>
                  ...
                  <div class="panel-body">
                     ...
                     <ul class="nav nav-tabs nav-tabs-solid m-b-20">
                        ...
                        <li class="<?php echo ('expense_approval' == $active_approval )?'active':'';?>"><a href="#" id='expense_approval'><?php echo lang('expenses_approval');?></a></li>                       

						      <li class="<?php echo ('leave_approval' == $active_approval )?'active':'';?>" ><a href="#" id='leave_approval'><?php echo lang('leave_approval');?></a></li>

                        <li class="<?php echo ('offer_approval' == $active_approval )?'active':'';?>"><a href="#" id='offer_app_view' ><?php echo lang('offer_approval');?></a>
   ...
   <div class="div_table-expenses " style="<?php echo ('expense_approval' == $active_approval )?'':'display: none';?>">
      ...
      <?php if(User::is_admin()) { ?>
        ...
        <form action="<?php echo base_url(); ?>settings/expense_approval_settings" id="tokbox_form" class="bs-example form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
               ...
               <h3><?php echo lang('expenses_approval_settings');?></h3>

                    <!-- <input type="hidden" name="settings" value="offer_approval_setting"> -->

                    <div class="form-group">

                        <label class="control-label col-md-3"><?php echo lang('default_expenses_approval');?></label>

                        <div class="col-md-9 approval-option">

                            <label class="radio-inline">

                                <input id="radio-single" class="default_expense_approval" value="seq-approver" <?php echo ($default_expense_approval =='seq-approver')?"checked":"";?> name="default_expense_approval" type="radio"><?php echo lang('sequence_approval_(chain)');?> <sup> <span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>

                            </label>

                            <label class="radio-inline">

                                <input id="radio-multiple" class="default_expense_approval" value="sim-approver" <?php echo ($default_expense_approval =='sim-approver')?"checked":"";?> name="default_expense_approval"type="radio"><?php echo lang('simultaneous_approval');?> <sup><span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                     ...
                     <div class="form-group row approver seq-approver" style="<?php echo ($expense_seq_approve =='seq-approver')?"display: block;":"";?>">
                        ...
                        <label class="control-label col-sm-3"><?php echo lang('expense_approvers');?></label>
                        ...
                        <div class="col-sm-9 ">
                                ...
                                if(!empty($expense_approvers)){
                                    ...
                                    if($expense_seq_approve == 'seq-approver') { 
                                        ...
                                        <label class="ex_exp_approvers_<?php echo $i;?> control-label m-b-10 exp_appr" style="padding-left:0"><?php echo lang('approvers');?> <?php echo $i;?></label>
                            ...
                            <div class="row ex_exp_approvers_<?php echo $i;?>">
                                ...
                                <optgroup><?php echo lang('select_approvers');?></optgroup> 

                                <optgroup label="Staff">

                                    <option value=""><?php echo lang('select_approvers');?></option>

                                    <?php foreach ($designations as $designation):  
                                          if($designation->subdomain_id == $this->session->userdata('subdomain_id')){
                                      ?>
                        ...
                        <?php } ?>
                                   ...
                                   <?php  $i++;
                                        ...
                                        <label class="control-label m-b-10" style="padding-left:0"><?php echo lang('approver_1');?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-offset-3 m-t-10">
                                ...
                                <a id="add_expense_approvers" href="javascript:void(0)" class="add-more">+ <?php echo lang('add_approvers');?></a>
                    ...
                    <div class="form-group row approver sim-approver" style="<?php echo ($expense_sim_approve =='sim-approver')?"display: block;":"";?>">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <label class="control-label" style="margin-bottom:10px;padding-left:0"><?php echo lang('simultaneous_approval');?> </label>
                     ...
                     <div class="m-t-30 m-b-30">
                        ...
                        <div class="col-md-9">
                          ...
                          <button id="expense_approval_set_btn" type="submit" class="btn btn-primary btn-lg"><?php echo lang('save_changes');?></button>
	...
	<div class="div_offer_app "  style="<?php echo ('offer_approval' == $active_approval )?'':'display: none';?>">
      ...
      <?php if(User::is_admin()) { ?>
        ...
        <form action="<?php echo base_url(); ?>settings/offer_approval_settings" id="tokbox_form" class="bs-example form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
               ...
               <h3><?php echo lang('offer_approval_settings');?></h3>

                    <!-- <input type="hidden" name="settings" value="offer_approval_setting"> -->

                    <div class="form-group">

                        <label class="control-label col-md-3"><?php echo lang('default_offer_approval');?></label>

                        <div class="col-md-9 approval-option">

                            <label class="radio-inline">

                                <input id="radio-single" class="default_offer_approval" value="seq-approver" <?php echo ($default_offer_approval =='seq-approver')?"checked":"";?> name="default_offer_approval" type="radio"><?php echo lang('sequence_approval_(chain)');?> <sup> <span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>

                            </label>

                            <label class="radio-inline">

                                <input id="radio-multiple" class="default_offer_approval" value="sim-approver" <?php echo ($default_offer_approval =='sim-approver')?"checked":"";?> name="default_offer_approval"type="radio"><?php echo lang('simultaneous_approval');?> <sup><span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                     ...
                     <div class="m-t-30 m-b-30">
                        ...
                        <div class="col-md-9">
                          ...
                          <button id="offer_approval_set_btn" type="submit" class="btn btn-primary btn-lg"><?php echo lang('save_changes');?></button>
      ...
      <?php if(User::is_admin()) { ?>
        ...
        <form action="<?php echo base_url(); ?>settings/leave_approval_settings" id="tokbox_form" cl
          ...
          ss="bs-example form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
               ...
               <h3><?php echo lang('leave_approval_settings');?></h3>

                    <!-- <input type="hidden" name="settings" value="offer_approval_setting"> -->

                    <div class="form-group row">

                        <label class="control-label col-md-3"><?php echo lang('default_leave_approval');?></label>

                        <div class="col-md-9 approval-option">

                            <label class="radio-inline">

                                <input id="radio-single" class="default_offer_approval" value="seq-approver" <?php echo ($default_leave_approval =='seq-approver')?"checked":"";?> name="default_leave_approval" type="radio"><?php echo lang('sequence_approval_(chain)');?><sup> <span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>

                            </label>

                            <label class="radio-inline">

                                <input id="radio-multiple" class="default_offer_approval" value="sim-approver" <?php echo ($default_leave_approval =='sim-approver')?"checked":"";?> name="default_leave_approval"type="radio"><?php echo lang('simultaneous_approval');?> <sup><span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                     ...
                     <div class="form-group row approver seq-approver" style="<?php echo ($leave_seq_approve =='seq-approver')?"display: block;":"";?>">
                        ...
                        <label class="control-label col-sm-3"><?php echo lang('leave_approvers');?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 col-md-offset-3 m-t-10">
                                ...
                                <a id="add_leave_approvers" href="javascript:void(0)" class="add-more">+ <?php echo lang('add_approvers');?></a>
                    ...
                    <div class="form-group row approver sim-approver" style="<?php echo ($leave_sim_approve =='sim-approver')?"display: block;":"";?>">
                     ...
                     <div class="m-t-30 m-b-30">
                        ...
                        <div class="col-md-9">
                          ...
                          <button id="leave_approval_set_btn" type="submit" class="btn btn-primary btn-lg"><?php echo lang('save_changes');?></button>
