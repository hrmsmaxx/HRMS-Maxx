...
$email['user'] = array("activate_account","change_email","forgot_password","registration","reset_password","email_log");
...
<ul class="nav nav-tabs nav-tabs-bottom m-b-30">
	<li><a href="<?php echo base_url(); ?>settings/?settings=email"><?=lang('email_settings');?></a></li>
	<li class="active"><a href="<?php echo base_url(); ?>settings/?settings=templates"><?=lang('email_templates');?></a></li>
</ul>
    <div class="p-0">
