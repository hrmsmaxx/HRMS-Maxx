...
<div class="panel panel-white m-b-0">
	<div class="panel-heading">
		<div class="row">
			<div class="col-xs-6">
				<h3 class="panel-title m-l-0 m-t-10"><?php echo lang('translations')?></h3>
			</div>
			<div class="col-xs-6">
				<div class="pull-right add-translation">
					...
					<button id="add-translation" class="btn btn-primary btn-md"><?php echo lang('add_translation')?></button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="table-responsive">
			<table id="table-translations" class="table table-striped table-bordered custom-table m-b-0 AppendDataTables">
				...
				<tbody>
					...
					?>
					<tr>
						<td class=""><img src="<?php echo base_url('assets/images/flags/'.$l->icon)?>.gif" /></td>
						...
						<td class="text-right">
						  <a data-rel="tooltip" data-original-title="<?php echo lang('backup')?>" class="backup-translation btn btn-xs btn-default" href="#" data-href="<?php echo base_url()?>settings/translations/backup/<?php echo $l->name?>/?settings=translations"><i class="fa fa-download"></i></a>
						  <a data-rel="tooltip" data-original-title="<?php echo lang('restore')?>" class="restore-translation btn btn-xs btn-default" href="#" data-href="<?php echo base_url()?>settings/translations/restore/<?php echo $l->name?>/?settings=translations"><i class="fa fa-upload"></i></a>
						  <a data-rel="tooltip" data-original-title="<?php echo ($l->active == 1 ? lang('deactivate') : lang('activate') )?>" class="active-translation btn btn-xs btn-<?php echo ($l->active == 0 ? 'default' : 'success' )?>" href="#" data-href="<?php echo base_url()?>settings/translations/active/<?php echo $l->name?>/?settings=translations"><i class="fa fa-eye"></i></a>
...
<div class="panel panel-white">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo lang('translations')?> - <?php echo ucwords($language)?></h3>
	</div>
	<div class="panel-body">
		<div class="table-responsive">
			<table id="table-translations-files" class="table table-striped table-bordered custom-table m-b-0 AppendDataTables">
                <thead>
					<tr>
						...
						<th class="col-options no-sort col-xs-1 text-right"><?php echo lang('action')?></th>
					</tr>
                </thead>
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td class=""><?php echo ($altpath == './system/' ? 'System':'Application')?></td>
		...
		<div class="panel-heading">
			<div class="row">
				<div class="col-xs-6">
					...
					if ($language_file == 'fx') { $fn = lang('main_application'); }
					if ($language_file == 'tank_auth') { $fn = lang('authenication'); }
        ...
        <div class="panel-body">
			<div class="table-responsive">
				<table id="table-strings" class="table table-striped table-bordered custom-table m-b-0 AppendDataTables">
					<thead>
						<tr>
							<th class="col-xs-5"><?php echo lang('english'); ?></th>
