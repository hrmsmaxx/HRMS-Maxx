		...
		echo form_open('settings/slack_conf', $attributes); ?>
			<div class="panel panel-white">
				<div class="panel-heading">
					<h3 class="panel-title p-5"><?=lang('slack_integration'); ?></h3>
				</div>
				<div class="panel-body">
					<?php echo validation_errors(); ?>
					<input type="hidden" name="settings" value="<?=$load_setting?>">
					<div class="form-group">
						<label class="col-lg-3 control-label"><?=lang('slack_notification'); ?></label>
						<div class="col-lg-3">
							<label class="switch">
					...
					<div class="form-group">
						<label class="col-lg-3 control-label"><?=lang('slack_username'); ?> <span class="text-danger">*</span></label>
						<div class="col-lg-3">
							<input type="text" class="form-control" value="<?=config_item('slack_username')?>" name="slack_username" data-required="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label"><?=lang('slack_channel'); ?> <span class="text-danger">*</span></label>
						<div class="col-lg-3">
							<input type="text" class="form-control" value="<?=config_item('slack_channel')?>" name="slack_channel" data-required="true">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-3 control-label"><?=lang('slack_webhook'); ?> <span class="text-danger">*</span></label>
						<div class="col-lg-8">
