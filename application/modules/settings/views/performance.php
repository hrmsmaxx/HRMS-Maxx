											...
											<div class="col-md-12 col-lg-12">
												<!-- <form id="okr_description" action="<?=base_url()?>settings/okr_description" method="POST"> -->
													<div class="form-group">
														...
														<textarea rows="5" cols="5" class="form-control" name="description"><?php echo $okr_description['description'];?></textarea>
													</div>
										...
										<div class="row">
											<div class="col-md-12">
												<!-- <form id="compentency_tab" action="<?php echo base_url()?>settings/insert_competencies" method="post"> -->
													...
													<div class="submit-section">														
														<button  class="m-0 btn btn-primary submit-btn performance_status <?php echo ($performance_status['competency'] ==1)?"red_circle":"";?>" data-status="competency" <?php echo ($performance_status['competency'] ==1)?"disabled":"";?> title="<?php echo ($performance_status['competency'] ==1)?"Admin can’t activate it again":"";?>" <?php if($performance_status['competency'] ==1){ ?> style="background-color: #c7c7c7;border: 1px solid #c7c7c7; margin: 23px 0px;" <?php } else{?> style="margin: 23px 0px;"
