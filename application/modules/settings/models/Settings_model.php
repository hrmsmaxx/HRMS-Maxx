...
class Settings_model extends CI_Model
{
    ...
    function add_translation($language, $files)
    {
        ...
        public function save_leave_approver_settings($data = array()) {
         $this->db->insert('leave_approver_settings',$data);
        return  $this->db -> insert_id();
    }
    public function save_expense_approver_settings($data = array()) {
         $this->db->insert('expense_approver_settings',$data);
        return  $this->db -> insert_id();
    }
}
