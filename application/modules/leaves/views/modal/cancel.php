<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header bg-danger">
			...
			<h4 class="modal-title"> <?php echo lang('cancel_leave');?>  </h4>
		</div>
		<?php echo form_open(base_url().'leaves/cancel'); ?>
			<div class="modal-body">
				<p> <?php echo lang('are_you_sure_want_cancel_this_leave_request');?></p>
			...
			<div class="modal-footer"> 
				<button type="submit" class="btn btn-danger"> <?php echo lang('cancel');?> </button>
