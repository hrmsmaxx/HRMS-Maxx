<div class="content">
    <div class="row">
        ...
        <div class="col-sm-4  text-right m-b-20">     
              <a class="btn back-btn" href="<?=base_url()?>categories"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
          </div>
    </div>
    <div class="card-box">
		<div class="row">
			<div class="col-sm-12 text-right m-b-30">
				...
				<a href="<?=base_url()?>categories/sub_categories/<?php echo $category_id; ?>" class="btn btn-primary rounded" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?php echo lang('add_sub_category');?></a>
			</div>
		</div>
		<div class="row">
			<!-- Invoice Items -->
