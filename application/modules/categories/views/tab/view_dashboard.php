		...
		<div class="card-box">
			...
			<ul class="list-group no-radius m-b-0">
				...
				<li class="list-group-item">
					...
					<span class="text-muted"><?=lang('skype')?></span>
				</li>
				<?php endif; ?>
				<?php if($l->linkedin != '') : ?>
				<li class="list-group-item">
					...
					<span class="text-muted"><?=lang('linkedin')?></span>
				</li>
				<?php endif; ?>
				...
				<li class="list-group-item">
					...
					<span class="text-muted"><?=lang('facebook')?></span>
				</li>
				<?php endif; ?>
				<?php if($l->twitter != '') : ?>
				<li class="list-group-item">
					...
					<span class="text-muted"><?=lang('twitter')?></span>
				</li>
				<?php endif; ?>
...
<div class="card-box">
	<h3 class="card-title"><?=lang('description')?></h3>
