          ...
          <div class="row filter-row">
            ...
            <div class="col-sm-3 col-md-2 col-xs-6"> 
              <div class="form-group form-focus select-focus">
                ...
                <select class="floating form-control" id="ticket_status" name="ticket_status"> 
            ...
            <div class="col-sm-3 col-md-2 col-xs-6"> 
              <div class="form-group form-focus select-focus">
                ...
                <select class="floating form-control" id="ticked_priority" name="ticked_priority"> 
