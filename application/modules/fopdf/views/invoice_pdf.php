...
//Set your logo
$invoice->setLogo("assets/images/logos/".config_item('invoice_logo')); // $invoice->setLogo(image,maxwidth,maxheight);
//Set theme color
...
if(isset($attach)){
  $render = 'F';
  $invoice->render('./assets/tmp/'.lang('invoice').' '.$inv->reference_no.'.pdf',$render);
}else{
  $render = 'D';
