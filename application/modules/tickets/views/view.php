...
<div class="row">
    ...
    <div class="col-xs-8">
        ...
        <h4 class="page-title"><?php echo lang('preview_ticket');?></h4>
                        ...
                        <div class="row p-0">
								...
								<div class="panel panel-white">
													...
													<div class="panel panel-white m-t-3">
														<div class="panel-body">
															<h5 class="panel-title m-b-20"><?php echo lang('upload_image_files'); ?></h5>
															<div class="row">
						...
						<?php } } else { ?>
								...
								<div class="chat-footer">
                                    ...
                                    <div class="comment-item media" id="comment-form">
                                        <a class="pull-left thumb-sm avatar" style="padding-right:0">
                                           
            <img src="<?php echo User::avatar_url(User::get_id()); ?>" class="img-circle" style="width:30px;height:30px;">
                                        ...
                                        <div class="media-body">
                                            <div class="foeditor-noborder">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                    <div class="col-md-12">
                                                        <label class="btn btn-default btn-filechoose"><?php echo lang('choose_file')?></label>                  
