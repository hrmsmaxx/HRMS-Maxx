...
<?=lang('create_ticket')?></button>
		...
		<?php }else{
          ...
          <div class="form-group">
				...
				<?php if (User::is_admin()) { ?>
				<a href="<?=base_url()?>settings/?settings=departments" class="btn m-l-15 btn-info" data-toggle="tooltip" title="<?=lang('departments')?>"><i class="fa fa-plus"></i> <?=lang('departments')?></a>
				<?php } ?>
