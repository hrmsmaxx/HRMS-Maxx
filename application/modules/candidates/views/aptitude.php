...
<div class="content p-t-10">
	<div class="row">
		<div class="col-xs-8">
			<h4 class="page-title"><?php echo lang('aptitude_test_screen');?></h4>
		</div>
		<div class="col-xs-4">
			<a href="<?php echo site_url('candidates/interviewing') ?>" class="btn btn-success text-right"><?php echo lang('back');?></a>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<div class="col-lg-7 ">
			...
			<div class="card-box">
				<p class="m-b-30"><?php echo lang('click_button_to_answer_your_question'); ?></p>
				<div class="row">
