		...
		<div class="table-responsive">
			<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $i++;?></td>
						<td><a href="<?php echo base_url(); ?>candidates/job_view/<?php echo $jobs->id;?>"><?php echo $jobs->job_title;?></a></td>
						 ...
						 <td class="text-center">
							<div class="dropdown action-label">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a class="dropdown-item" href="<?php echo site_url('candidates/user_offer_status_change/8/'.$jobs->candidate_id.'/'.$jobs->id);?>"><i class="fa fa-dot-circle-o text-info"></i> <?php echo lang("accept_offer"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('candidates/user_offer_status_change/9/'.$jobs->candidate_id.'/'.$jobs->job_id.'/');?>"><i class="fa fa-dot-circle-o text-danger"></i>  <?php echo lang("reject_offer"); ?></a></li>
