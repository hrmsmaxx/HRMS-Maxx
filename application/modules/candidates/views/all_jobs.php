...
<div class="content p-t-10">
	...
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-xs-6 col-md-3">  
			...
			<a href="#" data-toggle="collapse" data-target="#advance_search" class="text-info m-b-10" style="display:block;"><?php 
			echo lang('advanced_search')?></a><a href="<?php echo site_url('candidates/all_jobs'); ?>"  style="display:block;" ><?php echo lang('clear'); ?></a>
		</div>  
	</div>
</form>
	...
	<div class="row filter-row m-b-20">
		<div class="col-sm-12 col-xs-12 col-md-12"> 
			...
			<div id="advance_search" class="collapse m-t-20">
				<div class="row">
					<div class="col-lg-4">
			...
			<a class="job-list" href="<?php echo base_url(); ?>candidates/job_view/<?php echo $job->id;?>">
				<div class="job-list-det">
					<div class="job-list-desc">
						<h3 class="job-list-title"><?php echo $job->job_title;?></h3>
						<h4 class="job-department"><?php echo $job->deptname; ?></h4>
					</div>
					<div class="job-type-info">
						<span class="job-types"><?php  echo $job->job_type;?></span>
					</div>
				</div>
