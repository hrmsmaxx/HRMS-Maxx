						...
						<td class="text-center">
							<div class="dropdown action-label">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-info"></i> <?php echo lang('full_time');?></a></li>
									<li><a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-success"></i> <?php echo lang('part_time');?></a></li>
									<li><a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> <?php echo lang('internship');?></a></li>
									<li><a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-warning"></i> <?php echo lang('temporary');?></a></li>
