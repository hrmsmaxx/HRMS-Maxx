...
<div class="row admin-dash">
	<div class="col-md-6 col-sm-6 col-lg-3">
		<div class="dash-widget clearfix card-box">
			<span class="dash-widget-icon"><i class="fa fa-file-text-o" aria-hidden="true"></i></i></span>
...
<a href="<?php echo base_url(); ?>candidates/job_view/<?php echo $latest['id'];?>" class="list-group-item"><?php echo $latest['job_title'];?><span class="pull-right" style="font-size:12px; color: #a1a1a1;"><?php if($latest['days']>0){ echo $latest['days'].' days ago';}else{ echo $latest['hour'].' hours ago';}?></span></a>
<?php
					} ?>
			</div>
		</div>
				...
				<div class="table-responsive">
					<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
						...
						<tbody>
							...
							<tr>
								<td><?php echo $i++; ?></td>
								<td><a href="<?php echo base_url(); ?>candidates/job_view/<?php echo $offer->id;?>"><?php echo $offer->job_title;?></a></td>
					...
					<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
						...
						<tbody>
							...
							foreach ($applied_jobs as $key => $list) {
							 	...
							 	<tr>
								<td><?php echo $i++;?></td>
								<td><a href="<?php echo base_url(); ?>candidates/job_view/<?php echo $list->id;?>"><?php echo $list->job_title;?></a></td>
