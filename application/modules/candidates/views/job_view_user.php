...
<div class="header-white header">
    ...
    <ul class="nav navbar-nav navbar-right nav-user pull-right">
        ...
        <li class="">
            <a href="<?php echo base_url('candidates');?>" class="user-link">
            <span><?php echo lang('login');?></span>
            </a>
        </li>
    </ul>
</div>
<div class="content container" style="padding-top:95px;">
    <div class="row">
        <div class="col-xs-12">
            ...
            <ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
                ...
                <li><a href="<?php echo base_url(); ?>candidates/all_jobs_user"><?php echo lang('all_jobs');?></a></li>
                <li><?php echo lang('view_job'); ?></li>
            </ul>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="job-info job-widget">
                ...
                <h3 class="job-title m-t-30"><?php echo $jobs_detail['job_title'];?></h3>
        ...
        <div class="col-md-4">
            ...
            <div class="job-det-info job-widget">
                ...
                <a class="btn job-btn" href="#" data-toggle="modal"  data-target="#apply_job" onclick="register_for('apply')"><?php echo lang('apply_for_this_job');?></a>
                <div class="row">
                    <div class="col-lg-6"><a class="btn job-btn1" href="#" data-toggle="modal"  onclick="register_for('saved')"data-target="#apply_job"><?php echo lang('save');?></a></div>
                    <div class="col-lg-6"><a class="btn job-btn2" href="#" data-toggle="modal" data-target="#apply_job"  onclick="register_for('archive')"><?php echo lang('archive');?></a></div>
                </div>
                <div class="info-list">
                ...
                <div class="info-list">
                    <p class="text-truncate"> <?php echo PHONE_NUMBER;?>
                        ...
                        <br> <a href="<?php echo WEBSITE_URL;?>" target="_blank" title="<?php echo WEBSITE_URL;?>"><?php echo 'https://hrmsmaxx.com';?></a>
                    </p>
                </div>
