...
<div class="content p-t-10">
    ...
    <li class="active"><a data-toggle="pill" href="#home" style="margin-right:10px;"><?php echo lang('apptitude');?></a></li>
    <li><a data-toggle="pill" href="#menu1"><?php echo lang('schedule_interview');?></a></li>
	</ul>
	</div>
	</div>
	</div>
			...
			<div class="table-responsive">
				<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
					 ...
					 foreach($interviewing_jobs as $list)
					{
						...
						<tr>
						<td><?php echo $i++; ?></td>
						<td><a href="<?php echo base_url('candidates/job_view/'.$list->id); ?>"><?php echo $list->job_title;?></a></td>
						...
						<!-- <td class="text-center">
							...
							<td class="text-center">
							<a href="<?=base_url()?>candidates/aptitude/<?php echo $list->deptid.'/'.$list->id;?>" class="btn btn-primary aptitude-btn"><span><?php echo lang('click_here'); ?></span></a>
							</td>
						</tr>
			...
			<div class="table-responsive">
				<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
					...
					?>
						<tr>
						<td><?php echo $i++;?></td>
						<td><a href="<?php echo '#';?>"><?php echo $list->job_title;?></a></td>
						<td><?php echo $list->deptname;?></td>
						
							<td class="text-center">
							<a href="javascript:void(0);" class="btn btn-primary disabled"><span>
						...
						foreach (json_decode($list->schedule_date,true) as $key => $sche_date) {
							...
							<a href="<?php echo site_url('candidates/schedule_interview_time/'.$list->id);?>" class="btn btn-primary aptitude-btn" data-toggle="ajaxModal"><span><?php echo lang('select_your_time'); ?></span></a>
						<?php }else{
						...
						$current_time = date('H:i');
						 ...
						 ?> <a href="<?php echo site_url('candidate_chats'); ?>"><?php echo lang('video_call');?></a><?php 
							}else{
