...
<form action="<?php echo site_url('candidates/all_jobs_list');?>" method="post" id="search_alljobs_filter_list">
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-xs-6 col-md-3">  
			...
			<a href="#" data-toggle="collapse" data-target="#advance_search" class="text-info m-b-10" style="display:block;"><?php echo lang('advanced_search');?></a>
			<a href="<?php echo site_url('candidates/all_jobs_list');?>"  class="text-info m-b-10" style="display:block;"><?php echo lang('clear') ?></a>
		</div>  
	</div>
</form>
		...
		<div class="table-responsive">
			<table class="table table-striped custom-table mb-0 datatable">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $i++;?></td>
						<td><a href="<?php echo base_url(); ?>candidates/job_view/<?php echo $job->id;?>"><?php echo $job->job_title;?></a></td>
						...
						<td class="text-center">
							<div class="action-label">
								<a class="btn btn-white btn-sm btn-rounded" href="#" >
								<i class="fa fa-dot-circle-o text-danger"></i><?php if($job->status==0){ echo lang('open');}else{ echo lang('close');}?> 
								</a>
							</div>
						</td>
					</tr>
