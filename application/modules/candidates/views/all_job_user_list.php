...
<div class="content container" style="height:100vh;padding-top:95px;">
	...
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-xs-6 col-md-3">  
			...
			<a href="#" data-toggle="collapse" data-target="#advance_search" class="text-white badge bg-info" style="display:inline-block; padding:5px 10px;">
				<?php echo lang('advanced_search');?>
			</a>
			<a class="text-white badge bg-danger" style="display:inline-block; padding:5px 10px;" href="<?php echo site_url('candidates/all_jobs_user_list');?>"><?php echo lang('clear');?></a>
		</div>  
	</div>
</form>
		...
		<div class="table-responsive">
			<table class="table table-striped custom-table mb-0 datatable">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $i++;?></td>
						<td><a href="<?php echo base_url(); ?>candidates/job_view_user/<?php echo $list->id;?>"><?php echo $list->job_title;?></a></td>
