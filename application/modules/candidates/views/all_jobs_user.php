<div class="header-white header">
	<div class="header-left">
		<a class="logo" href="<?php echo base_url();?>candidates/all_jobs_user">
...
<?php $all_job_header= $this->db->where('subdomain_id',$this->session->userdata('subdomain_id'))->get('all_job_header')->row_array();?>
	<div class="container-fluid p-0" style="width:100%;">
		<div class="top-image">
			<img src="<?php echo base_url();?>assets/uploads/<?php echo $all_job_header['image']?>" class="img-fluid" alt="<?=lang('responsive_image'); ?>" style="width:100%;height:300px;">
		</div>
	</div>
...
<div class="content p-t-10">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center m-t-20 m-b-30 text-success"><?php echo $all_job_header['description']?></h4>
				</div>
			</div>
	<!-- <div class="row">
		<div class="col-xs-8">
	...
	<div class="row">
		...
		<div class="col-sm-4  text-right m-b-20">     
	          <a class="btn back-btn" href="<?=base_url()?>candidates/all_jobs_user_list"><i class="fa fa-list"></i><?=lang('list_view');?></a>
	      </div>
...
<form action="<?php echo site_url('candidates/all_jobs_user');?>" method="post" id="search_user_filter">
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-xs-6 col-md-3">  
			...
			<a href="#" data-toggle="collapse" data-target="#advance_search" class="text-white badge bg-info" style="display:inline-block; padding:5px 10px;"><?php echo lang('advanced_search');?></a>
			<a tyle="display:inline-block;padding:5px 10px;" class="badge bg-danger text-white" href="<?php echo site_url('candidates/all_jobs_user');?>"><?php echo lang('clear');?></a>
		</div>  
	</div>
</form>
			...
			<a class="job-list" href="<?php echo base_url(); ?>candidates/job_view_user/<?php echo $list->id;?>">
				...
				<div class="job-list-footer">
					<ul>
						...
						echo $diff->format("%a").' '. lang('days_ago');
					?> </li>
					</ul>
				</div>
			</a>
