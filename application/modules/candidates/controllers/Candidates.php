...
class Candidates extends MX_Controller
{
 ...
 // print_r($data);exit;
    ...
    public function dashboard()
    {
        ...
        $jobs_counts = $this->Jobs_model->select_counts(array('candidate_id'=>$this->session->userdata('user_id'),'jobs.subdomain_id'=>$this->session->userdata('subdomain_id')));
       // echo $this->db->last_query();exit; 
        ...
        $data['applied_jobs'] = $this->Jobs_model->select_jobs_status_list(array('candidate_job_status.status'=>1,'candidate_id'=>$this->session->userdata('user_id'),'jobs.subdomain_id'=>$this->session->userdata('subdomain_id')));

       $data['latest_jobs'] = $this->Jobs_model->get_latest_jobs(10);
       $where1['candidate_id'] = $this->session->userdata('user_id');
       $where1['subdomain_id'] = $this->session->userdata('subdomain_id'); 
       $data['total_visited'] = $this->Jobs_model->get_counts('candidate_visited_jobs',$where1); 
    //echo $this->db->last_query();exit; 
    $where['candidate_id'] = $this->session->userdata('user_id');
    $where['user_job_status >='] = 7; /*offered job*/
    $where['jobs.subdomain_id'] = $this->session->userdata('subdomain_id'); /*offered job*/
    $data['offered_jobs'] = $this->Jobs_model->select_offered_jobs($where);
    //echo $this->db->last_query();exit; 
       //print_r( $data['job_counts']);exit; 

    $data['month_wise'] = $month_wise= $this->Jobs_model->select_month_wise_details(array('status'=>1,'candidate_id'=>$this->session->userdata('user_id'),'jobs.subdomain_id'=>$this->session->userdata('subdomain_id')));
	 ...
	 public function all_jobs()
    {
        ...
        $data['job_categories'] = $this->Jobs_model->select('departments',array('subdomain_id'=>$this->session->userdata('subdomain_id'))); /* to fetch job category*/
        $data['countries'] = $this->Jobs_model->select('countries'); /* to fetch countries */
        $data['experience_level'] = $this->Jobs_model->select('experience_level',array('status'=>1,'subdomain_id'=>$this->session->userdata('subdomain_id')));

        $data['job_types'] =  $this->Jobs_model->select('jobtypes',array('status'=>1,'subdomain_id'=>$this->session->userdata('subdomain_id')));/* job types */
        $data['designation'] =  $this->Jobs_model->select('designation',array('subdomain_id'=>$this->session->userdata('subdomain_id')));/* get position list*/
    ...
    public function all_jobs_user()
    {
        ...
        $data['countries'] = $this->Jobs_model->select('countries'); /* to fetch countries */
        $data['experience_level'] = $this->Jobs_model->select('experience_level',array('status'=>1,'subdomain_id'=>$this->session->userdata('subdomain_id')));
        $data['job_types'] =  $this->Jobs_model->select('jobtypes',array('status'=>1,'subdomain_id'=>$this->session->userdata('subdomain_id')));
        $data['designation'] =  $this->Jobs_model->select('designation',array('subdomain_id'=>$this->session->userdata('subdomain_id')));
        $where['jobs.deleted_at'] =NULL; 
        $where['jobs.subdomain_id'] =$this->session->userdata('subdomain_id'); 
    ...
    public function job_view_user()
    {
        ...
        $data['jobs_detail'] = $this->Jobs_model->select_jobs_detail(array('jobs.id'=>$this->uri->segment(3),'jobs.subdomain_id'=>$this->session->userdata('subdomain_id'))); /* get jobs details*/
        $data['job_categories'] = $this->Jobs_model->select('departments',array('subdomain_id'=>$this->session->userdata('subdomain_id'))); /* to fetch job category*/
        $data['countries'] = $this->Jobs_model->select('countries'); /* to fetch countries */
       ...
       $cond['jobs.subdomain_id'] =$this->session->userdata('subdomain_id'); /* for applied jobs*/ 
       $data['applications'] = $this->Jobs_model->get_counts_new('candidate_job_status',$cond); /* total applicants */
        $this->template
                ->set_layout('login')
    ...
    public function job_view()
    {
                ...
                if($visited->num_rows()>0){
                    $upd['visited_on'] = date('Y-m-d H:i:s');
                     $upd['candidate_id'] = $this->session->userdata('user_id');
                      ...
                      $upd['subdomain_id'] =  $this->session->userdata('subdomain_id');
                    ...
                    $ins['job_id'] = $this->uri->segment(3); 
                     $ins['subdomain_id'] =  $this->session->userdata('subdomain_id');         
       ...
       $cond1['job_id'] = $this->uri->segment(3);
       $cond1['subdomain_id'] = $this->session->userdata('subdomain_id');
       $data['total_views'] = $this->Jobs_model->get_counts('candidate_visited_jobs',$cond1); /* get total views*/
       $cond['job_id'] = $this->uri->segment(3);
       $cond['status'] =1; /* for applied jobs*/ 
       $data['applications'] = $this->Jobs_model->get_counts_new('candidate_job_status',$cond); /* total applicants */
       $data['jobs_detail'] = $this->Jobs_model->select_jobs_detail(array('jobs.id'=>$this->uri->segment(3),'jobs.subdomain_id'=>$this->session->userdata('subdomain_id'))); /* get jobs details*/
  ...
  // exit;
    ...
    public function register(){
        ...
        //   print_r($_FILES);exit; 
          ...
          if($this->form_validation->run()){
            ...
            $already = $this->Jobs_model->select_check('registered_candidates',array('email'=>$this->input->post('email'),'subdomain_id'=>$this->session->userdata('subdomain_id')));
   ...
   // print_r($result);exit;
	...
	public function offered()
    {
        ...
        $where['candidate_id'] = $this->session->userdata('user_id');
        $where['user_job_status >='] = 7; /*offered job*/
        $where['jobs.subdomain_id'] = $this->session->userdata('subdomain_id'); /*sub domain id*/
        $data['offered_jobs'] = $this->Jobs_model->select_offered_jobs($where);
    ...
    public function archived()
    {
        ...
        $data['currencies'] = App::currencies();
        $data['languages'] = App::languages();
        $data['archive_jobs'] = $this->Jobs_model->select_jobs_status_list(array('candidate_job_status.status'=>3,'candidate_id'=>$this->session->userdata('user_id'),'jobs.deleted_at'=>NULL,'jobs.subdomain_id'=>$this->session->userdata('subdomain_id')));
    ...
    public function aptitude()
    {
        ...
        $where['subdomain_id']    = $this->session->userdata('subdomain_id');  /* sub domain id */
