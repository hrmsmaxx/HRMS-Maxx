	...
	<div class="modal-content">
		...
		<div class="modal-body">
		 	...
		 	<div class="form-group">
				...
				<div class="col-lg-9">
					<input type="text" class="form-control" value="<?=$info->first_name?>" name="first_name">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label"><?=lang('last_name')?> <span class="text-danger">*</span></label>
				<div class="col-lg-9">
					<input type="text" class="form-control" value="<?=$info->last_name?>" name="last_name">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label"><?=lang('dob')?><span class="text-danger">*</span></label>
				<div class="col-lg-9">
					<input class="col-lg-3 form-control datetimepicker" type="text" value="<?php  echo date('Y-m-d',strtotime($info->dob));?>" name="dob" data-date-format="yyyy-mm-dd" >
				</div>
			</div>
				<div class="form-group">
		...
		<option value="<?=$d->deptid?>" <?=($d->deptid == $info->department || (is_array($dep) && in_array($d->deptid, $dep))) ? ' selected="selected"' : ''?>>
			   ...
			   <?php if (User::get_role($user->id) != 'client') { ?>
				...
				<div class="col-lg-9">
					<input type="text" class="form-control telephone" value="<?=$info->phone?>" name="phone">
				</div>
				</div>
				...
				<div class="form-group">
				<label class="col-lg-3 control-label"><?php echo lang('skype'); ?></label>
				<div class="col-lg-9">
