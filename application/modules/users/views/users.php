...
<?php
		...
		<div class="col-md-8 col-xs-7 text-right m-b-30">
	...
	<div id="add_new_user" class="modal fade" role="dialog" style="display: none;">
		...
		<div id="subscripe_user" class="modal fade" role="dialog" style="display: none;">
		<div class="modal-dialog">
