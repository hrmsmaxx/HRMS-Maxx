<div class="modal-dialog">
    <div class="modal-content">
      ...
      <img src="<?=User::avatar_url($event->added_by); ?>" class="img-rounded" style="width:38px;height:38px;">
        ...
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title h3"><?=$incidents->incident_name?></h4>
        </div>
        <div class="modal-body">
            <ul class="list-group no-radius">
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                    <span class="pull-right">
                         <label class="label label-success"><?=$incidents->start_date?></label>
                    </span>
                    <?=lang('start_date')?>
                </li>
                <li class="list-group-item">
                    <span class="pull-right">
                         <label class="label label-danger"><?=$incidents->end_date?></label>
                    </span>
                    <?=lang('end_date')?>
                </li>
                <li class="list-group-item">
                    <span class="pull-right">
                    <a class="thumb-xs avatar">
      <img src="<?=User::avatar_url($incidents->created_by); ?>" class="img-rounded" style="width:38px;height:38px">

          </a> <label class="label label-default"><?=User::displayName($incidents->created_by)?></label></span>
                    <?=lang('added_by')?>
                </li>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-danger" data-dismiss="modal"><?=lang('close')?></a>
            <?php if(User::is_admin() || User::is_staff()) : ?>
            <a href="<?= base_url('incidents/edit_incident_cal/'.$incidents->id) ?>" class="btn btn-success text-white" data-toggle="ajaxModal" data-dismiss="modal"><?=lang('edit_incident')?>
