<div class="content container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<h4 class="page-title"><?=lang('income_statement')?></h4>
		...
		<div class="card-box budget-tabs m-b-0">
          ...
          <div class="tab-content">           
           ...
           <?php  for ($y=$start_years; $y <=$current_year ; $y++) { 
            ...
            $this->db->where("dgt_budget_revenues.subdomain_id",$this->session->userdata('subdomain_id'));
            ...
            $this->db->where("dgt_budget_expenses.subdomain_id",$this->session->userdata('subdomain_id'));
            ...
            <div id="statement_<?php echo $y;?>" class="tab-pane <?php echo ($y == $current_year )?'active':'';?>">
              ...
              <div class="card-box">
                  ...
                  <h4 class="card-title"><?=lang('income_statement')?> <?php echo $y;?></h4>
                  ...
                  <div class="table-responsive border">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th><strong><?=lang('revenues')?></strong></th>
                     ...
                     echo '<tr>';
                      ...
                      // Generating Month  here 
                        ...
                        foreach($months as $month) {
                          ...
                          $this->db->where("budget_revenues.subdomain_id",$this->session->userdata('subdomain_id'));
                     ...
                     echo '<tr>';
                      ...
                      /* Getting Categories from the array  ends */
                          ...
                          /* Getting Post Year */
                            ...
                            echo '<td><strong>'.lang("total_revenue").'</strong></td>';
                ...
                <!-- Budget_expenses start -->
                     ...
                     <tr>
                        ...
                        <th><strong><?=lang('expenses')?></strong></th>
                     ...
                     echo '<tr>';
                      ...
                      echo '<td><strong>'.lang("total_expenses").'</strong></td>';
                    ...
                    <!-- Sum of profit for each month -->
                     ...
                     //print_r($sum_revenues); exit;
                      ...
                      echo '<td><strong>'.lang('total_profit').'</strong></td>';
