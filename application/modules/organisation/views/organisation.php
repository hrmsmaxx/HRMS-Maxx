...
$result['nodeDataArray'][] = array(
      ...
      'loc'      => '',
      'name'     => '',
      "department" =>$website_name,
      "position"=>"",
      "picture" =>base_url()."assets/images/".$site_logo
    );
...
foreach ($all_grades as $grades) {
    ...
    $des_grade = $this->db->select('*')
                       ...
                       ->where('U.activated',1)
                       ->where('U.banned',0)
                       ->where('D.subdomain_id',$this->session->userdata('subdomain_id'))
                       ->get()->result_array();
...
<div>
		...
		<div class="row">
			<div class="col-sm-12">
				<h4 class="page-title"><?php echo lang('organisation');?></h4>
			</div>
		</div>	
    <section class="panel m-b-0" style="min-height:260px" >
      ...
      <div id="sample" style="margin-left:0px;">
              <div style="width:100%; white-space:nowrap;">
                ...
                <span style="display: inline-block; vertical-align: top; width:100%">
                  <div id="myDiagram" style="border: solid 1px #ededed; height: 500px"></div> 
                </span>
              </div>  
