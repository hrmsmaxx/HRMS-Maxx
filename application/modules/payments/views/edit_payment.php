<div class="content">
	<div class="row">
		...
		<div class="col-sm-4  text-right m-b-20">     
              <a class="btn back-btn" href="<?=base_url()?>payments"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
          </div>
	</div>
		...
		<div class="col-sm-12">
			<div class="panel panel-white">
				<div class="panel-heading">
					<h3 class="panel-title"><?=lang('payment_details')?> - <?=lang('trans')?> <?=$i->trans_id?></h3>
				</div>
