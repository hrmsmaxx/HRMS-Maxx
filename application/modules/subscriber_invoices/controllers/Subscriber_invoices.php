...
class Subscriber_invoices extends MX_Controller

{
...

    {
        ...
        $this->invoice_prefix = $invoice_settings['invoice_prefix']?$invoice_settings['invoice_prefix']:config_item('invoice_prefix');
        $this->pdf_engine = $invoice_settings['pdf_engine']?$invoice_settings['pdf_engine']:config_item('pdf_engine');

        $this->display_invoice_badge = $invoice_settings['display_invoice_badge']?$invoice_settings['display_invoice_badge']:config_item('display_invoice_badge');

        $this->load->module('layouts');

        $this->load->library(array('template', 'form_validation'));

        $this->template->title(lang('invoices').' - '.$this->company_name);
        ...
        $this->load->model(array('Subscriber_invoice', 'App', 'Subscriber_client', 'Expense'));
...

    {
        ...
        if($this->session->userdata('user_id') !=2){
            $layouts = 'users';
            $data['page'] = lang('subscriber_invoices');
        }else{
             $layouts = 'superadmin';
        }
        $this->template
...

    {
        ...
        Subscriber_invoice::evaluate_invoice($invoice_id);
	...
	WHERE a.item_name = '".$name."' and a.subdomain_id = '".$this->session->userdata('subdomain_id')."'";
...

    {
        ...
        //     App::access_denied('subscriber_invoices');
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                redirect('subscriber_invoices/add');

            } else {

                if (config_item('increment_invoice_number') == 'TRUE') {

                    $_POST['reference_no'] = $this->invoice_prefix.Subscriber_invoice::generate_invoice_number();
            ...
            if ($_POST['currency'] == '') {
                ...
                $currency = Subscriber_client::client_currency($_POST['client']);
                ...
                if ($invoice_id = App::save_data('subscriber_invoices', $this->input->post())) {
                ...
                redirect('subscriber_invoices/view/'.$invoice_id);
        ...
        // if (User::is_admin() || User::perm_allowed(User::get_id(), 'edit_all_invoices')) {
            ...
            if ($this->input->post()) {
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    redirect('subscriber_invoices/edit/'.$invoice_id);
            ...
            $_POST['date_saved'] = Applib::date_formatter($_POST['date_saved']).' 00:00:00';
                    ...
                    if (Subscriber_invoice::update($invoice_id, $this->input->post())) {

                        if ($this->input->post('r_freq') != 'none') {

                            subscriber_invoice::recur($invoice_id, $this->input->post());
                ...
                $data['clients'] = Subscriber_client::get_all_clients();
...

    {
        ...
        if (User::is_admin() || User::perm_allowed(User::get_id(), 'view_all_invoices')) {
            ...
            return $this->client_invoices($this->session->userdata('subdomain_id'), $this->filter_by);
...

    {
        ...
        switch ($filter_by) {
            ...
            return Subscriber_invoice::paid_invoices();
            ...
            return Subscriber_invoice::unpaid_invoices();
            ...
            return Subscriber_invoice::partially_paid_invoices();
            ...
            return Subscriber_invoice::recurring_invoices();
            ...
            return Subscriber_invoice::get_invoices();
...

    {
        ...
        switch ($filter_by) {
            ...
            case 'paid':
                ...
                return Subscriber_invoice::paid_invoices($company);
            ...
            case 'unpaid':
                ...
                return Subscriber_invoice::unpaid_invoices($company);
            ...
            case 'partially_paid':
                ...
                return Subscriber_invoice::partially_paid_invoices($company);
            ...
            case 'recurring':
                ...
                return Subscriber_invoice::recurring_invoices($company);
            ...
            default:
                ...
                return Subscriber_invoice::get_client_invoices($company);
...

    {
        ...
        $this->load->model('Subscriber_payment');
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $due = Subscriber_invoice::get_invoice_due_amount($invoice_id);
                ...
                'paid_by' => Subscriber_invoice::view_by_id($invoice_id)->client,
                ...
                $payment_id = Subscriber_payment::save_pay($data);
                ...
                if (isset($attached_file)) {
                    ...
                    Subscriber_payment::update_pay($payment_id, $data);

                }



                if (Subscriber_invoice::payment_status($invoice_id) == 'fully_paid') {

                    Subscriber_invoice::update($invoice_id, array('status' => 'Paid'));

                }

            // Log Activity

            $cur = Subscriber_invoice::view_by_id($invoice_id)->currency;
                ...
                'value2' => Subscriber_invoice::view_by_id($invoice_id)->reference_no,
...

    {
        ...
        $client = Subscriber_client::view_by_id(Subscriber_invoice::view_by_id($invoice)->client)->company_name;
        ...
        foreach ($admins as $key => $user) {
            ...
            $data = array(
                                ...
                                'invoice_ref' => Subscriber_invoice::view_by_id($invoice)->reference_no,
            ...
            $params = array(
                                ...
                                'subject' => '['.$this->company_name.'] Payment Confirmation',
...

    {
        ...
        if ($this->input->post()) {
            ...
            foreach ($_POST['expense'] as $key => $ar) {
                ...
                Subscriber_invoice::save_items($data);
            ...
            redirect('subscriber_invoices/view/'.$invoice);
...

    {
        ...
        Subscriber_invoice::update($invoice_id, $data);
...

    {
        ...
        if ($this->input->post()) {
            ...
            $info = Subscriber_invoice::view_by_id($invoice_id);
            ...
            App::update('subscriber_invoices', array('inv_id' => $invoice_id), $data);
...

    {
        ...
        if ($this->input->post()) {
            ...
            App::save_data('subscriber_payments', $transaction);
...

    {
        ...
        if ($this->input->post()) {
            ...
            $this->load->model('subscriber_invoices/invoices_recurring');
            ...
            //     'value1' => subscriber_invoice::view_by_id($invoice)->reference_no,
...

    {
        ...
        $data['activities'] = subscriber_invoice::activities($invoice_id);
...

    {
        ...
        $data['payments'] = Subscriber_payment::by_invoice($invoice_id);
...

    {
        ...
        if ($this->input->post()) {
            ...
            Subscriber_invoice::delete($invoice);
...

    {
        ...
        if ($this->input->post()) {
            ...
            $cur = Subscriber_invoice::view_by_id($invoice)->currency;

            $reference = Subscriber_invoice::view_by_id($invoice)->reference_no;
            ...
            $message = str_replace('{SITE_NAME}', $this->company_name, $signature);
...

    {
        ...
        if ($this->input->post()) {
            ...
            $invoice = Subscriber_invoice::view_by_id($id);



            $client = Subscriber_client::view_by_id($invoice->client);

            $due = Subscriber_invoice::get_invoice_due_amount($id);
        ...
        $data = array('emailed' => 'Yes', 'date_sent' => date('Y-m-d H:i:s', time()));
            ...
            Subscriber_invoice::update($id, $data);
        ...
        //     App::Log($activity);
            ...
            redirect('subscriber_invoices/view/'.$id);
    ...
    $this->load->view('subscriber_invoices/invoice_chart', isset($data) ? $data : null);
...

    {
        ...
        'title' => lang('invoice').' '.Subscriber_invoice::view_by_id($invoice_id)->reference_no,

        'author' => $this->company_name,

        'creator' => $this->company_name,

        'filename' => lang('invoice').' '.Subscriber_invoice::view_by_id($invoice_id)->reference_no.'.pdf',

        'badge' => $this->display_invoice_badge,
...

    {
        ...
        $message = str_replace('{SITE_NAME}', $this->company_name, $EmailSignature);
        ...
        $params['recipient'] = Subscriber_client::view_by_id($info->client)->company_email;
...

    {
        ...
        $invoice = Subscriber_invoice::view_by_id($invoice_id);
        ...
        'recipient' => $subscriber_email['subscriber_email'],
        ...
        if (strtolower($cc) == 'on') {
            $subscriber_email = $this->db->get_where('dgt_subscribers',array('subscribers_id' =>$subscriber_email))->row_array();

            $params['cc'] = $subscriber_email['subscriber_email'];
...

    {
        ...
        $invoice_details = $this->db->get_where('dgt_subscriber_invoices',array('inv_id'=>$invoice_id))->row_array();

        $invoice_items = $this->db->get_where('dgt_subscriber_items',array('invoice_id'=>$invoice_id))->result_array();

        $new_invoice = array(

            'reference_no' => $this->invoice_prefix.Subscriber_invoice::generate_invoice_number(),
        ...
        $this->db->insert('dgt_subscriber_invoices',$new_invoice);
        ...
        $this->db->insert('dgt_subscriber_items',$res);
    ...
    function invoice_settings(){
        ...
        $this->template->title(lang('accounting').' - '.$this->company_name);

        $data['page'] = lang('invoices');

        $data['sub_page'] = lang('sales_settings');
...

    {
...

        {
            ...
            redirect('subscriber_invoices/invoice_settings');
