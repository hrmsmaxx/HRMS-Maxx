...
$function = 'subscriber_invoices';
	...
	<div class="row">
		<div class="col-sm-8">
			<h4 class="page-title"><?php echo lang('invoice'); ?></h4>
		</div>
        <div class="col-sm-4  text-right m-b-20">     
              <a class="btn btn-outline-primary back-btn" href="<?php echo base_url().$function; ?>"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
          </div>
	</div>
                ...
                <div class="card-body">
                    <div class="row">
						<div class="col-md-12 m-t-8 m-l-2">
                           ...
                           <?php if($this->session->userdata('user_id') ==2){ ?>
							<a href="<?= base_url() ?>subscriber_invoices/items/insert/<?=$inv->inv_id ?>" title="<?= lang('item_quick_add') ?>" class="btn btn-sm btn-info" data-toggle="ajaxModal">
								<i class="fa fa-list-alt text-white"></i> <?= lang('items') ?>
							</a>
                            
							<?php if ($inv->show_client == 'Yes') { ?>
							<a class="btn btn-sm btn-success" href="<?= base_url() ?>subscriber_invoices/hide/<?=$inv->inv_id ?>" data-toggle="tooltip" data-original-title="<?=lang('hide_to_client') ?>" data-placement="bottom">
								<i class="fa fa-eye-slash"></i>
							</a>
							<?php } else { ?>
							<a class="btn btn-sm btn-danger" href="<?= base_url() ?>subscriber_invoices/show/<?= $inv->inv_id ?>" data-toggle="tooltip" data-original-title="<?= lang('show_to_client') ?>" data-placement="bottom">
								<i class="fa fa-eye"></i> 
							</a>
							<?php } }?>
                                ...
                                <?php if ((Subscriber_invoice::get_invoice_due_amount($inv->inv_id) > 0) ) { ?>

                                    <a class="btn btn-sm btn-<?=config_item('theme_color');?>"
                                       href="<?=base_url()?>subscriber_invoices/pay/<?=$inv->inv_id?>" data-toggle="tooltip"
                            ...
                            <?php if ($inv->recurring == 'Yes') { ?>
                                    ...
                                    <a class="btn btn-sm btn-warning" href="<?= base_url() ?>subscriber_invoices/stop_recur/<?=$inv->inv_id?>"
                            ...
                            <?php if($this->session->userdata('user_id') ==2){ ?>
                                ...
                                <a href="<?= base_url() ?>subscriber_invoices/edit/<?=$inv->inv_id?>"
                                ...
                                <a href="<?= base_url() ?>subscriber_invoices/delete/<?=$inv->inv_id?>" class="btn btn-sm btn-danger"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                       ...
                                       <!--  <li>
                                            <a href="<?=base_url()?>subscriber_invoices/send_invoice/<?=$inv->inv_id?>" data-toggle="ajaxModal"
                                        ...
                                        <li>
                                            <a href="<?=base_url()?>subscriber_invoices/remind/<?=$inv->inv_id?>" data-toggle="ajaxModal"
                                               title="<?=lang('send_reminder')?>"><?= lang('send_reminder') ?>
                                            </a>
                                        </li>
                                    
                                    <li>
                                        <a href="<?= base_url() ?>subscriber_invoices/timeline/<?= $inv->inv_id ?>">
                                    ...
                                    <li>
                                        ...
                                        <li class="dropdown-item">
                                            <a href="<?=base_url() ?>subscriber_invoices/mark_as_paid/<?=$inv->inv_id?>" data-toggle="ajaxModal">
                                                <?=lang('mark_as_paid') ?>
                                            </a>
                                        </li>

                                        <li class="dropdown-item">
                                            <a href="<?=base_url() ?>subscriber_invoices/cancel/<?=$inv->inv_id?>" data-toggle="ajaxModal">
                                                <?=lang('cancelled') ?>
                                            </a>
                                        </li>
                        ...
                        <?php } ?>
                            ...
                            <?php if (config_item('pdf_engine') == 'invoicr') : ?>
                                <a href="<?= base_url() ?>fopdf/invoice/<?= $inv->inv_id ?>" class="btn btn-sm btn-primary float-right m-r-2">
                                    <i class="fa fa-file-pdf-o"></i> <?=lang('pdf') ?>
                                </a>


                            <?php elseif (config_item('pdf_engine') == 'mpdf') : ?>
                                <a href="<?= base_url() ?>subscriber_invoices/pdf/<?= $inv->inv_id ?>" class="btn btn-sm btn-primary float-right m-r-2">
                                    <i class="fa fa-file-pdf-o"></i> <?=lang('pdf') ?>
                                </a>
                    ...
                    if (!$this->session->flashdata('message')) :
                        if (strtotime($inv->due_date) < time() && Subscriber_invoice::get_invoice_due_amount($inv->inv_id) > 0) :
                            ?>
                ...
                <?php else: ?>
                    <div class="alert alert-danger hidden-print">
                        <button type="button" class="close" data-dismiss="alert">×</button> <i class="fa fa-warning"></i>
                        <?php echo lang('this_invoice_cancelled'); ?>
                    </div>

                <?php endif; ?>

                    <div class="card inv-panel m-b-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-lg-4 col-md-6 text-right" style="color: #817d7d;">
								<h3 class="text-uppercase text-right"><?=$inv->reference_no?> <?php if ($inv->recurring == 'Yes') { ?>
                                        <span class="badge badge-danger bg-danger"><i class="fa fa-retweet"></i>
                                ...
                                <div>
                                    ...
                                    <span class="d-inline-block float-right">
                                        ...
                                        <?=lang(Subscriber_invoice::payment_status($inv->inv_id))?>
                                        </span></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <?php if (config_item('swap_to_from') == 'FALSE') { ?>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6 m-b-20 ">
                                        ...
                                        <?php $l = Subscriber_client::view_by_id($inv->client)->language; ?>
                                        ...
                                        <p class="row">
                                             ...
                                             <span class="col-xs-3"><?= lang('address') ?>:</span> 
...
<br>
                                            <span class="col-xs-3 "><?= lang('phone') ?>:</span>
                                <span class="col-xs-9 ">
                                <a href="tel:<?= (config_item('company_phone_' . $l)
                                    ...
                                    <?php endif; ?>
                                            ...
                                            <?php if (config_item('company_fax_'.$l) != '' || config_item('company_fax') != '') : ?>
                                                <span class="col-xs-3 "><?= lang('fax') ?>:</span>
                                                <span class="col-xs-9 ">
                                ...
                                <a href="tel:<?= (config_item('company_registration_' . $l) ? config_item('company_registration_' . $l) : config_item('company_registration')) ?>">
                                    <?=(config_item('company_registration_' . $l)
                                        ...
                                        : config_item('company_registration')) ?>
                                            ...
                                            <span class="col-xs-3"><?=lang('company_vat')?>:</span>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 m-b-20">
                                    ...
                                    <h4><?=Subscriber_client::view_by_id($inv->client)->company_name;?> <br></h4>
                                    <p>
                                        <span class="col-xs-3 no-gutter"><?=lang('address')?>:</span>
                                            <span class="col-xs-9 no-gutter">
                                        <?=Subscriber_client::view_by_id($inv->client)->company_address?><br>
                                                <?=Subscriber_client::view_by_id($inv->client)->city;?>
                                                <?php if (Subscriber_client::view_by_id($inv->client)->zip != '') {
                                                    echo ", ".Subscriber_client::view_by_id($inv->client)->zip;  } ?><br>

                                                <?php if (Subscriber_client::view_by_id($inv->client)->state != '') {
                                                    echo Subscriber_client::view_by_id($inv->client)->state.", ";  } ?>
                                                <?=Subscriber_client::view_by_id($inv->client)->country; ?>
                                    </span>
                                        <span class="col-xs-3 no-gutter"><?=lang('phone')?>:</span>
                                            <span class="col-xs-9 no-gutter">
                                        <a href="tel:<?=Subscriber_client::view_by_id($inv->client)->company_phone;?>">
                                            <?=ucfirst(Subscriber_client::view_by_id($inv->client)->company_phone) ?>
                                        </a>&nbsp;
                                    </span>

                                        <?php if (Subscriber_client::view_by_id($inv->client)->company_fax != '') : ?>
                                            <span class="col-xs-3 no-gutter"><?=lang('fax')?>:</span>
                                            <span class="col-xs-9 no-gutter">
                                        <a href="tel:<?=Subscriber_client::view_by_id($inv->client)->company_fax;?>">
                                            <?=ucfirst(Subscriber_client::view_by_id($inv->client)->company_fax) ?>
                                        </a>&nbsp;
                                    </span>
                                        <?php endif; ?>

                                        <?php if(Subscriber_client::view_by_id($inv->client)->VAT != ''){ ?>
                                            <span class="col-xs-3 no-gutter"><?=lang('company_vat')?>:</span>
                                            <span class="col-xs-9 no-gutter">
                                            <?=Subscriber_client::view_by_id($inv->client)->VAT;?>
                                    </span>
                                        <?php } ?>
    ...
    <a href="<?=site_url()?>subscriber_invoices/add_expenses/<?=$inv->client?>/<?=$inv->inv_id?>" class="btn btn-xs btn-danger" data-toggle="ajaxModal"><?=lang('expenses_available')?></a>
    </span>
                        ...
                        <table id="inv-details" class="table sorted_table" type="invoices"><thead>
                            <tr>
                                ...
                                <?php if ($showtax) : ?>
                                    ...
                                    <th width="25%"style="width: 265px;"><?= lang('description') ?> </th>
                            ...
                            <?php foreach (Subscriber_invoice::has_items($inv->inv_id) as $key => $item) { ?>
                                <tr class="sortable" data-name="<?=$item->item_name?>" data-id="<?=$item->item_id?>">
                                    <td class="drag-handle"><i class="fa fa-reorder"></i></td>
                                    <td>
                                        <?php if($this->session->userdata('user_id') ==2) { ?>                                       
                                            <a class="text-info" href="<?=base_url()?>subscriber_invoices/items/edit/<?=$item->item_id?>" data-toggle="ajaxModal"><?=$item->item_name?>
                                            </a>
                                        <?php } else{
                                            echo $item->item_name;
                                        }?> 
                                    ...
                                    <td>
                                            ...
                                            <a class="hidden-print"
                                               href="<?= base_url() ?>subscriber_invoices/items/delete/<?=$item->item_id?>/<?=$item->invoice_id ?>" data-toggle="ajaxModal"><i class="fa fa-trash-o text-danger"></i>
                                            </a>
                        ...
                        <table class="table">
                            <tbody> -->
                                ...
                                <?php if ($inv->status != 'Paid' && $this->session->userdata('user_id') ==2) { ?>
                                    <tr class="hidden-print">
                                        <?php $attributes = array('class' => 'bs-example form-horizontal');
                                        echo form_open(base_url() . 'subscriber_invoices/items/add', $attributes);
                                        ?>
                                        <input type="hidden" name="invoice_id" value="<?=$inv->inv_id ?>">
                                        <input type="hidden" name="item_order" value="<?=count(subscriber_invoice::has_items($inv->inv_id)) + 1?>">
                                        <input id="hidden-item-name" type="hidden" name="item_name">
                                        <td></td>
                                        <td><input id="auto-item-name" data-scope="invoices" type="text" placeholder="<?=lang('item_name') ?>" class="typeahead form-control" style="min-width: 150px;"></td>

                                        <td><textarea id="auto-item-desc" rows="1" name="item_desc" placeholder="<?= lang('item_description') ?>" class="form-control js-auto-size" style="width: 265px;"></textarea></td>

                                        <td class="text-right"><input id="auto-quantity" type="text" name="quantity" value="1" class="form-control" style="min-width: 55px;" ></td>
                                        <?php if ($showtax) : ?>
                                            <td class="text-right">
                                                <select name="item_tax_rate" class="form-control m-b" style="min-width: 100px;" >
                                                    <option value="0.00"><?= lang('none') ?></option>
                                                    <?php
                                                    foreach (subscriber_invoice::get_tax_rates() as $key => $tax) {
                                        ...
                                        <?php endif; ?>
                                        <td class="text-right"><input id="auto-unit-cost" type="text" name="unit_cost" required placeholder="50.56" class="form-control" style=" min-width: 95px; ></td>
                                        <?php if ($showtax) : ?>
                                            <td><input type="text" name="tax" placeholder="0.00" readonly="" class="form-control" style="width: 55%;"></td>
                                        <?php endif; ?>
                                        <td></td>
                                        <td></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?=Applib::format_currency($inv->currency, subscriber_invoice::get_invoice_tax($inv->inv_id))?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?=Applib::format_currency($inv->currency, subscriber_invoice::get_invoice_tax($inv->inv_id,'tax2'))?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?=Applib::format_currency($inv->currency, subscriber_invoice::get_invoice_discount($inv->inv_id)) ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?=Applib::format_currency($inv->currency, subscriber_invoice::get_invoice_fee($inv->inv_id)) ?>
                                    </td>
                                ...
                                <?php if (subscriber_invoice::get_invoice_paid($inv->inv_id) > 0) {
                                ?>
                                <tr>
                                    <td colspan="<?= $showtax ? '7' : '5' ?>" class="text-right no-border"><strong><?= lang('payment_made') ?></strong></td>
                                    <td class="text-right text-danger">
                                        (-) <?=Applib::format_currency($inv->currency, subscriber_invoice::get_invoice_paid($inv->inv_id))?>
                                    </td>
                                    <td></td>
                                </tr>
                                <?php } ?>
						...
						<div class="invoice-info">
							<h5><?php echo lang('other_information'); ?></h5>
                        ...
                        <script>
                            ...
                            $('#customButton').on('click', function(e) {
                                ...
                                handler.open({
                                    ...
                                    description: 'INV REF: #<?=$inv->reference_no?> (<?=App::currencies($inv->currency)->symbol;?><?=subscriber_invoice::get_invoice_due_amount($inv->inv_id); ?>)',
                                    amount: '<?=subscriber_invoice::get_invoice_due_amount($inv->inv_id)*100?>',
    ...
    $attributes = array('id' => 'stripeForm');
          echo form_open(base_url().'stripepay/authenticate',$attributes); ?>
                            ...
                            <input type="hidden" name="amount" value="<?=subscriber_invoice::get_invoice_due_amount($inv->inv_id);?>"/>
                        </form>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><?php echo lang('clone_invoice'); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <h5><?php echo lang('do_you_clone_invoice'); ?>(<?= $inv->reference_no ?>)?</h5>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang('no'); ?></button>
        <button class="btn btn-primary clone_invoice_btn" data-invoice="<?= $inv->inv_id ?>"><?php echo lang('yes'); ?></button>
      </div>
    </div>
  </div>
</div>
