 <div class="page-wrapper" style="padding-top:35px">
	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="card panel-white m-b-0">

				<div class="card-body">

					<?php $attributes = array('class' => 'bs-example form-horizontal','id'=> 'createInvoiceForm'); echo form_open(base_url().'subscriber_invoices/add',$attributes); ?>
					...
					<?php echo validation_errors(); ?>
						...
						<div class="form-group form-row">
							...
							<div class="col-lg-4">
								...
								if(config_item('increment_invoice_number') == 'FALSE'){
									...
									echo subscriber_invoice::generate_invoice_number();
							...
							<div class="col-lg-4">
								...
								<select class="select2-option form-control" style="width:100%" name="client" >
									...
									<optgroup label="<?=lang('company')?>">
										...
										<option value="<?php echo $subscriber['subscribers_id'];?>"><?php echo ucfirst($subscriber['company_name']);?></option>
						...
						<div class="form-group form-row">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="create_invoice_tax1_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="tax"><?=lang('tax_is_invalid')?></label>
								</div>
								</div>
...
<div class="input-group-prepend">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="create_invoice_tax2_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="tax2"><?=lang('tax_is_invalid')?></label>
								</div>
								</div>
						...
						<div class="form-group form-row">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="create_invoice_discount_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="notes"><?=lang('discount_is_invalid')?></label>
								</div>
								</div>
						...
						<div class="form-group form-row">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="create_invoice_fee_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="notes"><?=lang('fees_is_invalid')?></label>
								</div>
								</div>
						...
						<div class="form-group form-row">
							...
							<div class="col-lg-4">
								...
								<select name="currency" class="form-control">
									...
									<option value=""><?=lang('company_default_currency')?></option>
						...
						<div class="form-group form-row form-row terms">
							...
							<div class="col-lg-9">
								...
								<div class="row">
								<div class="col-md-6">
								<label id="create_invoice_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="notes"><?=lang('notes_not_empty')?></label>
								</div>
								</div>
							</div>
