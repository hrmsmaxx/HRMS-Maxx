<!-- Page Content -->
	...
	<div class="row">
		<div class="col-sm-12">
			<h4 class="page-title"><?php echo lang('projects'); ?></h4>
		</div>
	</div>
					<div class="card-box">
					<!-- Page Title -->
				...
				<div class="row filter-row">
					<form method="POST" action="<?php echo base_url()?>projects/grid_view">
						<div class="col-lg-4 col-sm-6 col-xs-12">  
							<div class="form-group form-focus">
							<label class="control-label"><?php echo lang('project_title')?></label>
						...
						<div class="col-lg-4 col-sm-6 col-xs-12">  
							<div class="form-group form-focus">
								...
								<label id="client_name_error" class="error display-none" for="client_name"><?=lang('client_name_should_not_empty');?></label>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6 col-xs-12">  
							<button type="submit" class="btn btn-success rounded btn-block form-control" id="project_search_btn1"> <?php echo lang('search');?> </button>
							<!-- <a href="javascript:void(0)" id="project_search_btn" class="btn btn-success btn-block form-control"><?php //echo lang('search');?> </a>   -->
						</div>
					</form>     
                </div>
					<!-- Search Filter -->
							...
							<div class="card-box project-box">
								<div class="dropdown profile-action">
									...
									<ul class="dropdown-menu pull-right">
										<li><a href="<?=base_url()?>projects/edit/<?=$p->project_id?>"><i class="fa fa-pencil m-r-5"></i> <?=lang('edit');?></a></li>
										<?php if (User::is_admin() || User::perm_allowed(User::get_id(),'delete_projects')){ ?> 
										<li><a href="<?=base_url()?>projects/delete/<?=$p->project_id?>" data-toggle="ajaxModal"><i class="fa fa-trash-o m-r-5"></i> <?=lang('delete');?></a></li>
										<?php } ?>
									</ul>
								</div>
								<h4 class="project-title"><a href="<?php echo base_url(); ?>projects/view/<?php echo $p->project_id; ?>"><?php echo $p->project_title; ?></a></h4>
								<small class="block text-ellipsis m-b-15">
									<span class="text-xs"><?php echo count($open_tasks); ?></span> <span class="text-muted"><?=lang('open_tasks');?>, </span>
									<span class="text-xs"><?php echo count($completed_tasks); ?></span> <span class="text-muted"><?=lang('tasks_completed');?></span>
								</small>
								...
								<p class="m-b-5"><?=lang('progress');?> <span class="text-success float-right"><?php echo $p->progress; ?>%</span></p>
					...
					<?php if(($this->session->userdata('role_id') != 1) && ($this->session->userdata('role_id') != 4)) {
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card-box project-box">
								...
								<small class="block text-ellipsis m-b-15">
									<span class="text-xs"><?php echo count($open_tasks1); ?></span> <span class="text-muted"><?=lang('open_tasks');?>, </span>
									<span class="text-xs"><?php echo count($completed_tasks1); ?></span> <span class="text-muted"><?=lang('tasks_completed');?></span>
								</small>
								...
								<p class="m-b-5"><?=lang('progress');?> <span class="text-success float-right"><?php echo $p1->progress; ?>%</span></p>
								<div class="progress progress-xs mb-0">
