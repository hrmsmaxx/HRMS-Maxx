...
<div class="content">
	<div class="row">
		...
		<div class="col-sm-7 col-xs-9 text-right m-b-20">
			...
			<a href="<?=base_url()?>projects/add" class="btn view-btn1 add-btn"><i class="fa fa-plus"></i> <?=lang('create_project')?></a>
			<?php } ?>
			...
			?>
			<?php if ($archive) : ?>
			<a href="<?=base_url()?>projects" class="btn add-btn view-btn1"><?=lang('view_active')?></a>
			<?php else: ?>
			<a href="<?=base_url()?>projects?view=archive" class="btn add-btn view-btn1">
			<?=lang('view_archive')?></a>
			<?php endif; ?>            
