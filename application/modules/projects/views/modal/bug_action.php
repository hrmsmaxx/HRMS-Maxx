...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id'=>'projectAddBug');
		...
		<div class="modal-body">
			 <input type="hidden" name="project" value="<?=$project?>">
				...
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('severity')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
		...
		<button type="submit" class="btn btn-success" id="project_add_bug"><?=lang('new_bug')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		$attributes = array('class' => 'bs-example form-horizontal','id'=>'projectEditBug');
		...
		<div class="modal-body">
			 ...
			 <input type="hidden" name="project" value="<?=$i->project?>">
				...
				<label class="col-lg-4 control-label"><?=lang('description')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
				<textarea name="bug_description" class="form-control ta"><?=$i->bug_description?></textarea>
				</div>
				</div>
				...
				<label class="col-lg-4 control-label"><?=lang('reproducibility')?> <span class="text-danger">*</span></label>
				<div class="col-lg-8">
				<textarea name="reproducibility" class="form-control ta"><?=$i->reproducibility?></textarea>
				</div>
				</div>
		...
		<div class="modal-footer"> <a href="#" class="btn btn-danger" data-dismiss="modal"><?=lang('close')?></a>
		<button type="submit" class="btn btn-success" id="project_edit_bug"><?=lang('save_changes')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
