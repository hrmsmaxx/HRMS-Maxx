...
<div class="row project-commentsContent">
    <div class="col-lg-12">
      <section class="panel panel-body">
        <section class="comment-list block">
          ...
          <img src="<?php echo User::avatar_url(User::get_id()); ?>" class="img-circle">
              ...
              <textarea class="form-control foeditor-project-discussion" name="comment"
              placeholder="<?php echo Project::by_id($project_id)->project_title; ?> <?=lang('comment')?>" ></textarea>
                    <div class="row">
                    <div class="col-md-6">
                    <label id="project_comment_error" class="error display-none" style="position:inherit;top:0" for="commentTextarea">Comment must not empty</label>
                    </div>
                    </div>
                    <footer class="panel-footer bg-light lter">
                      <button class="btn btn-success pull-right btn-sm" type="submit" id="project_comment_discussion">
