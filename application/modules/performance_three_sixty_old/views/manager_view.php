                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-sm-4  text-right m-b-20">     
			              <a class="btn back-btn" href="<?=base_url()?>performance/performance_dashboard"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
			          </div>
					</div>
					<div class="row">
						<div class="col-md-12">
								...
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table">
											<thead>
												<tr>
													<th style="min-width: 600px;"><?php echo lang('goal'); ?> <?php echo $count;?></th>
