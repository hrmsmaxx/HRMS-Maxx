...
<!-- Content -->
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title m-b-5"><?php echo lang('360_performance'); ?></h4>
						...
						<!-- <div class="col-sm-4  text-right m-b-20">     
			              <a class="btn back-btn" href="<?=base_url()?>performance/performance_dashboards"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
			          </div> -->
					</div>
					<div class="row">
						<div class="col-md-12">
								...
								<div class="col-sm-8">
									<div class="join-year">
										...
										<select class="select form-control">
											<option><?php echo lang('2019'); ?></option>
										</select>
									</div>
								</div>
							</div>
								...
								<div class="performance-box">
									...
									<div class="table-responsive">
										<table class="table performance-table">
											<thead>
												<tr>
													<th style="min-width: 600px;" class="goalCount"><?php echo lang('goal'); ?> <?php echo $count;?></th>
                                                                        ...
                                                                        <div class="task-container">
                                                                            ...
                                                                            <span class="task-action-btn task-btn-right">
                                                                                <span class="action-circle large delete-btn" title="Delete Goal Action">
                                                                                    <i class="material-icons"><?php echo lang('delete'); ?></i>
                                                                                </span>
                                                                            </span>
                                                                        </div>
                                                                    </li>
								...
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table">
											<thead>
												<tr>
													<th style="min-width: 600px;" class="goalCount"><?php echo lang('goal'); ?> 1</th>
													<th class="text-center"><?php echo lang('status'); ?></th>
													<th class="text-center" style="width: 120px;"><?php echo lang('self_rating'); ?></th>
													<th class="text-center" style="width: 120px;"><?php echo lang('rating'); ?></th>
													<th class="text-center" style="width: 85px;"><?php echo lang('feedback'); ?></th>
											...
											<tbody>
												<tr>
													...
													<td class="text-center">
														...
														<span class="badge btn-danger"><?php echo lang('not_approved'); ?></span>
													</td>
													<td>
														<?php $ratings = $this->db->get_where('competency_ratings')->row_array() ; ?>
														<select class="form-control " name="self_rating" >
                                                                ...
                                                                <ul class="task-list" id="tasklist">
                                                                    <li class="task">
                                                                        <div class="task-container">
                                                                            ...
                                                                            <span class="task-action-btn task-btn-right">
                                                                                <span class="action-circle large delete-btn" title="Delete Goal Action">
                                                                                    <i class="material-icons"><?php echo lang('delte'); ?></i>
                                                                                </span>
                                                                            </span>
                                                                        </div>
                                                                    </li>
												...
												<tr>
													...
													<td>
														...
														<select class="form-control select employee_competence_rating" name="self_rating[]" data-id="<?php echo $performance_competencies['id'] ?>">
															<option value=""><?php echo lang('not_rated'); ?></option>
															<?php $ratings = $this->db->get_where('competency_ratings')->row_array() ; ?>
															<?php if(isset($ratings) && !empty($ratings)){ 
															$rating_no = explode('|',$ratings['rating_no']);
															$rating_value = explode('|',$ratings['rating_value']);
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<textarea rows="4" class="form-control"><?php echo lang('no_feedback_found'); ?></textarea>
						</div>
