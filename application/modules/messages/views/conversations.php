												...
												<div class="col-xs-12 col-sm-6 pull-right top-action-left">
													...
													<?php echo form_open(base_url().'messages/search/'); ?>
														...
														<div class="input-group">
															...
															<span class="input-group-btn"> <button class="btn btn-md btn-default" type="submit"><?=lang('go')?>!</button></span>
														...
														<section class="media-body">
															...
															echo form_open(base_url().'messages/send', $attributes); ?>
																...
																<div class="message-cont">
																	...
																	<div class="row">
																	<div class="col-md-6">
																	<label id="send_conversation_error" class="error display-none" style="position:inherit;top:0;font-size:15px;"><?=lang('msg_not_empty')?></label>
																	</div>
																	</div>
