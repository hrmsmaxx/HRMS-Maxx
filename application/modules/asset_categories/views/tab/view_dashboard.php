		...
		<div class="card-box">
			...
			<ul class="list-group no-radius m-b-0">
				...
				<li class="list-group-item">
					...
					<span class="text-muted"><?php echo lang('skype'); ?></span>
				</li>
				<?php endif; ?>
				<?php if($l->linkedin != '') : ?>
				<li class="list-group-item">
					...
					<span class="text-muted"><?php echo lang('linkedin'); ?></span>
				</li>
				<?php endif; ?>
				...
				<li class="list-group-item">
					...
					<span class="text-muted"><?php echo lang('facebook'); ?></span>
				</li>
				<?php endif; ?>
				<?php if($l->twitter != '') : ?>
				<li class="list-group-item">
					...
					<span class="text-muted"><?php echo lang('twitter'); ?></span>
				</li>
				<?php endif; ?>
...
<div class="card-box">
	<h3 class="card-title"><?php echo lang('description'); ?></h3>
	<div class="leads-desc"><p><?=($l->notes == '') ? lang('no_notes') : nl2br_except_pre($l->notes);?></p></div>
</div>