<div class="content">
    <div class="row">
        <div class="col-sm-8">
            ...
            <h4 class="page-title"><strong><?php echo $depart['deptname']; ?></strong> <?php echo lang('designations'); ?></h4>
        </div>
        <div class="col-sm-4 text-right m-b-30">
			<a href="<?=base_url()?>all_departments" class="btn back-btn"><i class="fa fa-chevron-left"></i><?php echo lang('back'); ?></a>
			<a href="<?=base_url()?>all_departments/designations/<?php echo $department_id; ?>" class="btn btn-primary rounded" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?php echo lang('add_designation'); ?></a>
        </div>
    </div>
    <div class="row">
        <!-- Invoice Items -->
