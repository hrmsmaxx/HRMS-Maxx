<div class="modal-dialog">
	...
	<div class="modal-content">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title"><?php echo lang('edit_sub_category'); ?></h4>
		...
		<div class="modal-body">
			...
			<?php $attributes = array('class' => 'bs-example','id'=>'settingsDesignationForm'); echo form_open_multipart('asset_categories/edit_sub_category/'.$sub_details['sub_id'], $attributes); ?>
