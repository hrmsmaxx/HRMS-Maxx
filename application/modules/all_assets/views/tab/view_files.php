	...
	<div class="col-md-12">
		<div class="panel files-panel">
			<div class="panel-heading">
				<div class="row">
					<div class="col-xs-6">
						<h3 class="panel-title"><?php echo lang('files')?></h3>
					</div>
					<div class="col-xs-6">
						<a href="<?=base_url()?>leads/file/add/<?=$l->co_id?>" class="btn btn-success btn-xs pull-right" data-toggle="ajaxModal" data-placement="left" title="<?php echo lang('upload_file')?>">
							<i class="fa fa-plus-circle"></i> <?php echo lang('upload_file')?>
						</a>
					</div>
				</div>
			</div>
