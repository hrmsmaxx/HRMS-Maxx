					...
					<div class="row">
						...
						<div class="col-sm-4 text-right m-b-0">
							...
							<div class="btn-group btn-group-sm">
								...
								<button class="btn btn-default" onclick="document.querySelector('form').submit()"><?php echo lang('pdf');?></button>

								<a href="<?php echo base_url(); ?>payroll" class="btn btn-default"><?php echo lang('back');?></a>
