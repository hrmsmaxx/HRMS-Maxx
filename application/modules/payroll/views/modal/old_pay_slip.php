<div class="modal-dialog" style="width:50%">
	...
	<div class="modal-content">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title"> <?php echo lang('create_pay_slip'); ?> </h4>
		...
		<?php /*echo form_open(base_url().'fopdf/payslip_pdf');*/ ?>
			...
			<div class="modal-body">
				...
				<div class="row"> 
					...
					<div class="col-md-6"> 
						...
						<h4 class="text-primary"><?php echo lang('earnings'); ?></h4>

						<div class="form-group">

							<label> <?php echo lang('basic_da'); ?> (<?php echo $da_percentage; ?>%)  </label>
						...
						<div class="form-group">
							...
							<label><?php echo lang('hra'); ?>(<?php echo $hra_percentage; ?>%) </label>
						...
						<div class="form-group">
							...
							<label> <?php echo lang('conveyance'); ?> </label>
						...
						<div class="form-group">
							...
							<label> <?php echo lang('medical_allowance'); ?> </label>
						...
						<div class="form-group">
							...
							<label> <?php echo lang('other_allowance'); ?> </label>
					...
					<div class="col-md-6">
						...
						<h4 class="text-primary"> <?php echo lang('deductions'); ?> </h4>

						<div class="form-group">

							<label> <?php echo lang('tds'); ?> </label>
						...
						<div class="form-group">
							...
							<label><?php echo lang('leave'); ?> </label>
						...
						<div class="form-group">
							...
							<label><?php echo lang('prof_tax'); ?> </label>
						...
						<div class="form-group">
							...
							<label><?php echo lang('overtime'); ?></label>
						...
						<div class="form-group">
							...
							<label> <?php echo lang('fund'); ?> </label>
						...
						<div class="form-group">
							...
							<label> <?php echo lang('others'); ?>  </label>
			...
			<div class="modal-footer text-center">
				...
				<button type="submit" class="btn btn-success" id="payroll_create_payslip"> <?php echo lang('create_pay_slip'); ?> </button>
