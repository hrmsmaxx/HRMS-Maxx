		 <div class="content container-fluid">
					...
					<div class="row">
						...
						<div class="col-xs-8">
							...
							<h4 class="page-title"><?php echo lang('payslip');?></h4>
			...
			<button class="btn btn-default" onclick="document.getElementById('pdf_employee').click()"><?php echo lang('pdf');?></button>
			...
			<!--<a href="<?php echo base_url(); ?>payroll" class="btn btn-default">Back</a> -->
							...
							<a class="btn back-btn" href="<?=base_url()?>payroll"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
				...
				<?php 
					...
					<div class="col-md-4"> 
						...
						<div class="form-group"> 
							...
							<label><?php echo lang('year'); ?> <span class="text-danger">*</span></label>
					...
					<div class="col-md-4"> 
						...
						<div class="form-group"> 
							...
							<label><?php echo lang('month'); ?> <span class="text-danger">*</span></label>
					...
					<div class="col-md-4"> 
						...
						<div class="form-group"> 
							...
							<input type="submit" name="submit" value="<?php echo lang('get_pay_slip') ?>" class="btn btn-primary">
				...
				if($this->input->post()){
				  ...
				  ?>
								...
								<h4 class="payslip-title" style="position: absolute;margin-left:-14px;"><?php echo lang('payslip_for_the_month'); ?> <?php echo date("F", strtotime($salary_moth)); ?> <?php echo $pay_slip_details['payslip_year']; ?></h4>
								<div class="row m-t-20">
									...
									<div class="col-md-6 m-b-20">
										...
										<div class="invoice-details">
											...
											<h3 class="text-uppercase"><?php echo lang('payslip'); ?> #<?php echo $details['id']; ?></h3>

											<ul class="list-unstyled">



												<li><?php echo lang('salary_month'); ?>: <?php 
							...
							<?php }  ?>
									...
									<div class="col-lg-12 m-b-20">
										...
										<ul class="list-unstyled">
											...
											<li><?php echo lang('employee_id'); ?>: FT-00<?php echo $employee_info->id; ?></li>

											<li><?php echo lang('joining_date'); ?>: <?php echo date('d M Y',strtotime($employee_info->created)); ?></li>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										...
										<div class="panel panel-default">
										    <div class="panel-heading"><h4 class="m-b-0 m-r-5"><strong><?php echo lang('earnings'); ?></strong></h4></div>
											...
											<td style="border:none;"><strong><?php echo lang('total_earnings'); ?></strong> <span class="pull-right"><strong>$<?php echo $earnings; ?></strong></span></td>
									...
									<div class="col-md-6 col-sm-12">
										...
										<div class="panel panel-default">
										    <div class="panel-heading"><h4 class="m-b-0 m-r-5"><strong><?php echo lang('deductions'); ?></strong></h4></div>
											...
											<td style="border:none;"><strong><?php echo lang('total_deductions'); ?></strong> <span class="pull-right"><strong>$<?php echo $deductions;?></strong></span></td>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<label type="button" class="label-netsalary pull-right"><strong><?php echo lang('net_salary'); ?> : <span class="m-l-10">$<?php echo ($earnings - $deductions); ?></span></strong> <!-- (Fifty nine thousand six hundred and ninety eight only.) --></label>
...
<?php }  ?>
									...
									<p class="alert alert-danger"><?php echo lang('no_results_found'); ?></p>
