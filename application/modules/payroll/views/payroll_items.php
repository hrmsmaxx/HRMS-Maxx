                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<h4 class="page-title"><?php echo lang('payroll_items');?> </h4>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="active">
										<a data-toggle="tab" href="#tab_additions"><?php echo lang('additions'); ?></a>
									</li>
									<li>
										<a data-toggle="tab" href="#tab_overtime"><?php echo lang('overtime'); ?></a>
									</li>
									<li>
										<a data-toggle="tab" href="#tab_deductions"><?php echo lang('deductions'); ?></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="tab-content">
						...
						<div class="tab-pane in active" id="tab_additions">
							...
							<div class="text-right m-b-30 clearfix">
								<button class="btn btn-primary add-btn" type="button" data-toggle="modal" data-target="#add_addition"><i class="fa fa-plus"></i> <?php echo lang('add_addition'); ?></button>
							</div>
							<!-- /Add Addition Button -->

							<div class="payroll-table card table-responsive">
								<table class="table table-hover table-radius">
									<thead>
										<tr>
											<th><?php echo lang('name'); ?></th>
											<th><?php echo lang('category'); ?></th>
											<th><?php echo lang('default_unit_amount'); ?></th>
											<th class="text-right"><?php echo lang('action'); ?></th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<th><?php echo lang('leave_balance_amount'); ?></th>
											<td><?php echo lang('monthly_remuneration'); ?></td>
											<td>$5</td>
											<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu pull-right">
														<li><a href="#" data-toggle="modal" data-target="#edit_addition"><i class="fa fa-pencil m-r-5"></i> <?php echo lang('edit'); ?></a></li>
														<li><a href="#" data-toggle="modal" data-target="#delete_addition"><i class="fa fa-trash-o m-r-5"></i> <?php echo lang('delete'); ?></a></li>
													</ul>
												</div>
											</td>
										</tr>
