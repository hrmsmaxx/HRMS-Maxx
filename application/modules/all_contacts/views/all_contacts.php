...
<div class="chat-main-row" style="top:-10px">
                    ...
                    <div class="col-xs-12 message-view">
                        <div class="chat-window">
                            <div class="chat-header">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <h4 class="page-title m-b-0 m-t-5"><?=lang('all_contacts')?></h4>
                                    </div>
                                    <div class="col-xs-6">
                                        <div class="navbar">
                                            <ul class="nav navbar-nav pull-right chat-menu">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="javascript:void(0)"><?=lang('menu')?> <?=lang('1')?></a></li>
                                                        <li><a href="javascript:void(0)"><?=lang('menu')?> <?=lang('2')?></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <div class="message-search m-t-0">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control" id="contact_search" onkeyup="contact_search()" placeholder="<?=lang('search')?>" required="">
                                    ...
                                    <div class="chat-wrap-inner">
                                        <div class="contact-box clearfix">
                                            <div class="contact-cat col-xs-12 col-sm-4 col-lg-3">
                                                <a href="javascript:void(0);" class="btn btn-primary btn-block" data-toggle="modal" data-target="#add_contact"><i class="fa fa-plus"></i> <?=lang('add_contact')?></a>
                                                <div class="roles-menu">
                                                    <ul class="nav">
                                                        <li class="active"><a href="javascript:void(0);" class="role_search" data-id="<?=$r->r_id?>"><?=lang('all')?></a></li>        
                                                         <?php
                                                          if (!empty($roles)) {
                                                          foreach ($roles as $r) { ?>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><?=lang('add_contact')?></h5>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="" id="AddContacForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label><?=lang('email_address')?> <span id="already_contactname" style="display: none;color:red;"><?=lang('email_already_register')?></span></label>
                                        <input class="form-control" type="email" name="email" id="email">
                                    </div>
                                    <div class="form-group">
                                        <label><?=lang('contact_number')?> <span class="text-danger">*</span><span id="already_contact_number" style="display: none;color:red;"><?=lang('contact_already_register')?></span></label>
                                    ...
                                    <div class="submit-section">
                                        <button class="btn btn-primary submit-btn" id="submit_contact_form" ><?=lang('submit')?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
