...
?>
                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title"><?php echo lang('OKR_performance');?></h4>
						...
						<div class="col-md-12">
							...
							<div class="form-group col-md-6">
								...
								<div class="radio_input">
									...
									<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='90 days')? 'checked':'' ?> value="90 days"><?php echo lang('90');?> <?php echo lang('days');?><span class="checkmark"  ></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration"  <?php echo ($okrdetails['goal_duration'] =='6 month')? 'checked':'' ?>  value="6 month"><?php echo lang('6');?> <?php echo lang('Month');?><span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='1 year')? 'checked':'' ?> value="1 year"><?php echo lang('1');?> <?php echo lang('year');?><span class="checkmark" ></span>
									</label> 
								</div>
							</div>
								...
								<div class="form-group col-md-6">									
									<div class="join-year">
										<span class="m-r-10"><?php echo lang('year');?></span>
							...
							<div class="performance-wrap">
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table">
											<thead>
												<tr>
													<th class="okr-show-obj"><?php echo lang('objective_key_result'); ?></th>
													<th class="text-center okr-status-wid"><?php echo lang('status'); ?></th>
													<th class="text-center okr-pgss" style=""><?php echo lang('progress'); ?></th>
													<th class="text-center okr-gradig" style=""><?php echo lang('grading'); ?></th>
													<th class="text-center okr-feedack" style=""><?php echo lang('feedback'); ?></th>
											...
											<tbody>
												...
												<td>
													<div class="label-input">
														<label class="goalCount"><?php echo lang('objective');?> <?php echo $count;?></label>
													 ...
													 <td class=""> 
														...
														<input type="hidden" class="grade_val" name="grade_value[]" value=""> -->
														 <select class="form-control select" name="grade_value" disabled="disabled">
															<?php $ratings = $this->db->get_where('okr_ratings',array('subdomain_id'=>$this->session->userdata('subdomain_id')))->row_array() ; ?>
								...
								foreach ($okr_results as $okr_result) {
									 ...
									 $result_feedback = $this->db->where('okr_result_id',$okr_result['id'])->get('okr_result_feedback')->row_array(); 
												...
												<tr>
													<td>
														<div class="label-input">
															<label><?php echo lang('key_result');?> <?php echo $result_count;?></label>
															<input type="text" class="form-control" name="key_result[]" value="<?php echo $okr_result['key_result'];?>">
															<?php 
															 if($result_count == count($okr_results)){?>
															 	<button type="button" class="btn btn-white add_key_result" data-arrayval="<?php echo count($okr_results);?>" data-toggle="tooltip" data-original-title="<?php echo lang('add_key_result'); ?>"><i class="fa fa-plus-circle"></i></button>
															 <?php } ?>
										...
										<div class="m-t-20 m-b-10 text-center">
											<button class="btn btn-primary" type="submit" id="create_offers_submit"><?php echo lang('update_okr_performance');?></button>
										</div>
									</div>
								</div>
								</div>
								...
								<div class="add-another-obj">
									<a href="javascript:void(0);" id="add_another_objective"><i class="fa fa-plus"></i> <?php echo lang('add_another_objective'); ?></a>
								</div>
							...
							<div class="form-group">
								...
								<div class="radio_input">
									<label class="radio-inline custom_radio">
										<input type="radio" name="goal_duration" value="90 days" checked><?php echo lang('90');?> <?php echo lang('days');?> <span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										<input type="radio" name="goal_duration" value="6 month"><?php echo lang('6');?> <?php echo lang('month');?> <span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										<input type="radio" name="goal_duration" value="1 year"><?php echo lang('1');?> <?php echo lang('year');?> <span class="checkmark"></span>
									</label> 
								</div>
							</div>
									...
									<div class="table-responsive">
										<table class="table performance-table">
											...
											<tbody>
												...
												<td>
													<div class="label-input">
														<label class="goalCount"><?php echo lang('objective'); ?> <?php echo lang('1'); ?></label>
														<input type="text" class="form-control" name="objective[]" required="required">
													</div>
													</td>
													<td class="text-center">
													 <span style="min-width:100px; padding:10px;" class="btn btn-info" name="status"><?php echo lang('pending'); ?></span>
											...
											<tbody class="key_result_container">
												<tr>
													<td>
														<div class="label-input">
															<label><?php echo lang('key_result'); ?> <?php echo lang('1'); ?></label>
													...
													<td class="text-center">
														<span style="min-width:100px; padding:10px;" class="btn btn-info"><?php echo lang('pending'); ?></span>
										...
										<div class="m-t-30 text-center">
											<button class="btn btn-primary" type="submit" id="create_offers_submit"><?php echo lang('create_okr_performance');?></button>
										</div>
									</div>
								</div>
							    </form>
							...
							<li>
								<div class="review">
									...
									<div class="review-block">
										...
										<p><?php echo lang('no_feedback_found'); ?></p>
		...
		<div id="progress_bar" class="modal center-modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title title"><?php echo lang('objective_progress'); ?></h4>
					</div>
					<div class="modal-body">
						<div class="range">
							<input type="range" min="0" max="100" value="0"  class="okr_progress" id="myRange">
							<span class="setyear"><?php echo lang('0'); ?></span>
						</div>
					</div>
		...
		<div id="key_progress" class="modal center-modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><?php echo lang('key_result_progress'); ?></h4>
					</div>
					<div class="modal-body">
						<div class="range">
							<input type="range" min="0" max="100"  value="0" class="okr_key key_progress" id="key_range">
							<span class="setyearkey" style=""><?php echo lang('0'); ?></span>
						</div>
		...
		<?php $okr_objectives = $this->db->select()
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><?php echo lang('no_feedback_found'); ?>Feedback</h4>
					</div>
					<div class="modal-body">
