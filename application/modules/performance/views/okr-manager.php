...
?>
                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title"><?php echo $okrdetails['emp_name']?> <?php echo lang('performance'); ?></h4>
						...
						<div class="col-md-12">
							...
							<div class="form-group col-md-6">
								...
								<div class="radio_input">
									...
									<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='90 days')? 'checked':'' ?> value="90 days"><?php echo lang('90_days'); ?><span class="checkmark"  ></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration"  <?php echo ($okrdetails['goal_duration'] =='6 month')? 'checked':'' ?>  value="6 month"><?php echo lang('6_month'); ?><span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='1 year')? 'checked':'' ?> value="1 year"><?php echo lang('1_year'); ?><span class="checkmark" ></span>
									</label> 
								</div>
							</div>
											...
											<tbody>
												...
												<td>
													<div class="label-input">
														<label><?php echo lang('objective'); ?> <?php echo $key+1?></label>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<option value="Approved" <?php if($obj->okr_status == "Approved") echo selected;?>><?php echo lang('approved'); ?></option>
																<option value="Pending" <?php if($obj->okr_status == "Pending") echo selected;?>><?php echo lang('pending'); ?></option>
																<option value="Rejected" <?php if($obj->okr_status == "Rejected") echo selected;?>><?php echo lang('rejected'); ?></option>
															</select>
														</div>
													</td>
													<td class="text-center">
													...
													<td class="text-center">
														...
														<?php } } } else { ?>
																<option value=""><?php echo lang('rating_not_found');?></option>
														<?php } ?>

														</select>
													</td>
													<td class="text-center">													   
														<button style="min-width:50px;padding:10px;font-size:16px;" type="button" class="btn <?php echo ($object_feedback['feed_back'] !='')?'btn-success':'btn-white';?>" data-toggle="modal" data-target="#add_obj_feedback<?php echo $obj->id;?>"><i class="fa fa-pencil"></i></button>
									 ...
									 $result_feedback = $this->db->where('okr_result_id',$okr_result['id'])->get('okr_result_feedback')->row_array(); 
												...
												<tr>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<select class="form-control okr_result_status" name="key_status[<?php echo $i?>][]" data-id="<?php echo $okr_result['id'];?>" data-userid="<?php echo $okrdetails['user_id'];?>">
																<option value="Approved" <?php if($okr_result['key_status'] == "Approved") echo selected;?>><?php echo lang('approved'); ?></option>
																<option value="Pending" <?php if($okr_result['key_status'] == "Pending") echo selected;?>><?php echo lang('pending'); ?></option>
																<option value="Rejected" <?php if($okr_result['key_status'] == "Rejected") echo selected;?>><?php echo lang('rejected'); ?></option>
													...
													<td class="text-center">
														...
														<button style="min-width:70px;padding:10px;" class="btn btn-success" type="button" id="keyres_progress" name="keyprog_value[<?php echo $i?>][]"><?php if($okr_result['keyprog_value'] != '') { ?><?php echo $okr_result['keyprog_value'];?>%<?php } else {?>0%<?php } ?></button>
													...
													<td class="text-center">
													 <button style="min-width:50px;padding:10px;font-size:16px;" type="button" class="btn <?php echo ($result_feedback['feed_back'] !='')?'btn-success':'btn-white';?>" data-toggle="modal" data-target="#add_result_feedback<?php echo $okr_result['id'];?>"><i class="fa fa-pencil"></i></button>
													</td>
												</tr>
												<?php 
												$result_count++;
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="hidden" name="user_id" value="<?php echo $okrdetails['user_id'];?>">
						</div>
