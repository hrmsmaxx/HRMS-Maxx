...
?>
                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title"><?php echo $okrdetails['emp_name']?> Performance</h4>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<select class="form-control okr_result_status" name="key_status[<?php echo $i?>][]" data-id="<?php echo $okr_result['id'];?>" data-userid="<?php echo $okrdetails['user_id'];?>">
																...
																<option value="Rejected" <?php if($okr_result['key_status'] == "Rejected") echo selected;?>>Rejected</option>
