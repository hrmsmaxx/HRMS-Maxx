					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">								
								<table id="table-performance_dashboard" class="table table-bordered custom-table m-b-0" >
								<?php if($performance_status['okr'] ==1){?>
									<thead>
										<tr>
											...
											<!-- <th>Peer Reviews</th> -->
											<th style=" text-align: center;"><?php echo lang('okr_grading');?></th>
								...
								<?php if($performance_status['competency'] ==1){?>
									<thead>
										<tr>
											...
											<th><?php echo lang('self_ratings');?></th>
											<!-- <th>Peer Reviews</th> -->
											<th style=" text-align: center;"><?php echo lang('your_ratings');?></th>
										</tr>
									</thead>
									<tbody>
										<?php 
...
$account_details = $this->db->get_where('account_details',array('user_id'=>$value['user_id']))->row_array();
								...
								<?php if($performance_status['smart_goals'] ==1){?>
									<thead>
										<tr>
											<th style="width:30%;"><?php echo lang('team');?></th>											
											<th><?php echo lang('goals');?></th>
											<th style=" text-align: center;"><?php echo lang('your_reviews');?></th>
										</tr>
									</thead>
									<tbody>
										<?php 
