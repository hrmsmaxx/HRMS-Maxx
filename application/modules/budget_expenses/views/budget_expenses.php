                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                              <li><a href="<?php echo base_url(); ?>budget_expenses/edit/<?php echo $budget['id']; ?>" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> <?=lang('edit')?></a></li>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content modal-md">
                          <div class="modal-header">
                            <h4 class="modal-title"><?=lang('delete_expensess')?>( <?php echo $budget['notes']; ?> )</h4>
                          </div>
