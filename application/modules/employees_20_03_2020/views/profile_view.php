						...
						<div class="row">
							<div class="col-md-5">
								<div class="profile-info-left">
									...
									<div class="staff-id">Employee ID Code : <?php echo $employee_details['id_code']; ?></div>
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<input type="text" name="id_code" placeholder="<?=lang('eg')?> 543219876" id="check_id_code" value="<?php echo $employee_details['id_code']; ?>" class="form-control only-numeric" autocomplete="off">
													</div>
												</div>
