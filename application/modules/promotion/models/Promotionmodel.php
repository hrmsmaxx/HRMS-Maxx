...
var $table = 'promotion p';
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select('p.*,u.id_code,u.id as user_id,a.avatar,a.fullname,d.deptname,ds.designation,g.grade_name as promotion_from, gg.grade_name as promotion_to');
        ...
        $this->db->join('designation ds', 'ds.id = u.designation_id', 'left');
