...
class Work_management extends MX_Controller {
    ...
    $data['page'] = lang('work_management');
    ...
    public function request_approval()
    {
        ...
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
            $this->template
        ->set_layout('users')
        ->build('work_management/request_approval',isset($data) ? $data : NULL);
    }
