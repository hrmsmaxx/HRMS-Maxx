                    ...
                    foreach ($employees as $key => $value) {
                        ...
                        if(isset($_POST["recurring_shift"]) && !empty($_POST["recurring_shift"])){
                           ...
                           // echo "<pre>";print_r($period); exit;       
                            ...
                            $count = 1;
                            $leave_day ="";
                            // echo "<pre>"; print_r($_POST['week_days']) ; 
                            $days  = array();
                            ...
                            // if($k== 7){
                                ...
                                //$leaveDay = 0;  
                                if(!in_array(lcfirst($dt->format("l")), $d)){
                                    $leaveDay = array_search(lcfirst($dt->format("l")),$weekDays);
                                }                               
                                
                                if($lastDateWeekNumber != $weekNumber) {
                                    if($leaveDay > 0){
                                        $d[$leaveDay-1] = $weekDays[$leaveDay];
                                    }
