						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="checkbox ">
									  <label><input type="checkbox"  name="cyclic_shift" id="cyclic_shift" value="1" <?php echo (isset($shift_details['cyclic_shift']) && ($shift_details['cyclic_shift'] ==1))?"checked":"";?>>Cyclic Shift</label>
									</div>
								</div>
								
								<!--  -->	
								<div id="recurring" class="<?php echo (isset($shift_details['recurring_shift']) && ($shift_details['recurring_shift'] ==1 || $shift_details['cyclic_shift'] ==1))?"":"hide";?>">
									<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="cal-icon">
										<input class="datepicker-schedule form-control" name="end_date" id="end_date" data-date-format="dd-mm-yyyy" value="<?php echo (isset($shift_details['end_date']) && ($shift_details['end_date'] =='0000-00-00'))?'':date('d-m-Y',strtotime($shift_details['end_date']));?>" placeholder="DD/MM/YYYY">
									</div>
								</div>														
								<div class="form-group">
