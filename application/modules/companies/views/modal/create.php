...
if($this->session->userdata('role_name')=='admin' && $this->session->userdata('branch_id') != '') {
    ...
    $branchs = $this->db->query("SELECT * FROM `dgt_branches` WHERE find_in_set(`id`, '$branch_id') AND `subdomain_id`='".$subdomain_id."' ")->result();
} else {
    $branchs = $this->db->get_where('dgt_branches', array('subdomain_id'=>$this->session->userdata('subdomain_id')))->result();
}
			...
			<div class="modal-body">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab-client-general">
						...
						<a class="btn btn-primary submit-btn" id="nextCreateGeneral"><?=lang('next');?></a>
						</div>
					...
					<div class="tab-pane fade in" id="tab-client-contact">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_general').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;" id="nextCreateContact" type="submit"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-web">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_contact').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;"  onclick="$('#tab_client_bank').trigger('click')"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-bank">
						...
						<div class="form-group">
							<label><?=lang('swift_bic');?></label>
							<input type="text" value="" name="bic" class="form-control">
						</div>
						<div class="form-group">
							<label><?=lang('sort_code');?></label>
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_web').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;" onclick="$('#tab_client_hosting').trigger('click')"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-hosting">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_bank').trigger('click')"><?=lang('previous');?></a>
