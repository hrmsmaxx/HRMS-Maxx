<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
			...
			<h4 class="modal-title"><?=lang('edit_client')?> <?=$company_id?></h4>
        </div>
		<?php $i = Client::view_by_id($company_id); ?>
			...
			<div class="modal-body">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab-client-general">
						...
						<input type="hidden" name="co_id" value="<?=$i->co_id?>">
						 <?php /* <div class="form-group">
							...
							<select class="form-control" name="branch_id" id="branch_name">
								<option value="" disabled><?php echo lang('select_branch'); ?></option>
								<?php  
								if(!empty($branches)) {
									foreach ($branches as $branch){ ?>
										<option value="<?=$branch->id;?>" <?php if($branch->id == $i->branch_id) { echo 'selected'; }?>><?=$branch->branch_name;?></option>
									<?php } ?>
								<?php } ?>
							</select>
						</div> */ ?>
						...
						<a class="btn btn-primary" id="nextEditGeneral"><?=lang('next');?></a>
						</div>
					...
					<div class="tab-pane fade in" id="tab-client-contact">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_general').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary" style="float:right;" id="nextEditContact" type="submit"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-web">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_contact').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary" style="float:right;"  onclick="$('#tab_upt_client_bank').trigger('click')"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-bank">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_web').trigger('click')"><?=lang('previous');?></a>
        				<a class="btn btn-primary" style="float:right;" onclick="$('#tab_upt_client_hosting').trigger('click')"><?=lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-hosting">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_bank').trigger('click')"><?=lang('previous');?></a>
