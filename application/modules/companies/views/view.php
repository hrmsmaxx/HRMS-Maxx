										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<div class="staff-id"><?=lang('company_id');?> : <?=$i->company_ref?></div>
													<div class="staff-msg"><a href="chat.html" class="btn btn-custom"><?=lang('send_message');?></a></div>
												</div>
											</div>
											<div class="col-md-7">
						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="active"><a class="nav-link active" data-toggle="tab" href="#myprojects"><?=lang('my_projects');?></a></li>
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-4">
											<div class="card-box project-box">
												...
												<p class="m-b-5"><?=lang('progress');?> <span class="text-success pull-right"><?php echo $p->progress; ?>%</span></p>
									        ...
									        <section class="panel panel-table">
									            <div class="panel-heading panel-h-p1">
													<div class="row">
														...
														<div class="col-xs-6">
															<a href="<?=base_url()?>estimates/add/<?=$i->co_id?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i> <?=lang('estimates')?></a><!-- data-toggle="ajaxModal" -->
														</div>
													</div>
												</div>
												<div class="panel-body">
