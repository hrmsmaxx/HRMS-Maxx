...
class Online_services extends MX_Controller {
    ...
    $this->template->title(lang('online_services').' - '.$this->company_name);
    $data['page'] = lang('online_services');
    ...
    public function profile_view($id)
    {
        $this->load->module('layouts');
        $this->load->library('template');
        $this->template->title('View Profile - '.$this->company_name);
	...
	public function emergency_tc()
    {
        ...
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
            $this->template
        ->set_layout('users')
        ->build('online_services/emergency_tc',isset($data) ? $data : NULL);
    } 
	
	
	public function passport_app()
    {
        $this->load->module('layouts');
        $this->load->library('template');
        $this->template->title(lang('online_services').'- '.$this->company_name);
        ...
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
            $this->template
        ->set_layout('users')
        ->build('online_services/passport_app',isset($data) ? $data : NULL);
    } 
	...
	public function work_permit()
    {
        ...
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
            $this->template
        ->set_layout('users')
        ->build('online_services/work_permit',isset($data) ? $data : NULL);
    }
	
	
	public function foreign_res_permit()
    {
        $this->load->module('layouts');
        $this->load->library('template');
        $this->template->title(lang('online_services').'- '.$this->company_name);
        ...
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
            $this->template
        ->set_layout('users')
        ->build('online_services/foreign_res_permit',isset($data) ? $data : NULL);
    }
    ...
    public function edit_profile($id)
    {
        ...
        $this->load->module('layouts');
        $this->load->library('template');
        $this->template->title('Edit Profile - '.$this->company_name);
        $data['page'] = lang('all employees');
        $data['form'] = TRUE;
        $data['employee_details'] = $this->employees->get_employeedetailById($id);
        $data['personal_details'] = $this->employees->get_employeepersonalById($id);
