<div class="content">
	...
	<div class="card-box">
		<ul class="nav nav-tabs nav-tabs-solid page-tabs">
			...
			<li class="active"><a href="<?php echo base_url(); ?>online_services/passport_app"><?php echo lang('passport_app'); ?></a></li>
	...
	<div class="card-box">
		<div class="row">
			<div class="col-sm-12">
				<h4 class="page-title"><?php echo lang('passport_app'); ?></h4>
			</div>
		</div>	
