<div class="content">
	...
	<div class="card-box">
		<ul class="nav nav-tabs nav-tabs-solid page-tabs">
			<li ><a href="<?php echo base_url(); ?>online_services"><?php echo lang('e_visa'); ?></a></li>
			...
			<li class="active"><a href="<?php echo base_url(); ?>online_services/foreign_res_permit"><?php echo lang('foreign_res_permit'); ?></a></li>
		</ul>
	</div>
	...
	<div class="card-box">
		<div class="row">
			<div class="col-sm-12">
				<h4 class="page-title"><?php echo lang('foreign_res_permit'); ?></h4>
			</div>
		</div>	
