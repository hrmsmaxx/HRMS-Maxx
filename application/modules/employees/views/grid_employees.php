<!-- Page Content  -->
                <div class="content container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>employees/grid_employee" method="POST">
						<div class="col-lg-4 col-sm-6">  
							<div class="form-group form-focus">
								<label class="control-label"><?php echo lang('fullname');?></label>
								<input type="text" id="client_name_edit" name="username" class="form-control floating">
								<label id="client_name_error" class="error display-none" for="client_name"><?php echo lang('full_name_must_not_empty');?></label>
							</div>
						</div>
						<!-- <div class="col-lg-4 col-sm-6">  
							<div class="form-group form-focus">
					...
					<div class="row staff-grid-row">
						...
						foreach ($employees as $employee) { 
							if($employee->subdomain_id == $this->session->userdata('subdomain_id')){
						// $client_due = Client::due_amount($client->co_id);
						?>
							<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3 AllGridCompanies">
								<div class="profile-widget">
									<div class="profile-img">
										<a  href="<?php echo base_url(); ?>employees/profile_view/<?php echo $employee->id; ?>" class="avatar"><img class="avatar" src="<?php echo base_url(); ?>assets/avatar/<?php echo $employee->avatar; ?>" alt=""></a>
									...
									<div class="dropdown profile-action">
										...
										<ul class="dropdown-menu pull-right">
											<li><a href="<?php echo base_url(); ?>employees/profile_view/<?php echo $employee->id; ?>" title="Employee"><i class="fa fa-pencil m-r-5"></i> <?php echo lang('edit');?></a></li>
											<li><a href="<?php echo base_url(); ?>employees/delete/<?php echo $employee->id; ?>" data-toggle="ajaxModal"><i class="fa fa-trash-o m-r-5"></i> <?php echo lang('delete');?></a></li>
											<!-- <li><a href="<?php echo base_url(); ?>employees/change_inactive/317"><i class="fa fa-eye-slash m-r-5"></i><?php echo lang('in_active');?></a></li> -->
										</ul>
									</div>
									...
									<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo base_url(); ?>employees/profile_view/<?php echo $employee->id; ?>"><?php echo $employee->id_code; ?></a></h5>
									...
									<a href="<?=base_url()?>employees/profile_view/<?=$employee->id?>" class="btn btn-white btn-sm m-t-10"><?=lang('view_profile')?></a>
								</div>
							</div>
						<?php } } } ?>
					</div>
