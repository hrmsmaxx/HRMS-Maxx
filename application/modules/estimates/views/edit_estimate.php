...
<div class="content">
	<div class="row">
		<!-- <div class="col-sm-8">
			<h4 class="page-title"><?php //echo lang('edit_estimate')?></h4>
		</div> -->
	...
	<div class="row">
		<div class="col-xs-3">
			<h4 class="page-title"><?=lang('edit_estimate')?></h4>
		</div>
				...
				<div class="panel-body">
					<?php $attributes = array('class' => 'bs-example form-horizontal'); echo form_open_multipart(base_url().'estimates/edit',$attributes); ?>
						...
						<?php /* <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select class="select2-option form-control" style="width:100%" name="branch_id" id="branch_id">
                                    <option value="" disabled><?=lang('select_branch');?></option>
                                    <?php foreach ($branches as $branch) { ?>
                                    <option value="<?=$branch->id;?>" <?php if($branch->id == $est->branch_id) { echo 'selected'; } ?>><?=$branch->branch_name;?></option>
                                    <?php } ?>
                                </select>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="edit_estimate_tax1_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="tax1"><?=lang('tax_is_invalid')?></label>
								</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="edit_estimate_tax2_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="tax2"><?=lang('tax_is_invalid')?></label>
								</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<div class="row">
								<div class="col-md-12">
								<label id="edit_estimate_discount_error" class="error display-none" style="position:inherit;top:0;font-size: 15px;" for="discount"><?=lang('discount_is_invalid')?></label>
								</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								...
								<div class="row">
									<div class="col-md-6">
									<label id="estimates_notes_error" class="error display-none" style="position:inherit;top:0;font-size:15px;" for="notes"><?=lang('notes_not_empty')?></label>
									</div>
							</div>
							</div>
