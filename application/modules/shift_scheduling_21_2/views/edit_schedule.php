					...
					<form method="POST" id="scheduleAddForm" action="<?php echo base_url().'shift_scheduling/edit_schedule'?>">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="<?php echo (isset($employee_details['recurring_shift']) && ($employee_details['recurring_shift'] ==1))?"":"hide";?>">
								<div class="form-group">
									<div class="checkbox">
									  <label><input type="checkbox"  name="recurring_shift" id="recurring_shift" value="1" class="recurring" <?php echo (isset($employee_details['recurring_shift']) && ($employee_details['recurring_shift'] ==1))?"checked":"";?> onclick="return false;">Recurring Shift</label>
									</div>
								</div>
								<!--  -->	
								...
								<div class="form-group">
									...
									<div class="cal-icon">
									<input class="datepicker-schedule form-control" class="form-control" data-date-format="dd-mm-yyyy"  name="end_date" id="end_date"  value="<?php echo (isset($employee_details['end_date']) && ($employee_details['end_date'] =='0000-00-00'))?$employee_details['schedule_date']:date('d-m-Y',strtotime($employee_details['end_date']));?>"  >	
									</div>								
								</div>	
								<div class="form-group ">
