...
class Performance_three_sixty extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->title(lang('360 performance').' - '.$this->company_name);

        $data['page'] = lang('performances');

        $data['sub_page'] = lang('360 performance');
    ...
    public function create_360()
    {
        ...
        if ($this->input->post()) {
                ...
                $args = array(
                            ...
                            'module' => 'performance_three_sixty/show_performance_three_sixty',
                            'module_field_id' => $performance_360_id,
                            'activity' => user::displayName($_POST['user_id']).' Updated Competency Performance',
                            'icon' => 'fa-user',
                            'value1' => $_POST['user_id'],
                            'subdomain_id' =>$this->session->userdata('subdomain_id'),
                        );
                App::Log($args);
                $this->session->set_flashdata('tokbox_success', lang('360_performance_updated_successfully'));
                ...
                $args = array(
                            ...
                            'module' => 'performance_three_sixty/show_performance_three_sixty',
                            'module_field_id' => $performance_360_id,
                            'activity' => user::displayName($_POST['user_id']).' Created Competency Performance',
                            'icon' => 'fa-user',
                            'value1' => $_POST['user_id'],
                            'subdomain_id' =>$this->session->userdata('subdomain_id'),
                        );
        ...
        $data['page'] = lang('360 performance');
        $data['datatables'] = true;
        $data['form'] = true;
        $data['currencies'] = App::currencies();
        $data['languages'] = App::languages();
    ...
    public function manager_rating(){
        ...
        $user_id= $this->db->get_where('performance_360',array('id'=>$id))->row()->user_id;
     ...
     public function manager_competence_rating(){
        ...
        $args = array(
                    ...
                    'activity' => user::displayName($this->session->userdata('user_id')).' Updated the competencies rating',
                    'icon' => 'fa-user',
                    'subdomain_id' =>$this->session->userdata('subdomain_id'),
                    // 'value1' => $_POST['user_id'],
                );
     ...
     public function employee_competence_rating(){
        ...
        $args = array(
                    ...
                    'module' => 'performance_three_sixty/show_performance_three_sixty',
                    'module_field_id' => $competencies_id,
                    'activity' => user::displayName($this->session->userdata('user_id')).' Updated competencies Rating',
                    'icon' => 'fa-user',
                    'value1' => $_POST['user_id'],
                    'subdomain_id' =>$this->session->userdata('subdomain_id'),
                );
    ...
    public function three_sixty_feedback(){
     ...
     public function competencies_feedback(){
            ...
            $_POST['user_id'] = $this->session->userdata('user_id');
                ...
                $args = array(
                            'user' => $_POST['feedback_to'],
                            'module' => 'performance_three_sixty',
                            'module_field_id' => $performance_360_feedback,
                            'activity' => user::displayName($this->session->userdata('user_id')).' Gave the feedback',
                            'icon' => 'fa-user',
                            'subdomain_id' =>$this->session->userdata('subdomain_id'),
                            // 'value1' => $_POST['feedback_to'],
                        );
                App::Log($args);
                $this->session->set_flashdata('tokbox_success', lang('feedback_updated_successfully'));
                redirect('performance_three_sixty/show_performance_three_sixty/'.$_POST['feedback_to']);
