						 ...
						 ?>
							...
							<?php if(!empty($performances_360)){ 
								...
								<div class="form-group col-sm-6">
									<label>Goal Dura<?php echo lang('goal_duration'); ?></label>
									<div class="radio_input">
										<label class="radio-inline custom_radio">
											<input type="radio" readonly name="goal_duration" <?php echo ($performance_360['goal_duration'] == 1)?"checked":"";?> value="1"><?php echo lang('90_days'); ?> <span class="checkmark"></span>
										</label>
										<label class="radio-inline custom_radio">
											<input type="radio" readonly name="goal_duration" <?php echo ($performance_360['goal_duration'] == 2)?"checked":"";?> value="2"><?php echo lang('6_month'); ?> <span class="checkmark"></span>
										</label>
										<label class="radio-inline custom_radio">
											<input type="radio"readonly name="goal_duration" <?php echo ($performance_360['goal_duration'] == 3)?"checked":"";?> value="3"><?php echo lang('1_year'); ?><span class="checkmark"></span>
										</label> 
									</div>
								</div>
								<div class="form-group col-sm-6">
								...
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table perform-align" style="table-layout: fixed;width:initial;">
											<thead>
												<tr>
													<th class="com-goal-width"><?php echo lang('goal'); ?> <?php echo $count;?></th>
													...
													<td class="text-center">														
														<div class="dropdown">
															...
															<ul class="dropdown-menu pull-right">
																<li><a href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/1/<?php echo $performance_360['user_id']; ?>"><?php echo lang('approved'); ?></a></li>
																<li><a href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/2/<?php echo $performance_360['user_id']; ?>"><?php echo lang('rejected'); ?></a></li>
																<li><a href="<?=base_url()?>performance_three_sixty/three_sixty_status/<?php echo $performance_360['id'];?>/0/<?php echo $performance_360['user_id']; ?>"><?php echo lang('pending'); ?></a></li>
															</ul>
														</div>
								...
								<div class="performance-box comp-box m-b-0">
									<div class="table-responsive">
										<table class="table performance-table perform-align">
											<thead>
												<tr>
													<th class="com-goal-width1"><?php echo lang('competencies'); ?></th>
													<th class="text-center com-self-rating" ><?php echo lang('self_rating'); ?></th>
													<th class="text-center com-rating"><?php echo lang('rating'); ?></th>
													<th class="text-center" style="min-width: 110px;width:110px;"><?php echo lang('feedback'); ?></th>
