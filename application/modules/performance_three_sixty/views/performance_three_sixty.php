                ...
                <div class="content container-fluid">
					...
					<div class="row">
						 ...
						 ?>
										...
										<div class="form-group col-sm-6">
											...
											<div class="radio_input">
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($performance_360['goal_duration'] == 1)?"checked":"";?> value="1"><?php echo lang('90_days'); ?> <span class="checkmark"></span>
												</label>
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($performance_360['goal_duration'] == 2)?"checked":"";?> value="2"><?php echo lang('6_month'); ?> <span class="checkmark"></span>
												</label>
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($performance_360['goal_duration'] == 3)?"checked":"";?> value="3"><?php echo lang('1_year'); ?> <span class="checkmark"></span>
												</label> 
											</div>
										</div>
								...
								<div class="performance-box">
									...
									<div class="table-responsive">
										<table class="table performance-table  perform-align">
											<thead>
												<tr>
													<th class="goalCount com-goal-width"> <?php echo lang('goal'); ?><?php echo $count;?></th>
													<th class="text-center" style="min-width:140px;width:140px;max-width:140px;"><?php echo lang('status'); ?></th>
													<th class="text-center com-self-rating"><?php echo lang('self_rating'); ?></th>
													<th class="text-center com-rating"><?php echo lang('rating'); ?></th>
													<th class="text-center" style="min-width:110px;width: 110px;max-width:110px;"><?php echo lang('feedback'); ?></th>
												</tr>
											</thead>
											<tbody>
												<tr>
													...
													<?php $ratings = $this->db->get_where('competency_ratings',array('subdomain_id'=>$this->session->userdata('subdomain_id')))->row_array() ; ?>
													<td>
												...
												<tr>
													<td colspan="6">
														<div class="add-another">
															<a href="javascript:void(0);" class="add_goal_action"><i class="fa fa-plus"></i> <?php echo lang('action');?></a>
														</div>
													</td>
												</tr>
												<tr>
                                                        ...
                                                        <div class="task-list-container">
                                                                    ...
                                                                    <li class="task <?php echo ($result[$i] == 1)?'completed':'';?>">
                                                                        <div class="task-container">
                                                                            <span class="task-action-btn task-check">
                                                                                <span class="action-circle large complete-btn" onclick="progress_smartgoal(this)" title="<?php echo lang('mark_complete'); ?>">
                                                                            ...
                                                                            <span class="task-action-btn task-btn-right">
                                                                                <span class="action-circle large delete-btn" title="<?php echo lang('delete'); ?> Goal Action">
                                                            ...
                                                            <div class="task-list-footer">
                                                                <div class="new-task-wrapper">
                                                                    ...
                                                                    <span class="add-new-task-btn btn btn-success add_goal"><?php echo lang('add_goal_action'); ?></span>
                                                    ...
                                                    <div class="m-t-30 text-right">
															<button class="btn btn-primary" type="submit" id="create_okr_submit"><?php echo lang('create_360_performance'); ?></button>
														</div>
														<!-- /Goal Actions -->
													</td>
												</tr>
							...
							<?php $count++; } ?>
								...
								<div class="add-another-goal">
									<a class=" m-b-0" href="javascript:void(0);" id="add_another_goal" ><i class="fa fa-plus"></i> <?php echo lang('add_another_goal'); ?></a>
							...
							<div class="performance-wrap">
								...
								<!-- <div class="row" style="margin-left: 0px; margin-right: -64px;"> -->
									...
									<div class="form-group col-sm-6" >
										...
										<div class="radio_input">
											<label class="radio-inline custom_radio p-t-0">
												<input type="radio" name="goal_duration" checked="" value="1"><?php echo lang('90_days'); ?> <span class="checkmark"></span>
											</label>
											<label class="radio-inline custom_radio p-t-0">
												<input type="radio" name="goal_duration" value="2"><?php echo lang('6_month'); ?> <span class="checkmark"></span>
											</label>
											<label class="radio-inline custom_radio p-t-0">
												<input type="radio" name="goal_duration" value="3"><?php echo lang('1_year'); ?> <span class="checkmark"></span>
											</label> 
										</div>
									</div>
									<div class="form-group col-sm-6">
								...
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table perform-align" style="table-layout: fixed;width:initial;">
											<thead>
												<tr>
													<th class="goalCount com-goal-width"><?php echo lang('goal'); ?><?php echo lang('1'); ?> </th>
													<th class="text-center" style="min-width: 140px;width:140px;max-width:140px;"><?php echo lang('status'); ?><th>
													<th class="text-center com-self-rating"><?php echo lang('self_rating'); ?><th>
													<th class="text-center com-rating"><?php echo lang('rating'); ?><th>
													<th class="text-center" style="width: 110px;max-width:110px;"><?php echo lang('feedback'); ?><th>
												</tr>
											</thead>
											<tbody>
												<tr>
													...
													<td class="text-center">
														...
														<button class="btn btn-warning" style="padding:10px;min-width:100px;"><?php echo lang('pending'); ?></button>
													</td>
													<td>
														<?php $ratings = $this->db->get_where('competency_ratings',array('subdomain_id'=>$this->session->userdata('subdomain_id')))->row_array() ; 
														 ?>
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <div class="m-t-20 text-right">
																	<button class="btn btn-primary" type="submit" id="create_offers_submit"><?php echo lang('create_360_performance'); ?></button>
																</div>
														<!-- /Goal Actions -->
													</td>
												</tr>
								...
								<div class="add-another-goal">
									<a href="javascript:void(0);" id="add_another_goal" ><i class="fa fa-plus"></i> <?php echo lang('add_another_goal'); ?></a>
						...
						<?php } ?>
							...
							<div class="performance-wrap">
								<h3 class="m-b-20"><?php echo lang('competencies'); ?></h3>
								<div class="performance-box comp-box m-b-0">
										...
										<table class="table performance-table" style="width:100%;">
											<thead>
												<tr>
													<th class=""><?php echo lang('competencies'); ?></th>
													<th class="text-center" style="width: 120px;"><?php echo lang('self_rating'); ?></th>
													<th class="text-center" style="width: 120px;"><?php echo lang('rating'); ?></th>
													<th class="text-center" style="width: 85px;"><?php echo lang('feedback'); ?></th>
						...
						<?php } } else {?>
							<li>
								<div class="review">
									...
									<div class="review-block">										
										<p><?php echo lang('no_review_found'); ?></p>
									</div>
								</div>
							</li>
						<?php }?>
