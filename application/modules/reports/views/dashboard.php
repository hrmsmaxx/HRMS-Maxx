...
<div class="content">
	<div class="row">
		<div class="col-sm-12">
			<h4 class="page-title"><?php echo lang('reports');?></h4>
		</div>
	</div>
	<div class="card-box">
	<div class="row">
...
Morris.Bar({
  element: 'bar-graph',
  data: [
    { y: '<?php echo lang('Jan'); ?>', a: <?=Report::invoiced($chart_year,'01')?> },
    { y: '<?php echo lang('Feb'); ?>', a: <?=Report::invoiced($chart_year,'02')?> },
    { y: '<?php echo lang('Mar'); ?>', a: <?=Report::invoiced($chart_year,'03')?> },
    { y: '<?php echo lang('Apr'); ?>', a: <?=Report::invoiced($chart_year,'04')?> },
    { y: '<?php echo lang('May'); ?>', a: <?=Report::invoiced($chart_year,'05')?> },
    { y: '<?php echo lang('Jun'); ?>', a: <?=Report::invoiced($chart_year,'06')?> },
    { y: '<?php echo lang('Jul'); ?>', a: <?=Report::invoiced($chart_year,'07')?> },
    { y: '<?php echo lang('Aug'); ?>', a: <?=Report::invoiced($chart_year,'08')?> },
    { y: '<?php echo lang('Sep'); ?>', a: <?=Report::invoiced($chart_year,'09')?> },
    { y: '<?php echo lang('Oct'); ?>', a: <?=Report::invoiced($chart_year,'10')?> },
    { y: '<?php echo lang('Nov'); ?>', a: <?=Report::invoiced($chart_year,'11')?> },
    { y: '<?php echo lang('Dec'); ?>', a: <?=Report::invoiced($chart_year,'12')?> }
  ],
  xkey: 'y',
  ykeys: ['a'],
  labels: ['<?php echo lang('invoices'); ?>'],
  preUnits:'<?=$cur->symbol?>',
  barColors: ["#38354a"]
});
</script>