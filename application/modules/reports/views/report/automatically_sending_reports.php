...
date_default_timezone_set('Asia/Kolkata');
  ...
  $punch_in_date_time = date('Y-m-d H:i');
   ...
   $where     = array('ad.user_id'=>$user_id,'a_month'=>$a_month,'a_year'=>$a_year,'ad.subdomain_id'=> $subdomain_id);
   if($branch_id != '') {
                ...
                <select class="select2-option form-control" name="user_id" id="user_name">
                    ...
                    <optgroup label="">
                        ...
                        ?>
                            ...
                            <option value="<?=$c->id?>" <?php if($_POST['user_id'] == $c->id) { echo 'selected=selected'; }?>>
      ...
      <!--   <?php  form_close(); ?> -->
        ...
        <div class="fill-container">
          ...
          <div class="col-md-12">
              ...
              <table id="task_report" class="table table-striped custom-table m-b-0 AppendDataTables">
                <thead>
                   <tr>
                      <th>#</th>
                      ...
                      <th><?php echo lang('work_status');?></th>
