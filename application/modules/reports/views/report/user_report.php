      ...
      <div class="fill body reports-top rep-new-band">
                ...
                <select class="select2-option form-control" style="width:280px" name="role_id" >
                    <optgroup label="<?=lang('tasks')?>">
                      <option value="0"><?php echo lang('all');?></option>
                        <?php 
                        $all_roles = $this->db->get_where('roles',array('subdomain_id'=>$this->session->userdata('subdomain_id')))->result();
        ...
        <div class="fill-container">
          ...
          <div class="col-md-12">
              ...
              <table id="table-templates-1 user_report" class="table table-striped custom-table m-b-0 AppendDataTables">
                <thead>
                  <tr>
