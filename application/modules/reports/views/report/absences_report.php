...
<div class="content">
	<div class="panel panel-white">
		<div class="panel-heading">
			<div class="row">
				<div class="col-sm-8">
					<h4 class="page-title m-b-0"><?=lang('absences_report')?></h4>
				</div>
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu export" style="left:auto; right:0px !important; min-width: 93px !important">  
              ...
              <li>
                <?php  $report_name = lang('absences_report');?>
                 <button class="btn  btn-block" onclick="absences_report_excel('<?php echo $report_name;?>','absences_report_excel');" style="text-align: left;"> <span style="font-size: 18px;text-align: left;"><i class="fa fa-file-excel-o" aria-hidden="true"></i></span><span><?=lang('excel')?></span> </button>
              </li>
            </ul>
          </div>
        ...
        <table id="table-absences_report" class="table table-striped custom-table m-b-0 AppendDataTables">
          <thead>
            <tr>            
              <th><?=lang('employee')?> </th>
                        ...
                        if(empty($day['punch_in'])){
                         if(count($all_user_schedule) == 1){                                
                              ...
                              if(!empty($user_schedule)){
                                ...
                                $total_scheduled_hour = $total_scheduled_hour;                                     
                            ...
                            if(count($all_user_schedule) > 1){
                              ...
                              $total_scheduled_hour = $scheduled_minutes;
