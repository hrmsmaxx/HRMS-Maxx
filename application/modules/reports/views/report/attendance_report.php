        ...
        <div class="col-sm-8">
          <h4 class="page-title m-b-10 m-r-10" style="display: inline-block;"><?=lang('attendance_report')?></h4>
           <div class="btn-group" style="display: inline-block;">
            <!-- <button class="btn btn-default"><?=lang('go_to')?></button> -->
            <button class="btn btn-default m-b-10 dropdown-toggle" data-toggle="dropdown"><?=lang('go_to')?><span class="" style="margin-left: 5px;"><img src="<?php echo base_url()."assets/img/cross_right_arrow.png";?>" width="13"></span>
            </button>
            <ul class="dropdown-menu export" style="left:auto; right:0px !important; min-width: 103px !important">  
               <li>
               <form method="post" action="<?php echo base_url()."attendance/attendance_records";?>" target="_blank">
                   ...
                   <!--  <input type="hidden" class="form-control" name = "teamlead_id" value="<?php echo (isset($_POST['teamlead_id']) && !empty($_POST['teamlead_id']))?$_POST['teamlead_id']:'';?>"> -->
                    ...
                    <button class=" btn  btn-block" type="submit" style="text-align: left;" target="_blank"><span><?=lang('attendance_records')?> / <?=lang('incidents')?></span></button>
               ...
               <li>
                ...
                <form method="post" action="<?php echo base_url()."incidents/calendar";?>" target="_blank">
                    <!-- <input type="hidden" class="form-control" name = "pdf" value="1"> -->
                    <input type="hidden" class="form-control" name = "id_code" value="<?php echo (isset($_POST['id_code']) && !empty($_POST['id_code']))?$_POST['id_code']:'';?>">
                    <input type="hidden" class="form-control" name = "department_id" value="<?php echo (isset($_POST['department_id']) && !empty($_POST['department_id']))?$_POST['department_id']:'';?>">                
                    <input type="hidden" class="form-control" name = "user_id" value="<?php echo (isset($_POST['user_id']) && !empty($_POST['user_id']))?$_POST['user_id']:'';?>">
                    <button class=" btn  btn-block" type="submit" style="text-align: left;" target="_blank"><span><?php echo lang('calendar');?></span></button>
                     <!-- <a href="#" class="pull-right" id="attendance_report_pdf1" type="submit"> -->
            ...
            <ul class="dropdown-menu export" style="left:auto; right:0px !important; min-width: 93px !important">  
              <li>
                <form method="post" action="">
                    ...
                    <input type="hidden" class="form-control" id="total_record" name = "total_record" value="">
                    <input type="hidden" class="form-control" id="attendance_record" name = "attendance_record" value="">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <a class="btn btn-success btn-md hide_attendance"><?=lang('attendance_logs')?></a>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
              <label class="d-block">&nbsp;</label>
              <a class="btn btn-success btn-md just_totals"><?=lang('just_totals')?></a>
            </div>
          </div>
          <div class="col-md-2">  
            <label class="d-block">&nbsp;</label>
            ...
            <tbody>
             ...
             <?php
                       ...
                       <?php
                          if(!empty($shift)){
                            foreach ($shift as $key => $shifts) {
                              echo $shifts['shift_name'].' ('.$shifts['work_hours'].'),';
                            } 
                          }else{
                            echo '';
                          }
                ...
                foreach ($month_days_in_out[$a_day-1] as $punch_detail) 
                {
                 ...
                 echo !empty($punch_detail['punch_in'])?'<i class="fa fa-arrow-right text-success"></i> &nbsp; '.date("g:i a", strtotime($punch_detail['punch_in'])).' '.$punchin_workcode.' &nbsp;|&nbsp ':$abs_incident; ?><?php echo !empty($punch_detail['punch_out'])?'<i class="fa fa-arrow-left text-danger"></i> &nbsp;  '.date("g:i a", strtotime($punch_detail['punch_out'])):''; ?> <?php echo $punchout_workcode;?>
               <?php }?>
                ...
                foreach ($month_days_in_out[$a_day-1] as $punch_detail) 
                {
                 ...
                 echo !empty($punch_detail['punch_in'])?'<i class="fa fa-arrow-right text-success"></i> &nbsp; '.date("g:i a", strtotime($punch_detail['punch_in'])).' '.$punchin_workcode.' &nbsp;|&nbsp ':$abs_incident; ?><?php echo !empty($punch_detail['punch_out'])?'<i class="fa fa-arrow-left text-danger"></i> &nbsp;  '.date("g:i a", strtotime($punch_detail['punch_out'])):''; ?> <?php echo $punchout_workcode;?> <br>
               <?php }?>
              </td>
