...
#excel_table th {
  ...
  padding-bottom: 12px;
              ...
              if(!empty($_POST['id_code']) || !empty($_POST['user_id']) || !empty($_POST['department_id']) || !empty($_POST['teamlead_id']) || !empty($_POST['range']))
                { 
                  ...
                  if(isset($_POST['user_id']) && !empty($_POST['user_id'])){
                    ...
                    $user_details= $this->db->get_where('users',array('subdomain_id'=>$subdomain_id,'id'=>$_POST['user_id']))->row_array();
            ...
            <table style="vertical-align: middle !important;text-align: center; border-collapse: collapse;width: 100%; padding: 8px;">
             ...
             <table style="vertical-align: middle !important;background-color:#24b23c">       
              <tr style="background-color:#a9d08f">
                <td colspan="9" style="vertical-align: middle !important;text-align: center;font-size: 20px"><?php echo !empty($user_details['id_code'])?$user_details['id_code']:"-";?> - <?php echo strtoupper(user::displayName($value));?></td>
              </tr>
            </table>
                      ...
                      ?>
                       ...
                       <?php   
                        ...
                        <?php echo lang(strtolower(date('l', $time)))?>
                           ...
                           <?php echo'<td  align="center" style="color:red;text-align: center; vertical-align: middle !important;" colspan="8"> '.lang('week_off').'  </td>';
                        }?>
           ...
           <?php } else {?>
            <tr><td colspan="9" style="vertical-align: middle !important;text-align: center;"><?php echo lang('no_records_found')?></td>
