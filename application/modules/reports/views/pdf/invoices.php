...
?>
  ...
  <h5><span><?php echo lang('from'); ?></span>&nbsp;<?=$start_date?>&nbsp;<span><?php echo lang('to'); ?></span>&nbsp;<?=$end_date?></h5>
</div>
...
<thead>
  <tr>
<th><?=lang('status')?></th>
<th class="<?=($report_by == 'InvoiceDate') ? 'text-primary': ''; ?>"><?=lang('invoice_date')?></th>
<th class="<?=($report_by == 'InvoiceDueDate') ? 'text-primary': ''; ?>"><?=lang('due_date')?></th>
<th><?=lang('invoice')?>#</th>
<th><?=lang('client_name')?></th>
<th class="text-right"><?=lang('amount')?></th>
<th class="text-right"><?=lang('due_amount')?></th>
  </tr>
</thead>
