...
<div class="rep-container">
  ...
  <h3 class="reports-headerspacing"><b><?=lang('work_code_report')?></b></h3>
  <?php if($client != NULL){ ?>
  ...
  <table id="table-late_arrival_report" border="0"cellpadding="0" cellspacing="0" height="100%" width="1200px" class="inside-report">
    <thead>
      <tr class="attendance_record" style="background-color:#cbcbcb;">                
          <th align="left" valign="middle" style="font-weight:bold!important;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;font-size:16px;"><?=lang('work_code')?></th>
          <th align="left" valign="middle" style="font-weight:700;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;font-size:16px;"><?=lang('work_code_name')?></th>
          <th align="left" valign="middle" style="font-weight:900;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;font-size:16px;"><?=lang('amountof_uses')?></th>
    ...
    {                   
      if(isset($_POST['range']) && !empty($_POST['range'])){       
        ...
        $all_users = $this->db->select('ad.*')
          ...
          $record  = $this->db->get_where('dgt_attendance_details')->result_array();  */           
          if(!empty($record)){
    ...
    <tr class="<?php echo $sno;?>" style="background-color:<?php echo ($sno % 2 == 0)?'#fff':'#eee';?>;font-family:'Open Sans',arial,sans-serif!important;">
      ...
      <td align="left" valign="middle" style="font-weight:400;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;">
        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
          <tr>
            <td align="left" style="font-family:'Open Sans',arial,sans-serif!important;font-size:14px;">
              <?php $incident_name =  $this->db->get_where('incidents',array('id' => $value))->row_array();
            echo ucfirst($incident_name['incident_name']); ?>
            </td>
          </tr>
       ...
       <td align="left" valign="middle" style="font-weight:400;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;">
        <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
          <tr>
            <td align="left" style="font-family:'Open Sans',arial,sans-serif!important;font-size:14px;">
              <?php echo (isset($workcode_count[$value]))?count($workcode_count[$value]):0;?>
            </td>
          </tr>
