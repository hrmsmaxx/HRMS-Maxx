            ...
            <tbody>
             ...
             <?php
                ...
                foreach ($month_days_in_out[$a_day-1] as $punch_detail) 
                {
                 ...
                 echo !empty($punch_detail['punch_in'])?date("g:i a", strtotime($punch_detail['punch_in'])).' '.$punchin_workcode.' | ':$abs_incident; ?><?php echo !empty($punch_detail['punch_out'])?date("g:i a", strtotime($punch_detail['punch_out'])):''; ?> <?php echo $punchout_workcode;?>
               <?php }?>
                          </td>
                        </tr>
                      </table>  
                              ...
                              <td align="left" style="text-transform:capitalize;font-size:14px;color:#333;">
                                <?php
                                  ...
                                  foreach ($month_days_in_out[$a_day-1] as $punch_detail) 
                                  {
                                   ...
                                   echo !empty($punch_detail['punch_in'])?date("g:i a", strtotime($punch_detail['punch_in'])).' '.$punchin_workcode.' | ':$abs_incident; ?><?php echo !empty($punch_detail['punch_out'])?date("g:i a", strtotime($punch_detail['punch_out'])):''; ?> <?php echo $punchout_workcode;?> <br>
                                 <?php }?>
                              </td>
                            </tr>
                          </table>
...
<?php if(empty($_POST['total_record'])){ ?>
           ...
           <?php } else {?>
            <tr><td ><?php echo lang('no_records_found')?>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
