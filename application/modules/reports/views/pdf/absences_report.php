...
<div class="rep-container">
  ...
  <h3 class="reports-headerspacing"><b><?=lang('absences_report')?></b></h3>
  <?php if($client != NULL){ ?>
...
date_default_timezone_set('Asia/Kolkata');
  ...
  $punch_in_date_time = date('Y-m-d H:i');
   ...
   ?>
         ...
         <table id="table-absences_report" border="0"cellpadding="0" cellspacing="0" height="100%" width="1200px" class="inside-report">
            <thead>
              <tr class="attendance_record" style="background-color:#cbcbcb;">                
                  ...
                  <th align="left" valign="middle" style="font-weight:700;padding:10px 8px 10px 8px;border:2px solid #9c9c9c;font-size:16px;"><?=lang('abscences')?></th>
