...

{
...

    {
    	...
    	$res = $this->db->where('subdomain_id',$this->session->userdata('subdomain_id'))->get('dgt_projects')->result_array();
...

	{
		...
		$records = $this->db->select('*')
				 ...
				 ->where('TS.subdomain_id',$this->session->userdata('subdomain_id'))
...

	{
		...
		$this->db->join('dgt_users U','U.id = TS.user_id','left');

		$this->db->where('TS.subdomain_id',$subdomain_id);
...

	{
		...
		// 		 ->join('dgt_users U','U.id = TS.user_id','left')
