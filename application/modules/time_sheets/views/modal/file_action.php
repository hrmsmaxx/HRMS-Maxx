                ...
                <div id="file_container">
                    <div class="form-group">
                        <div class="col-lg-offset-3 col-lg-9">
                            ...
                            <input type="file" class="form-control" name="projectfiles[]" required="">
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        $('#clear-files').click(function(){
            $('#file_container').html(
                "<div class='form-group'>" +
                    "<div class='col-lg-offset-3 col-lg-9'>" +
                    "<label class='btn btn-default btn-choose'>Choose File</label><input type='file' class='form-control' name='projectfiles[]'>" +
                    "</div></div>"
            );
        });
