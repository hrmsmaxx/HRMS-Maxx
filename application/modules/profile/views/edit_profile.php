<div class="content">
	<div class="row">
		...
		<div class="col-sm-4 text-right m-b-20 col-xs-6">			
				...
				<div class="panel-body">
					...
					echo form_open(base_url().'auth/change_password'); ?>
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" name="new_password" id="profile_new_password" data-userid="<?php echo $this->session->userdata('user_id'); ?>" required>
						</div>
						<div class="form-group">
