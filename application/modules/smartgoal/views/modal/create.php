			...
			<div class="modal-body">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab-client-general">
						...
						<a class="btn btn-primary submit-btn" id="nextCreateGeneral"><?php echo lang('next');?></a>
						</div>
					...
					<div class="tab-pane fade in" id="tab-client-contact">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_general').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;" id="nextCreateContact" type="submit"><?php echo lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-web">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_contact').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;"  onclick="$('#tab_client_bank').trigger('click')"><?php echo lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-bank">
						...
						<div class="form-group">
							<label><?php echo lang('swift_bic');?></label>
							<input type="text" value="" name="bic" class="form-control">
						</div>
						<div class="form-group">
							<label><?php echo lang('sort_code');?></label>
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_web').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary submit-btn" style="float:right;" onclick="$('#tab_client_hosting').trigger('click')"><?php echo lang('next');?></a>
					...
					<div class="tab-pane fade in" id="tab-client-hosting">
						...
						<a class="btn btn-primary submit-btn" onclick="$('#tab_client_bank').trigger('click')"><?php echo lang('previous'); ?></a>
