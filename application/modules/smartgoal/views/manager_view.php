													...
													<td class="text-center">														
														<div class="dropdown">
															...
															<ul class="dropdown-menu pull-right">
																<li><a href="<?=base_url()?>smartgoal/smartgoal_status/<?php echo $smartgoal['id'];?>/1/<?php echo $smartgoal['user_id']; ?>">Approved</a></li>
																<li><a href="<?=base_url()?>smartgoal/smartgoal_status/<?php echo $smartgoal['id'];?>/2/<?php echo $smartgoal['user_id']; ?>">Rejected</a></li>
																<li><a href="<?=base_url()?>smartgoal/smartgoal_status/<?php echo $smartgoal['id'];?>/0/<?php echo $smartgoal['user_id']; ?>">Pending</a></li>
															</ul>
														</div>
