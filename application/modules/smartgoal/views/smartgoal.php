						 ...
						 ?>
										...
										<div class="form-group col-sm-6">
											...
											<div class="radio_input">
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($smartgoals['goal_duration'] == 1)?"checked":"";?> value="1"><?php echo lang('90_days'); ?><span class="checkmark"></span>
												</label>
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($smartgoals['goal_duration'] == 2)?"checked":"";?> value="2"><?php echo lang('6_month'); ?> <span class="checkmark"></span>
												</label>
												<label class="radio-inline custom_radio p-t-0">
													<input type="radio" name="goal_duration" <?php echo ($smartgoals['goal_duration'] == 3)?"checked":"";?> value="3"><?php echo lang('1_year'); ?> <span class="checkmark"></span>
												</label> 
											</div>
										</div>
								...
								<div class="performance-box">
									...
									<div class="table-responsive">
										<table class="table performance-table perform-align" style="table-layout:fixed;width:initial;">
											<thead>
												<tr>
													<th class="goalCount smt-goal-width" > <?php echo lang('goal'); ?><?php echo $count;?></th>
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <div class="m-t-30 text-right">
																	<button class="btn btn-primary" type="submit" id="create_okr_submit"><?php echo lang('update_goal'); ?></button>
																</div>
														<!-- /Goal Actions -->
													</td>
												</tr>
							...
							<?php $count++; } ?>
								...
								<div class="add-another-goal">
									<a href="javascript:void(0);" id="add_smart_another_goal" ><i class="fa fa-plus"></i> <?php echo lang('add_another_goal'); ?></a>
								...
								<div class="performance-box">
									<div class="table-responsive">
										<table class="table performance-table perform-align" style="table-layout: fixed;width:initial;">
											<thead>
												<tr>
													<th class="goalCount smt-goal-width"><?php echo lang('goal'); ?> <?php echo lang('1'); ?></th>
													<th class="text-center" style="min-width: 140px;width:140px;max-width:140px;"><?php echo lang('status'); ?></th>
													<th class="text-center smart-goal-start"><?php echo lang('start'); ?></th>
													<th class="text-center smart-goal-completed"><?php echo lang('completed'); ?></th>
													<th class="text-center smart-goal-rating"><?php echo lang('rating'); ?></th>
											...
											<tbody>
												...
												<tr>
                                                                ...
                                                                <ul class="task-list" id="tasklist">
                                                                    <li class="task">
                                                                        <div class="task-container">
                                                                            ...
                                                                            <input type="text" class="form-control" name="action[]" data-action="action_1"placeholder="<?php echo lang('goal_action'); ?><?php echo lang('1'); ?>">
                                                                             <input type="hidden" class="form-control result" name="result[]"  value="">

                                                                            <span class="task-action-btn task-btn-right">
                                                                                <span class="action-circle large delete-btn" title="<?php echo lang('delete_goal_action'); ?>">
                                                                                    <i class="material-icons">delete</i>
                                                                                </span>
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    <li class="task">
                                                                        <div class="task-container">
                                                                            <span class="task-action-btn task-check">
                                                                              ...
                                                                              <input type="text" class="form-control" name="action[]" data-action="action_1" placeholder="<?php echo lang('goal_action'); ?><?php echo lang('2'); ?>">
                                                                              <input type="hidden" class="form-control result" name="result[]"  value="">
                                                    ...
                                                    <div class="m-t-30 text-right">
																	<button class="btn btn-primary" type="submit" id="create_offers_submit"><?php echo lang('create_goal'); ?></button>
																</div>
														<!-- /Goal Actions -->
													</td>
												</tr>
