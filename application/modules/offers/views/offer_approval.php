                  ...
                  <tbody>
                    ...
                    <?php
                     ...
                     foreach ($candi_list as $ck => $cv) { 
                          ...
                          $s_label = 'Not Approved';$s_label2 = '<i class="fa fa-thumbs-o-up" aria-hidden="true"></i>'; $class='success'; $color='#b31109';
                          $clr_class='warning'; $title="Click to Approve";
                        if($cv->approver_status == 2) {$s_label = 'Approved'; $s_label2 = '<i class="fa fa-thumbs-o-down" aria-hidden="true"></i>'; $clr_class='success';
                    ...
                    <tr>
                      ...
                      <td ><label class="label label-<?php echo $clr_class;?>" style='display: inline-block;min-width: 90px;'><?=ucfirst($s_label)?></label></td>
                      <!-- <td> <a href="<?= base_url().''.$cv->file_path.'/'.$cv->filename ?>" target='_blank' download>Download</td> -->
                      <td title="<?php echo $title;?>"><button data-status='<?=$cv->approver_status?>' data-offerid ="<?=$cv->id?>" data-offid='<?=$cv->app_row_id?>' type="button" class="btn btn-<?=$class?> status_changebuttons"><?=$s_label2?></button></td>
