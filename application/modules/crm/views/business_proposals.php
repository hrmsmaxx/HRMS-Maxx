      ...
      //           $last_tasks = $this->db->get('tasks')->row_array(); ?>
			<div class="chat-main-row chat-main-row-business">
...
<!-- <div class="row">
						...
						<div class="col-xs-4 text-right">
							...
							<a href="#" class="btn btn-white pull-right m-r-10" data-toggle="modal" data-target="#add_task_board"><i class="fa fa-plus"></i> <?php echo lang('create_list')?></a>			
					...
					<div class="kanban-board card-box m-b-0 loader">
						...
						<div class="kanban-cont">
							<?php $task_board = $this->db->get_where('lead_board',array('subdomain_id'=>$this->session->userdata('subdomain_id')))->result_array(); 
								...
								<div class="kanban-header" >
									...
									<div class="dropdown kanban-action">
										...
										<ul class="dropdown-menu pull-right">
											<li><a href="#" data-toggle="modal" data-target="#edit_task_board<?php echo $board['task_board_id'];?>"><?php echo lang('edit')?></a></li>
											<li><a data-toggle="ajaxModal" href="<?=base_url()?>crm/lead_board_delete/<?php echo $board['task_board_id']; ?>"><?php echo lang('delete')?></a></li>
										</ul>
									</div>
								</div>
									...
									<?php
								        ...
								        $this->db->where('b.subdomain_id',$this->session->userdata('subdomain_id'));
											...
											<div class="task-board-header">
												...
												<!-- <div class="dropdown kanban-task-action">
													...
													<!-- <ul class="dropdown-menu pull-right"> -->
														...
														<!-- <li><a data-toggle="ajaxModal" href="<?=base_url()?>crm/task_kanban_delete/<?php echo $leads['user_id']; ?>">Delete</a></li>
													</ul> -->
												<!-- </div> -->
											</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><?=lang('add_task_board'); ?></h4>
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
						<div class="modal-body">
							<form>
								<div class="form-group">
									<label><?=lang('task_board_name'); ?> <span id="already_task_board_name" style="display: none;color:red;"><?=lang('already_registered_task_board_name'); ?></span></label>
								...
								<div class="form-group task-board-color">
									<label><?=lang('task_board_color'); ?></label>
								...
								<div class="m-t-20 text-center">
									<button type="button" class="btn btn-primary btn-lg" id="task_board_save" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing "><?=lang('save'); ?></button> 
								</div>
							</form>
						</div>
					</div>
			...
			<div id="edit_task_board<?php echo $board['task_board_id']?>" class="modal custom-modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><?=lang('edit'); ?> <?php echo ucfirst($board['task_board_name']);?> <?=lang('board'); ?></h4>
							<button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
						<div class="modal-body">
							<form>
								<div class="form-group">
									<label><?=lang('task_board_name'); ?></label>
								...
								<div class="m-t-20 text-center">
									<button type="button" class="btn btn-primary btn-lg" id="task_board_edit" data-id="<?php echo $board['task_board_id'];?>" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing "><?=lang('save'); ?></button> 
								</div>
							</form>
						</div>
					</div>
