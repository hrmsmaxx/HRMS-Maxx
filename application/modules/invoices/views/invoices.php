<div class="content">
	<div class="row">
		...
		<div class="col-sm-8 col-xs-9 text-right m-b-0">
			...
			<a href="<?=base_url()?>invoices/add" class="btn btn-primary rounded m-b-10 pull-right"><i class="fa fa-plus"></i> <?=lang('create_invoice')?></a>
			<?php } ?>
			<div class="btn-group pull-right m-r-10 m-b-10">
				<button class="btn btn-default">
				  ...
				  ?></button>
				 <button class="btn btn-default m-b-10 dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
