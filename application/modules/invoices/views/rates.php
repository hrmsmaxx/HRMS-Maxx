<div class="content">
	<div class="row">
		...
		<div class="col-xs-7 text-right m-b-0">
			<a href="<?=base_url()?>invoices/tax_rates/add" data-toggle="ajaxModal" class="btn btn-primary m-b-10 btn-rounded pull-right"><i class="fa fa-plus"></i> <?=lang('new_tax_rate')?></a>
		</div>
	</div>
