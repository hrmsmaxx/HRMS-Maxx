...
<section class="content">
        ...
        <input type="text" class="form-control" value="<?=Applib::format_deci(Invoice::get_invoice_due_amount($id));?>" name="amount">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="datepicker-input form-control" size="16" type="text" value="<?=strftime(config_item('date_format'), time());?>" name="payment_date" data-date-format="<?=config_item('date_picker_format');?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="payment_method" class="form-control" required>
                                            <option value=""><?php echo lang('please_select_an_option'); ?></option>
                                            <?php
