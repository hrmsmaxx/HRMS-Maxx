<div class="content container-fluid">
	<div class="row">
		<div class="col-sm-12">
			<h4 class="page-title"><?=lang('budget_expenses')?></h4>
		</div>
	</div>
                  ...
                  <div class="row">
                     <div class="col-sm-6 col-md-3 col-xs-6">  
                      <div class="form-group form-focus select-focus" style="width:100%;">
                        ...
                        <select class="select floating form-control" name="cat_id"  id="cat_id" style="padding: 14px 9px 0px;"> 
                            ...
                            <option value="" selected="selected"><?=lang('all_category')?></option>
                        ...
                        <label id="employee_id_error" class="error display-none" for="employee_id"><?=lang('please_select_an_option')?></label>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 col-xs-6">
                      <div class="form-group form-focus">
                        <label class="control-label"><?=lang('date_from')?></label>
                        <div class="cal-icon">
                          ...
                          <label id="timesheet_date_from_error" class="error display-none" for="expenses_date_from"><?=lang('from_date_not_empty')?></label>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-xs-6">
                      <div class="form-group form-focus">
                        <label class="control-label"><?=lang('date_to')?></label>
                        <div class="cal-icon">
                          ...
                          <label id="timesheet_date_to_error" class="error display-none" for="expenses_date_to"><?=lang('to_date_not_empty')?></label>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-xs-6">  
                    <div class="form-group">
                        <button id="budget-revenuet_search_btn" class="btn btn-success form-control" > <?=lang('search')?> </button>  <!-- 
              ...
              <div class="table-responsive">
                <table class="table table-striped custom-table datatable" id="table-budget-revenue">
                  <thead>
                    <tr>
                      <th><?=lang('s_no')?></th>
                      <th><?=lang('project_notes')?></th>                    
                      <th><?=lang('cat_name')?></th>
                      <th><?=lang('sub_category_name')?></th>
                      
                     <!-- <th>Total Revenue</th>
                      <th>Tax Amount</th> -->
                      <th><?=lang('amount')?></th>
                      <th><?=lang('revenue_date')?></th>
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                              <li><a href="<?php echo base_url(); ?>budget_revenues/edit/<?php echo $budget['id']; ?>" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> <?=lang('edit')?></a></li>
                              <li><a href="#" data-toggle="modal" data-target="#delete_budget<?php echo $budget['id']; ?>"><i class="fa fa-trash-o m-r-5"></i> <?=lang('delete')?></a></li>
                            </ul>
                          </div>
                        </td> 
                      </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content modal-md">
                          <div class="modal-header">
                            <h4 class="modal-title"><?=lang('delete_revenues')?>( <?php echo $budget['notes']; ?> )</h4>
                          </div>
