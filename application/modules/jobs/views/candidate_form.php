...
<div class="row">
			...
			<ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
						        ...
						        <li><a href="<?php echo base_url(); ?>jobs/candidates"><?php echo lang('candidate_list');?></a></li>
						        <li class="active"><?php echo lang('add_candidates');?></li>
			</ul>
		</div>
                        	...
                        	foreach($designations as $des){
                        		?><option value="<?php echo $des['id'];?>" <?php if(in_array($des['id'],$position_array)){ echo "selected";}?>><?php echo $des['designation'];?></option><?php 
										...
										<div class="form-group">
													...
													<?php if(isset($candidate_detail['file_name']) &&  $candidate_detail['file_name'] !='' ){?>
