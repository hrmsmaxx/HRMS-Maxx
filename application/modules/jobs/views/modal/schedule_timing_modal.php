		...
		<?php 
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" name="schedule_date[0]" class="form-control datetimepicker" id="schedule_date1" value="<?php if(isset($schedule_dates[0])) {echo date('m/d/Y',strtotime($schedule_dates[0]));} ?>" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="schedule_date[1]" class="form-control datetimepicker" id="schedule_date2" value="<?php if(isset($schedule_dates[1])) {echo date('m/d/Y',strtotime($schedule_dates[1]));} ?>" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" name="schedule_date[2]" class="form-control datetimepicker" id="schedule_date3" value="<?php if(isset($schedule_dates[2])) {echo date('m/d/Y',strtotime($schedule_dates[2]));} ?>" required>
				</div>
