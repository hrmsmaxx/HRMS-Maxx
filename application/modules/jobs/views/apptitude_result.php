	...
	<div class="card-box">
		<div class="row">
			<div class="col-sm-5 col-5">
				<h4 class="page-title"><?php echo lang('apptitude_results');?></h4>
			</div>
			...
			<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
				...
				<tbody>
					...
					foreach($completed_users as $users){
						...
						<tr>
						<td><?php echo $i++; ?></td>
						<td><a href="<?php echo '#';?>"><?php echo $users->first_name.' '.$users->last_name;?></a></td>
						...
						?></td>
						<td><?php if(isset($total_marks[$users->user_id])) { echo array_sum($total_marks[$users->user_id]);}else{ echo 0;}?></td>
						...
						<td class="text-center">
							...
							<div class="dropdown action-label">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/1/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-info"></i> <?php echo lang("resume_shortlisted"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/2/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-danger"></i>  <?php echo lang("resume_rejected"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/3/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-success"></i>  <?php echo lang("apptitude_selected"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/4/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-danger"></i>  <?php echo lang("apptitude_rejected"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/5/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-success"></i>  <?php echo lang("video_call_selected"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/6/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-danger"></i>  <?php echo lang("video_call_rejected"); ?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/7/'.$users->user_id.'/'.$users->job_id.'/apptitude_result');?>"><i class="fa fa-dot-circle-o text-success"></i>  <?php echo lang("offered"); ?></a></li>
								</ul> 
							</div>
						</td>
