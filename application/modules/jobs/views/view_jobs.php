	...
	<div class="row">
		<div class="col-xs-8">
			...
			<ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
						        ...
						        <li class="active"><a href="<?php echo base_url(); ?>jobs/manage"><?php echo lang('manage_jobs');?></a></li>
						        <li><?php echo lang('view_jobs');?></li>
			</ul>
	...
	<div class="row">
		<div class="col-md-8">
			<div class="job-info job-widget">
				...
				<h3 class="job-title"><?php echo $jobs_detail['job_title']; ?></h3>
