	...
	<div class="row">
		<div class="col-xs-12">
			...
			<ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
						        ...
						        <li><?php echo lang('recruiting_dashboard');?></li>
			</ul>
		</div>
	</div>
...
<a href="<?php echo base_url(); ?>jobs/view_jobs/<?php echo $latest['id'];?>" class="list-group-item"><?php echo $latest['job_title'];?><span class="pull-right" style="font-size:12px; color: #a1a1a1;"><?php if($latest['days']>0){ echo $latest['days'].' days ago';}else{ echo $latest['hour'].' hours ago';}?></span></a>
<?php
					} ?>
