<?php
	...
	?>
			...
			<ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
						        ...
						        <li><a href="<?php echo base_url(); ?>interview_questions"><?php echo lang('interview_questions');?></a></li>
						        <li class="active"><?php echo lang('add_questions');?></li>
			</ul>
		</div>
						 <div class="col-sm-4  text-right m-b-20">     
				              <a class="btn back-btn" href="<?=base_url()?>interview_questions"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
				          </div>
					</div>					
	<div class="row">
	...
	<div class="panel">
		<div class="panel-heading">
			<h6 class="panel-title"><?php echo lang('add_questions');?></h6>
		</div>
