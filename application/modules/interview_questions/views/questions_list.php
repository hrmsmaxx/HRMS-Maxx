...
<!--<div class="main-wrapper">-->
	...
	<div class="page-wrapper job-wrapper" style="padding-top:0;">
		<div class="content">
			<div class="row">
				<div class="col-xs-8">
				...
				<li><?php echo lang('interview_questions');?></li>
			</ul>
				</div>
				 <div class="col-sm-4 col-xs-4 text-right m-b-20">     
				              <a class="btn back-btn" href="<?=base_url()?>jobs"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
				          </div>
			</div>
			...
			<div class="card-box">
				<div class="row">
					<div class="col-sm-5 col-5">
						<h4 class="page-title"><?php echo lang('category_list');?></h4>
					</div>
					<div class="col-sm-7 col-7 text-right m-b-30">
					
						<a href="<?php echo base_url().'/interview_questions/category';?>" data-toggle="ajaxModal" class="btn add-btn m-r-5"> <?php echo lang('add_category');?></a>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							...
							<table id="table-templates-1" class="table table-striped custom-table m-b-0 AppendDataTables">
								...
								<tbody>
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><a href="<?php echo base_url(); ?>interview_questions/category/<?php echo $category->id; ?>" class="dropdown-item" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> <?php echo lang('edit');?></a></li>
										<li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#delete_category" onclick="delete_category(<?php echo $category->id;?>)"><i class="fa fa-trash-o m-r-5"></i> <?php echo lang('delete');?></a></li>
									</ul>
									</div>
									</td>
									</tr>
			...
			<div class="card-box">
				<div class="row">
					...
					<div class="col-sm-7 col-7 text-right m-b-30">
						<a href="<?php echo base_url(); ?>interview_questions/add_questions" class="btn add-btn"> <?php echo lang('add_questions');?></a>
					...
					<div class="col-lg-12">
						<div class="table-responsive">
							...
							<div class="dropdown action-label">
								...
								<ul class="dropdown-menu dropdown-menu-right">
									<li><a class="dropdown-item" href="<?php echo site_url('interview_questions/question_status/1').'/'.$list->id;?>"><i class="fa fa-dot-circle-o text-info"></i> <?php echo lang('active');?></a></li>
									<li><a class="dropdown-item" href="<?php echo site_url('interview_questions/question_status/0').'/'.$list->id;?>"><i class="fa fa-dot-circle-o text-success"></i> <?php echo lang('inactive')?></a></li>
								</ul>
							</div>
						</td>
										<td class="text-center">
											<div class="dropdown dropdown-action">
												<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url(); ?>interview_questions/edit_questions/<?php echo $list->id ?>" class="dropdown-item"><i class="fa fa-pencil m-r-5"></i> <?php echo lang('edit');?></a></li>
													<li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#delete_question" onclick="delete_question(<?php echo $list->id;?>)"><i class="fa fa-trash-o m-r-5"></i> <?php echo lang('delete');?></a></li>
												</ul>
											</div>
										</td>
									</tr>
