...
?> -->
			...
			<ul class="breadcrumb m-b-30 p-l-0" style="background:none; border:none;">
						        ...
						        <li><a href="<?php echo base_url(); ?>jobs/manage"><?php echo lang('manage_questions');?></a></li>
						        <li class="active"><?php echo lang('edit_question');?></li>
			</ul>
		</div>
	...
	<div class="panel">
		<div class="panel-heading">
			<h6 class="panel-title"><?php echo lang('edit_questions');?></h6>
		</div>
