<div class="content">
	<div class="row">
		<div class="col-xs-4">
			<h4 class="page-title"><?=lang('collaboration')?></h4>
		</div>
	</div>
<div class="card-box">
		<ul class="nav nav-tabs nav-tabs-solid page-tabs">
			<li class="active"><a href="<?php echo base_url(); ?>chats"><?=lang('chat_call')?></a></li>
			<li><a href="<?php echo base_url(); ?>messages"><?=lang('email')?></a></li>
		</ul>
	</div>
...
<div class="chat-main-row video-blk-right chat-call-placeholder chat-main-row-extra">
<div class="msg-inner">
            ...
            <div class="navbar">
                ...
                <ul class="nav navbar-nav pull-right chat-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="javascript:void(0)"><?=lang('delete_conversations')?></a></li>
                        </ul>
                    </li>
                </ul>
				<!--<div id="profile-info-collapse">
                ...
                <div class="message-search pull-right">
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" placeholder="<?=lang('search')?>" required="">
            ...
            <div class="message-bar">
                <div class="message-inner">
                    ...
                    <div class="message-area"><div class="input-group">
							<input type="" class="form-control" id="msgTxt" name="msgTxt" placeholder="<?=lang('type_msg')?>">
...
<div class="call-users user-list">
            ...
            <div id="add_chat_user" class="modal custom-modal fade center-modal" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"><?php echo lang('direct_chat');?></h3>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <div class="input-group m-b-30 direct_chat_select2">
                                    <!-- <input placeholder="<?php echo lang('search_to_start_a_chat');?>" class="form-control search-input input-lg" name="search_user" id="search_user" type="text"> -->
                                    <select class="select2-option form-control search-input input-lg" style="width:100%;" name="search_user" id="search_user" > 
										<!-- <optgroup label="<?=lang('search_to_start_a_chat')?>">  -->
											<option value="" ><?=lang('search_to_start_a_chat'); ?></option>
										<?php foreach (User::employee() as $key => $user) { 
												
											?>
										<option value="<?php echo User::displayName($user->id);?>"><?=ucfirst(User::displayName($user->id))?></option>
										<?php  } ?>	
										</optgroup> 
									</select>
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary btn-lg" onclick="search_user()"><?php echo lang('search');?></button>
                                    </span>
                                </div>
                                <div>
                                    <h5><?php echo lang('conversations_with');?></h5>
