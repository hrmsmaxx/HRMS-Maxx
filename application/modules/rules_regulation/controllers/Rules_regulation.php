...
class Rules_regulation extends MX_Controller {
    ...
    function __construct()
    {
        ...
        $this->company_name = $theme_settings['website_name']?$theme_settings['website_name']:$this->config->item('company_name');
    }
    ...
    function index()
    {
				...
				$this->template->title('Rules & Regulation - '.$this->company_name); 
