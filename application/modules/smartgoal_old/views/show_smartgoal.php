...
<div class="content container-fluid">
   <div class="row">
      ...
      <div class="col-sm-4 text-right m-b-20">        
            <a class="btn back-btn" href="<?=base_url()?>smartgoal/"><i class="fa fa-chevron-left"></i> Back</a>
      </div>
   </div>
   <div class="row">
      <div class="col-md-12">
            ...
            <div class="form-group">
               <div class="join-year">
                  ...
                  <select class="select form-control" name="goal_year">
                     <?php $year = date('Y'); for ($i=$year; $i<=$year+6; $i++) { ?>
                     ...
                     <table class="table performance-table">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="text-center">
                                 <button type="button" class="btn <?php echo !empty($feedback[$key])?'btn-success':'btn-white'?> obj_feedback" onclick="goal_feedback(<?php echo $key?>)" data-id="<?php echo $key ?>"><i class="fa fa-commenting"></i></button>
                              </td>
                           </tr>
                        </tbody>
                        <tbody>
