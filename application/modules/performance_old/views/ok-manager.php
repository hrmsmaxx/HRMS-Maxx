...
?>
                ...
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title m-b-5"><?php lang('performance_configuration'); ?></h4>
							<ol class="breadcrumb page-breadcrumb">
								<li><a href="#"><?php lang('offer_accepted'); ?></a></li>
								<li><a href="#"><?php lang('forms'); ?></a></li>
								<li class="active"><?php lang('your_goal'); ?></li>
							</ol>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-sm-8">
									<div class="join-year">
										<span><?php lang('year'); ?></span>
										<select class="select form-control" name="goal_year">
											
											<option value="2019" <?php if($okrdetails['goal_year'] == "2019") echo selected;?>><?php lang('2019'); ?></option>
											<option value="2020" <?php if($okrdetails['goal_year'] == "2020") echo selected;?>><?php lang('2020'); ?></option>
											<option value="2021" <?php if($okrdetails['goal_year'] == "2021") echo selected;?>><?php lang('2021'); ?></option>
											<option value="2022" <?php if($okrdetails['goal_year'] == "2022") echo selected;?>><?php lang('2022'); ?></option>
											<option value="2023" <?php if($okrdetails['goal_year'] == "2023") echo selected;?>><?php lang('2023'); ?></option>
											<option value="2024" <?php if($okrdetails['goal_year'] == "2024") echo selected;?>><?php lang('2024'); ?></option>
							...
							<div class="form-group">
								<label>"><?php lang('goal_duration'); ?></label>
								<div class="radio_input">
									<label class="radio-inline custom_radio">
										
									<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='90 days')? 'checked':'' ?> value="90 days">"><?php lang('90_days'); ?><span class="checkmark"  ></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration"  <?php echo ($okrdetails['goal_duration'] =='6 month')? 'checked':'' ?>  value="6 month">"><?php lang('6_month'); ?><span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='1 year')? 'checked':'' ?> value="1 year">"><?php lang('1_year'); ?><span class="checkmark" ></span>
									</label> 
								</div>
							</div>
									...
									<div class="table-responsive">
										...
										<table class="table performance-table">
											<thead>
												<tr>
													<th></th>
													<th class="text-center"><?php lang('status'); ?></th>
													<th class="text-center"><?php lang('progress'); ?></th>
													<th class="text-center"><?php lang('grading'); ?></th>
													<th class="text-center" style="width: 85px;"><?php lang('feedback'); ?></th>
												</tr>
											</thead>
											...
											<tbody>
												...
												<td>
													<div class="label-input">
														<label><?php lang('objective_1'); ?></label>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<option value="Approved" <?php if($obj->okr_status == "Approved") echo selected;?>><?php lang('approved'); ?></option>
																<option value="Pending" <?php if($obj->okr_status == "Pending") echo selected;?>><?php lang('pending'); ?></option>
															</select>
														</div>
													</td>
													<td class="text-center">
								...
								foreach ($okr_results as $okr_result) {
												...
												<tr>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<select class="form-control" name="key_status[<?php echo $i?>][]">
																<option value="Approved" <?php if($okr_result['key_status'] == "Approved") echo selected;?>><?php lang('approved'); ?></option>
																<option value="Pending" <?php if($okr_result['key_status'] == "Pending") echo selected;?>><?php lang('pending'); ?></option>
																<option value="Pending" <?php if($okr_result['key_status'] == "Rejected") echo selected;?>><?php lang('rejected'); ?></option>
													...
													<td class="text-center">
														...
														<?php } } } else { ?>
																<option value=""><?php lang('ratings_not_found'); ?></option>
														<?php } ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><?php lang('write_feedback'); ?></h4>
					</div>
					<div class="modal-body">
						<form>
							<div class="form-group">
								<label><?php lang('feedback'); ?></label>
								<?php 
		...
		<div id="add_opj_feedback" class="modal center-modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><?php lang('feedback'); ?></h4>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label><?php lang('write_feedback'); ?></label>							
						</div>
