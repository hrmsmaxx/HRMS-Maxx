                ...
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-sm-4">
									<table class="table table-border user-info-table m-b-0">
										<tbody>
											<tr>
													...
													<td class="text-center">
														<div class="dropdown">
															...
															<select class="form-control okr_result_status" name="key_status[<?php echo $i?>][]" data-id="<?php echo $okr_result['id'];?>" data-userid="<?php echo $okrdetails['user_id'];?>">
																...
																<option value="Pending" <?php if($okr_result['key_status'] == "Rejected") echo selected;?>><?php echo lang('rejected'); ?></option>
