...
//echo 'okr<pre>'; print_r($okrdetails); exit;
?>
          
                <div class="content container-fluid">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title m-b-5"><?php echo lang('OKR_performance');?></h4>
						...
						<!-- <div class="col-sm-4  text-right m-b-20">     
			              <a class="btn back-btn" href="<?=base_url()?>performance"><i class="fa fa-chevron-left"></i> <?php echo lang('back');?></a>
			          </div> -->
					</div>
					<div class="row">
						<div class="col-md-12">
								...
								<div class="form-group">									
									<div class="join-year">
										...
										<select class="select form-control" name="goal_year">
											<option value="2019" <?php if($okrdetails['goal_year'] == "2019") echo 'selected';?>><?php echo lang('2019'); ?></option>
							...
							<div class="form-group">
								...
								<div class="radio_input">
									...
									<label class="radio-inline custom_radio">
										...
										<input type="radio" name="goal_duration"  <?php echo ($okrdetails['goal_duration'] =='6 month')? 'checked':'' ?> value="6 month"><?php echo lang('6');?> <?php echo lang('month');?> month2<span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										...
										<table class="table performance-table">
											<thead>
												<tr>
													...
													<th class="text-center"><?php echo lang('progress');?></th>
													<th class="text-center"><?php echo lang('grading');?></th>
													<th class="text-center"><?php echo lang('feedback');?></th>
													4[-   ]
												</tr>
											</thead>
											<tbody>
							...
							<div class="form-group">
								...
								<div class="radio_input">
									...
									<label class="radio-inline custom_radio">
										<input type="radio" name="goal_duration" value="6 month"><?php echo lang('6');?> Month1
										<?php echo lang('month');?>  <span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
							...
							<div class="performance-wrap">
									...
									<div class="table-responsive">
										<table class="table performance-table">
											...
											<tbody>
												...
												<td>
													<div class="label-input">
														<label class="goalCount"><?php echo lang('objective'); ?></label>
														<input type="text" class="form-control" name="objective[]">
													</div>
													</td>
													<td class="text-center">
													 <span class="badge btn-info" name="status"><?php echo lang('pending'); ?></span>
											...
											<tbody class="key_result_container">
												<tr>
													<td>
														<div class="label-input">
															<label><?php echo lang('key_result'); ?></label>
													...
													<td class="text-center">
														<span class="badge btn-info"><?php echo lang('pending'); ?></span>
								...
								<div>
								<input type="submit" value="<?php echo lang('submit'); ?>" class="btn btn-primary submit-btn" style="display:block;margin:auto;margin-top:15px">
								</div>
							<?php } ?>
		...
		<div id="progress_bar" class="modal center-modal fade" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title"><?php echo lang('objective_progress'); ?></h4>
					</div>
					<div class="modal-body">
