							...
							<div class="form-group">
								...
								<div class="radio_input">
									...
									<label class="radio-inline custom_radio">
										...
										<input type="radio" name="goal_duration"  <?php echo ($okrdetails['goal_duration'] =='6 month')? 'checked':'' ?>  value="6 month"><?php echo lang('goal_duration');?><?php echo lang('6');?> <?php echo lang('month');?><span class="checkmark"></span>
									</label>
									<label class="radio-inline custom_radio">
										
										<input type="radio" name="goal_duration" <?php echo ($okrdetails['goal_duration'] =='1 year')? 'checked':'' ?> value="1 year"><?php echo lang('goal_duration');?><?php echo lang('1');?> <?php echo lang('year');?><span class="checkmark" ></span>
									</label> 
								</div>
							</div>
