										...
										<ul class="nav navbar-nav pull-right chat-menu">
											<li class="dropdown">
												...
												<ul class="dropdown-menu">
													<li><a href="javascript:void(0)"><?php echo lang('pending_tasks');?></a></li>
													<li><a href="javascript:void(0)"><?php echo lang('completed_tasks');?></a></li>
													<li><a href="javascript:void(0)"><?php echo lang('all_tasks');?></a></li>
												</ul>
											</li>
										</ul>
													...
													<div class="task-list-container">
														<div class="task-list-body">
															<ul id="task-list">
																	...
																	<li class="task <?php echo $cls; ?>">
																		<div class="task-container">
																			<span class="task-action-btn task-check">
																				<span class="action-circle large complete-btn <?php echo $btn_actions;?>"  data-id="<?php echo $tasks['t_id']; ?>" title="<?=lang('mark_complete');?>">
																		...
																		<span class="task-action-btn task-btn-right">
																			...
																			<span class="action-circle large" data-toggle="modal" onclick="delete_task(<?php echo $tasks['t_id'];?>)"  title="<?=lang('delete_task');?>">
																...
																<?php } }else{ ?>
																	<li class="task">
																		<div class="task-container">
																			<span class="task-label" contenteditable="true"><h5><?=lang('no_task_found');?></h5></span>
																		</div>
																	</li>
																<?php } ?>
															</ul>
														...
														<div class="task-list-footer">
															<div class="new-task-wrapper" style="display: none;">
																<input type="hidden" id="project_id" value="<?php echo $project_id['project_id']; ?>" placeholder="<?=lang('enter_new_task');?>">
																<textarea id="new_task" placeholder="<?=lang('enter_new_task');?>"></textarea>
						...
						<?php } 
                         ...
                         if($types=='task')
                         {
                         	 ...
                         	 if($task_det['task_progress'] == 100)
								{
									$tasl_cls = '<i class="material-icons">check</i>'.lang('completed');
									$btn_task='task-completed';
									$btn_action='task_uncompletes';
									
								}else{
									$tasl_cls = '<i class="material-icons">check</i>'.lang('mark_complete');
									$btn_task='';
							...
							<div class="chat-window">
								<div class="chat-header">
									<div class="navbar">
										...
										<div class="task-assign">
											<span class="assign-title"><?=lang('project_lead'); ?> </span> 
											<?php $team_lead = $this->db->select('*')
											         ->from('projects P')
											         ->join('account_details AD','P.assign_lead = AD.user_id')
											         ->where('P.assign_lead',$project_id['project_id'])
											...
											<div class="chat-box">
												<div class="chats">
													...
													<div class="task-textarea">
															<textarea placeholder="<?=lang('task_name'); ?>" id="task_name" onkeyup="task_name(<?php echo $tasks_id;?>)" class="form-control"><?php echo $task_det['task_name']; ?></textarea>
														</div>
													<?php $team_members = $this->db->select('*')
											         ->from('assign_tasks PA')
											         ->join('account_details AD','PA.assigned_user = AD.user_id')
														...
														<div class="assignee-info">
																...
																<?php if(!empty($assignrd_name))
																{
																	...
																	<div class="assigned-info">
																		<div class="task-head-title">'.lang('assigned_to').'</div>
																...
																else 
																{
																	echo'<a data-toggle="ajaxModal" href="'.base_url().'all_tasks/assign_user/'.$project_id['project_id'].'/'.$tasks_id.'/Assign">
																		...
																		<div class="assigned-info">
																			<div class="task-head-title">'.lang('unassigned').'</div>
														...
														<div class="task-due-date">
																...
																<?php if(!empty($task_det['due_date']))
																{
																	echo'<div class="due-icon">
																		...
																		<div class="due-info">
																			<div class="task-head-title">'.lang('due_date').'</div>
													...
													<div class="task-desc">
														<div class="task-desc-icon">
															<i class="material-icons"><?=lang('subject');?></i>
														</div>
														<div class="task-textarea">
															<textarea placeholder="<?=lang('description');?>" id="task_description" onkeyup="task_description(<?php echo $tasks_id;?>)" class="form-control"><?php echo $task_det['description'];?></textarea>
														</div>
													</div>
									...
									<div class="message-bar">
										<form method="post" id="post_comments" enctype="multipart/form-data" action="<?php echo base_url();?>all_tasks/post_task_comments" class="message-inner">
											...
											<div class="message-area"><div class="input-group">
												...
												<textarea class="form-control" id="comments" name="description" placeholder="<?=lang('description');?>"></textarea>
												<span class="input-group-btn">
													<button class="btn btn-custom" type="submit"><i class="fa fa-send"></i></button>
												</span>
												</div>
