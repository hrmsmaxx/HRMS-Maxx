										...
										<ul class="nav navbar-nav pull-right chat-menu">
											<li class="dropdown">
												...
												<ul class="dropdown-menu">
													<li><a href="<?php echo base_url();?>all_tasks/view/<?php echo $project_id['project_id'];?>/pending">Pending Tasks</a></li>
													<li><a href="<?php echo base_url();?>all_tasks/view/<?php echo $project_id['project_id'];?>/completed">Completed Tasks</a></li>
													<li><a href="<?php echo base_url();?>all_tasks/view/<?php echo $project_id['project_id'];?>">All Tasks</a></li>
												</ul>
											</li>
										</ul>
												...
												<div class="task-wrapper">
													<div class="task-list-container">
														<div class="task-list-body">
															...
															<!-- $all_tasks = $this->db->get_where('tasks',array('project'=>$project_id['project_id']))->result_array();  -->
											...
											<div class="chat-box">
												<div class="chats">
													...
													<div class="task-textarea">
															<textarea placeholder="Task Name" id="task_name" onkeyup="task_name(<?php echo $tasks_id;?>)" class="form-control"><?php echo $task_det['task_name']; ?></textarea>
														</div>
													<?php $team_members = $this->db->select('*')
											         ->from('assign_tasks PA')
											         ->join('account_details AD','PA.assigned_user = AD.user_id')
