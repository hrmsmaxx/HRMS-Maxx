	<div class="content">
		<div class="row">
			<div class="col-sm-8 col-xs-6">
				<h4 class="page-title m-b-10"><?php echo lang('work_management');?></h4>
			</div>
			<div class="col-sm-4 col-xs-6 text-right m-b-10">			
		...
		<?php $this->load->view('sub_menus');?>
			<div class="row">
				<div class="col-sm-12">
					<h4 class="page-title m-b-0"><?php echo lang('tasks');?></h4>
				</div>
			</div>
																	...
																	<li class="task <?php echo $cls; ?>">
																		<div class="task-container">
																			<span class="task-action-btn task-check">
																				<span class="action-circle large complete-btn <?php echo $btn_actions;?>"  data-id="<?php echo $tasks['t_id']; ?>" title="<?php echo lang('mark_complete'); ?>">
