...

{
...

    {
        ...
        $this->template->title(lang('work_management').' - '.$this->company_name);

        $data['page'] = lang('projects');

        $data['sub_page'] = lang('all_tasks');
...

        {
            ...
            $data['all_projects'] = $this->db->get_where('projects',array('status'=>'Active','subdomain_id'=>$this->session->userdata('subdomain_id')))->result_array();
            ...
            // echo "<pre>";print_r($data['project_id']);die;
...

    {
        ...
        $this->template->title(lang('all_tasks').' - '.$this->company_name);
...

    {
        ...
        $form_data['subdomain_id'] = $this->session->userdata('subdomain_id');
