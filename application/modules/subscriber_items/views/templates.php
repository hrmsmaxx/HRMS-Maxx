		...
		<div class="tab-pane " id="task_templates">
				...
				<div class="row">
					...
					<div class="col-sm-8 text-right m-b-30">
						...
						<a href="<?=base_url()?>subscriber_items/save_task" class="btn btn-success pull-right m-r-10" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('add_task')?></a>
		...
		<div class="tab-pane active" id="invoice_templates">
				...
				<div class="row">
					...
					<div class="col-sm-8 text-right m-b-30">
						...
						<a href="<?=base_url()?>subscriber_items/add_item" class="btn btn-success pull-right m-r-10" data-toggle="ajaxModal"><i class="fa fa-plus"></i> <?=lang('new_item')?></a>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-right">
									...
									<a href="<?=base_url()?>subscriber_items/edit_item/<?=$item->item_id?>" class="btn btn-success btn-xs" data-toggle="ajaxModal">

										<i class="fa fa-edit"></i>

									</a>

									<a href="<?=base_url()?>subscriber_items/delete_item/<?=$item->item_id?>" class="btn btn-danger btn-xs" data-toggle="ajaxModal">
