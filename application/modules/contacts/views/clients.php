<section id="content">
          <section class="hbox stretch">
			...
			foreach ($users as $key => $user) { ?>
									...
									<img src="<?=base_url()?>assets/avatar/<?=$user->avatar?>" class="img-circle"></a>
									</td>
          ...
          echo form_open(base_url().'auth/register_user'); ?>
           ...
           <input type="hidden" name="r_url" value="<?=base_url()?>contacts">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" placeholder="<?=lang('eg')?> Envato Inc." value="<?=set_value('company')?>" name="company" class="input-sm form-control">
                  </div>
                  <div class="form-group">
