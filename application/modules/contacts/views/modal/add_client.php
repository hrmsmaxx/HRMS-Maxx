<?php
	$roles = $this->db->where(array('role'=>'client','subdomain_id'=>$this->session->userdata('subdomain_id')))->get('roles')->row_array();
?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('add_contact')?></h4>
			 ...
			 $attributes = array('class' => 'bs-example form-horizontal','id' => 'addContactForm');
		...
		<div class="modal-body">
			 ...
			 <input type="hidden" name="role" value="<?=$roles['r_id']?>">
			 <input type="hidden" name="user_type" value="<?=$roles['r_id']?>">
			 ...
			 <div class="form-group">
				...
				<div class="col-lg-8">
					<input type="text" class="form-control" value="<?=set_value('fullname')?>" placeholder="E.g John Doe" name="fullname">
				</div>
				</div>
          		<div class="form-group">
				...
				<div class="col-lg-8">
                          ...
                          <input class="form-control" id='username' type="text" value="<?=set_value('username')?>" placeholder="johndoe" name="username">
				...
				<div class="col-lg-8">
                          ...
                          <input class="form-control" id='email' type="email" value="<?=set_value('email')?>" placeholder="me@domain.com" name="email">
				...
				<div class="form-group">
					...
					<label class="">
						<input type="radio" name="email_contact[]" value="Yes" required=""> <?=lang('yes')?> </label>
                    <label class="">
                        <input type="radio" name="email_contact[]" checked="checked" value="No" required=""> <?=lang('no')?> </label>
                </div>

		<div class="modal-footer"> <a href="#" class="btn btn-danger" data-dismiss="modal"><?=lang('close')?></a>
		<button type="submit" id="addContactClient" class="btn btn-success"><?=lang('add_contact')?></button>
		</form>
		</div>
	</div>
	<!-- /.modal-content -->
