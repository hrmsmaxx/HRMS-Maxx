...
?>
	...
	<div class="modal-content">
		...
		<h4 class="modal-title text-danger"><?=lang('edit_user')?> </h4> <!-- - <?php //echo User::displayName($id);?> -->
		</div><?php
			 $attributes = array('class' => 'bs-example form-horizontal','id' => 'editContactForm');
		...
		<div class="modal-body">
			 ...
			 <div class="form-group">
				...
				<div class="col-lg-8">
					<input type="text" class="form-control" id="edit_contact_mobile" value="<?=$profile->mobile?>" name="mobile">
				</div>
                                </div>
				<div class="form-group">
		...
		<button type="submit" class="btn btn-success" id="updateContactClient"><?=lang('save_changes')?></button>
		</form>		</div>
	</div>
	<!-- /.modal-content -->
</div>
