			...
			<div class="modal-body">
				...
				<div class="tab-content">
					<div class="tab-pane fade in active" id="tab-client-general">
						...
						<a class="btn btn-primary" id="nextEditGeneral"><?php echo lang('next'); ?></a>
						</div>
					...
					<div class="tab-pane fade in" id="tab-client-contact">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_general').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary" style="float:right;" id="nextEditContact" type="submit"><?php echo lang('next'); ?></a>
					...
					<div class="tab-pane fade in" id="tab-client-web">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_contact').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary" style="float:right;"  onclick="$('#tab_upt_client_bank').trigger('click')"><?php echo lang('next'); ?></a>
					...
					<div class="tab-pane fade in" id="tab-client-bank">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_web').trigger('click')"><?php echo lang('previous'); ?></a>
        				<a class="btn btn-primary" style="float:right;" onclick="$('#tab_upt_client_hosting').trigger('click')"><?php echo lang('next'); ?></a>
					...
					<div class="tab-pane fade in" id="tab-client-hosting">
						...
						<a class="btn btn-primary" onclick="$('#tab_upt_client_bank').trigger('click')"><?php echo lang('previous'); ?></a>
