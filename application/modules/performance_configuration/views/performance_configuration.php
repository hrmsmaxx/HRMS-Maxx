		...
		<div class="page-wrapper">
                <div class="content container">
					<div class="row">
						<div class="col-sm-8">
							<h4 class="page-title"><?php echo lang('performance_configuration'); ?></h4>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card-box">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="active"><a href="#okr_tab" data-toggle="tab"><?php echo lang('okrs') ?></a></li>
									<li><a href="#kpi_tab" data-toggle="tab"><?php echo lang('kpi'); ?></a></li>
									<li><a href="#smart_goals_tab" data-toggle="tab"><?php echo lang('smartgoal'); ?></a></li>
									<li><a href="#compentency_tab" data-toggle="tab"><?php echo lang('compentencies_or_BARS'); ?></a></li>
								</ul>
								...
								<div class="tab-content">
									...
									<div class="tab-pane active" id="okr_tab">
										<div class="row">
											<div class="col-md-6">
												<form id="okr_description" action="<?=base_url()?>performance_configuration/okr_description" method="POST">
													<div class="form-group">
														<label><?php echo lang('okrs_description'); ?></label>
														<textarea rows="4" cols="5" class="form-control" name="description"><?php echo $okr_description['description'];?></textarea>
													</div>
													<div class="submit-section">
														<button class="btn btn-primary submit-btn okr_description_submit" type="submit"><?php echo lang('save'); ?></button>
													</div>
												</form>
											</div>
										</div>
									...
									<div class="tab-pane" id="kpi_tab">
										<?php echo lang('kpi_content_here'); ?>
									</div>
									<!-- /KPI Config -->
									
									<!-- Smart Goal Config -->
									<div class="tab-pane" id="smart_goals_tab">
										<h4 class="m-b-20"><?php echo lang('smart_goal_configuration'); ?></h4>
										<form id="" action="<?=base_url()?>performance_configuration/create_smart_goal" method="POST">
											<div class="form-group">
												<label><?php echo lang('choose_rating_scale'); ?></label>
												<div class="radio_input" id="rating_scale_select">
													<label class="radio-inline custom_radio">
														<input type="radio" name="rating_scale" value="rating_1_5" required><?php echo lang('1 - 5'); ?> <span class="checkmark"></span>
													</label>
													<label class="radio-inline custom_radio">
														<input type="radio" name="rating_scale" value="rating_1_10"><?php echo lang('1 - 10'); ?> <span class="checkmark"></span>
													</label>
													<label class="radio-inline custom_radio">
														<input type="radio" name="rating_scale" value="custom_rating"><?php echo lang('custom'); ?> <span class="checkmark"></span>
													</label> 
												</div>
											</div>
