	...
	<div class="row filter-row">
						<div class="col-lg-4 col-sm-6">  
							<div class="form-group form-focus">
								...
								<label id="client_name_error" class="error display-none" for="client_name"><?php echo lang('company_should_not_empty')?></label>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">  
							<div class="form-group form-focus">
								...
								<label id="client_email_error" class="error display-none" for="client_email"><?php echo lang('email_should_not_empty')?></label>
							</div>
						</div>
						<div class="col-lg-4 col-sm-6">  
							<a href="javascript:void(0)" id="client_search" class="btn btn-success btn-block form-control" ><?php echo lang('search')?> </a>  
						</div>     
                    </div>
