...
<!-- Page Content -->
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="page-title"><?php echo lang('my_profile'); ?></h4>
						</div>
					</div>
					<!-- /Page Title -->
										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<div class="staff-id"><?php echo lang('company_id'); ?> : <?=$i->company_ref?></div>
													<div class="staff-msg"><a href="chat.html" class="btn btn-custom"><?php echo lang('send_message'); ?></a></div>
												</div>
											</div>
											<div class="col-md-7">
						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="active"><a class="nav-link active" data-toggle="tab" href="#myprojects"><?php echo lang('my_projects'); ?></a></li>
											...
											<div class="card-box project-box">
												<div class="dropdown profile-action">
													...
													<ul class="dropdown-menu pull-right">
														<li><a href="<?=base_url()?>projects/edit/<?=$p->project_id?>"><i class="fa fa-pencil m-r-5"></i> <?php echo lang('edit'); ?></a></li>
														<?php if (User::is_admin() || User::perm_allowed(User::get_id(),'delete_projects')){ ?> 
														<li><a href="<?=base_url()?>projects/delete/<?=$p->project_id?>" data-toggle="ajaxModal"><i class="fa fa-trash-o m-r-5"></i> <?php echo lang('delete'); ?></a></li>
														<?php } ?>
													</ul>
												</div>
												<h4 class="project-title"><a href="<?php echo base_url(); ?>projects/view/<?php echo $p->project_id; ?>"><?php echo $p->project_title; ?></a></h4>
												<small class="block text-ellipsis m-b-15">
													<span class="text-xs"><?php echo count($open_tasks); ?></span> <span class="text-muted"><?php echo lang('open_tasks'); ?>, </span>
													<span class="text-xs"><?php echo count($completed_tasks); ?></span> <span class="text-muted"><?php echo lang('tasks_completed'); ?></span>
												</small>
												...
												<div class="project-members m-b-15">
													<div><?php echo lang('project_leader'); ?> :</div>
												...
												<p class="m-b-5"><?php echo lang('progress'); ?> <span class="text-success pull-right"><?php echo $p->progress; ?>%</span></p>
