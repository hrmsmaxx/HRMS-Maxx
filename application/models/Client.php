...
class Client extends CI_Model
{
	...
	*/
	...
	// Get all clients
	static function get_all_clients($subdomain_id = null)
	{
		return self::$db->where(array('is_lead' => 0,'co_id >'=> 0,'subdomain_id'=>$subdomain_id))->order_by('company_name','ASC')->get('companies')->result();
	}
	// Get all departments
	static function get_all_departments($subdomain_id = null)
	{
		return self::$db->order_by('depthidden','ASC')->where('subdomain_id',$subdomain_id)->get('departments')->result();
	}
