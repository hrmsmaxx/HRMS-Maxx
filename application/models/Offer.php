...
class Offer extends CI_Model
{
	...
	*/
	...
	/* ATS module offer queries */

	function select_offered_candidates($where){
		$this->db->select('jobs.job_title,candidate_job_status.*,registered_candidates.first_name,registered_candidates.last_name,designation.designation');
