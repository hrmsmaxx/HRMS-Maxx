...
class Invoices_Recurring extends CI_Model {
    ...
    public $table                 = 'dgt_invoices';
    public $primary_key           = 'dgt_invoices.inv_id';
    ...
    public function active()
    {
        ...
        $query = $this->db->query("SELECT * FROM dgt_invoices  WHERE recur_next_date <= date(NOW()) AND (recur_end_date > date(NOW()) OR recur_end_date = '0000-00-00') AND recur_start_date <= date(NOW())") -> result();
        return $query;
    }
