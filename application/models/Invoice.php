...
class Invoice extends CI_Model
{
    ...
    {
        return self::$db->get_where('items_saved', array('subdomain_id'=>$_SESSION['subdomain_id']))->result();
    }
    ...
    {
        self::$db->where('tax_rate_name',$data['tax_rate_name']);
        if(self::$db->get('tax_rates')->num_rows() == 0)
        {
