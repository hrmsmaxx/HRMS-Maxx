...
// $config['base_url'] = 'https://localhost/phu_hrms/';

// echo 'asdsasd'. $_SERVER['SERVER_PORT']; exit;
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "https://";
              ...
              // $server_path = $protocol.$domainName.$folder_name;
               ...
               $server_path = $protocol.$domainName;
...
$config['google_key'] = '6LdktgAVAAAAAI2l_bxbP4QtFt_SYJvObbQ9NtSk';
$config['google_secret'] = '6LdktgAVAAAAALu6b5BHBVe159YksgEV7JS63IXk';