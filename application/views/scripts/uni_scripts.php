...
function task_name(task_id)
{
    ...
    if(task_name!='')
    {
        $.post('<?php echo base_url();?>all_tasks/task_name_update',{'task_name':task_name,'task_id':task_id},function(data){
...
var notify = setInterval(send_ticket_email__notification, 5000);
