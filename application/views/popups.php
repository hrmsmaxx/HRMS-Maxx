			...
			<div class="modal-body">
				...
				<div class="incoming-btns">
							...
							<?php if($this->session->userdata('candidate_id')){ 
								$id_name="user_answer"; $end_id = 'user_hangup';
						}else{ $id_name="answer"; $end_id = 'hangup';}?>	
						<a href="javascript:void(0)" class="btn btn-success m-r-10" id="<?php echo $id_name;?>">Answer</a>
						<a href="javascript:void(0)" class="btn btn-danger" data-dismiss="modal" id="<?php echo $end_id;?>">Decline</a>
					</div>
				</div>
			</div>
		</div>
