...
require_once ROOT_URL . "/server/models/Entidad/EntidadCentro.php";
class ControladorCentro extends ControladorEntidadAbstracto
{
  public function crearInformacion()
  {
    ...
    $informacion["id_centro"] = $Utilidades->getPost('iddata', "int");
...
$ControladorCentro = new ControladorCentro($EntidadCentro);
