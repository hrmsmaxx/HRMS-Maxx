...
require_once ROOT_URL . "/server/models/Entidad/EntidadDiaTipo.php";
class ControladorDiaTipo extends ControladorEntidadAbstracto
{
  public function crearInformacion()
  {
    ...
    $informacion["id_dia_tipo"] = $Utilidades->getPost('iddata', "int");
...
$ControladorDiaTipo = new ControladorDiaTipo($EntidadDiaTipo);
