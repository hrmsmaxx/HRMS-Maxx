    ...
    <div class="card-body" style="display: none;">
      <form class="form-horizontal floating-label filtros" role="form" method="get" action="index.php" id="formularioFiltros">
        <div class="col-xs-12 col-sm-12 col-lg-6">
          ...
          include(ROOT_URL . "//cliente/Filtro/FiltroFechaDesde.php");
          include(ROOT_URL . "//cliente/Filtro/FiltroFechaHasta.php");
          include(ROOT_URL . "//cliente/Filtro/FiltroIncidencia.php");
          include(ROOT_URL . "//cliente/Filtro/FiltroDispositivo.php");
          ?>
